...
void BtTargetInfoJklOpt() {
    ...
    __twr_v469 = 48ULL;
    __twr_v470 = _mng_string468 + __twr_v469;
    _mng_str471 = __twr_v470;
    __twr_v472 = (uint64_t)(&BtCurrentTarget);
    __twr_v473 = *(uint64_t*)(__twr_v472);
    __twr_v474 = 312ULL;
    __twr_v475 = __twr_v473 + __twr_v474;
    __twr_v476 = *(uint64_t*)(__twr_v475);
    if (!(__twr_v476)) { goto __twr_l61; } else { goto __twr_l62; }
    __twr_l62:;
    ...
    __twr_v488 = 16ULL;
    __twr_v489 = _mng_str471 + __twr_v488;
    __twr_v490 = *(uint64_t*)(__twr_v489);
    __twr_v491 = *(uint64_t*)(_mng_str471);
    __twr_v492 = 1ULL;
...
void BtTargetInfoLink() {
    ...
    __twr_v507 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v508 = (uint64_t)(&_mng_filepath509);
    ((void (*)(uint64_t))__twr_v507)(__twr_v508);
    __twr_v510 = (uint64_t)(&BtParseStandardPath);
    __twr_v511 = 48ULL;
    __twr_v512 = _mng_string506 + __twr_v511;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v510)(__twr_v512, __twr_v508, __twr_v504);
    ...
    if (!(__twr_v517)) { goto __twr_l66; } else { goto __twr_l67; }
    __twr_l67:;
    ...
    __twr_v529 = (uint64_t)(&_mng_filepath509);
    __twr_v530 = 16ULL;
    ...
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v524)(__twr_v528, __twr_v532, __twr_v535);
    __twr_v536 = (uint64_t)(&TlUninitializeDynamicBuffer);
    ((void (*)(uint64_t))__twr_v536)(__twr_v529);
    __twr_l63:;
    _jkl_epilogue:;
}
void BtTargetInfoDyLink() {
    ...
    uint64_t __twr_v548;
    uint64_t __twr_v549;
    uint64_t _mng_rtstring550;
    uint64_t __twr_v551;
    uint64_t __twr_v552;
    uint64_t _mng_ctpathtoken553[4];
    uint64_t __twr_v554;
    uint64_t __twr_v555;
    uint64_t __twr_v556;
    uint64_t __twr_v557;
    ...
    uint64_t __twr_v560;
    uint64_t __twr_v561;
    uint64_t _mng_ctstring562;
    uint64_t __twr_v563;
    uint64_t __twr_v564;
    uint64_t _mng_filepath565[11];
    uint64_t __twr_v566;
    uint64_t __twr_v567;
    uint64_t __twr_v568;
    uint64_t __twr_v569;
    ...
    __twr_v548 = 0ULL;
    __twr_v549 = *(uint64_t*)(__twr_v547);
    _mng_rtstring550 = __twr_v549;
    __twr_v551 = (uint64_t)(&LexMatchToken);
    __twr_v552 = (uint64_t)(&_mng_ctpathtoken553);
    __twr_v554 = 4ULL;
    __twr_v555 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v551)(__twr_v552, __twr_v554, __twr_v548);
    if (__twr_v555) { goto __twr_l71; } else { goto __twr_l72; }
    __twr_l72:;
    __twr_v556 = (uint64_t)(&LexTokenError);
    __twr_v557 = (uint64_t)(&_mng_ctpathtoken553);
    __twr_v558 = (uint64_t)(&"Expected a string");
    __twr_v559 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v556)(__twr_v557, __twr_v558, __twr_v559, __twr_v559, __twr_v559);
    __twr_l71:;
    __twr_v560 = (uint64_t)(&_mng_ctpathtoken553);
    __twr_v561 = *(uint64_t*)(__twr_v560);
    _mng_ctstring562 = __twr_v561;
    __twr_v563 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v564 = (uint64_t)(&_mng_filepath565);
    ((void (*)(uint64_t))__twr_v563)(__twr_v564);
    __twr_v566 = (uint64_t)(&BtParseStandardPath);
    __twr_v567 = 48ULL;
    __twr_v568 = _mng_ctstring562 + __twr_v567;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v566)(__twr_v568, __twr_v564, __twr_v560);
    __twr_v569 = (uint64_t)(&BtCurrentTarget);
    ...
    __twr_l74:;
    __twr_v574 = (uint64_t)(&TlInsertDynamicBuffer);
    __twr_v575 = (uint64_t)(&BtCurrentTarget);
    __twr_v576 = *(uint64_t*)(__twr_v575);
    __twr_v577 = 224ULL;
    __twr_v578 = __twr_v576 + __twr_v577;
    __twr_v579 = 32ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v574)(__twr_v578, __twr_v579);
    __twr_l73:;
    __twr_v580 = (uint64_t)(&TlCopyIntoDynamicBuffer);
    __twr_v581 = (uint64_t)(&BtCurrentTarget);
    __twr_v582 = *(uint64_t*)(__twr_v581);
    __twr_v583 = 224ULL;
    __twr_v584 = __twr_v582 + __twr_v583;
    __twr_v585 = 48ULL;
    __twr_v586 = _mng_rtstring550 + __twr_v585;
    __twr_v587 = 16ULL;
    __twr_v588 = 64ULL;
    __twr_v589 = _mng_rtstring550 + __twr_v588;
    __twr_v590 = *(uint64_t*)(__twr_v589);
    __twr_v591 = *(uint64_t*)(__twr_v586);
    __twr_v592 = 1ULL;
    __twr_v593 = __twr_v591 - __twr_v592;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v580)(__twr_v584, __twr_v590, __twr_v593);
    __twr_v594 = (uint64_t)(&TlInsertDynamicBuffer);
    __twr_v595 = *(uint64_t*)(__twr_v581);
    __twr_v596 = __twr_v595 + __twr_v583;
    __twr_v597 = 58ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v594)(__twr_v596, __twr_v597);
    __twr_v598 = *(uint64_t*)(__twr_v581);
    __twr_v599 = 136ULL;
    __twr_v600 = __twr_v598 + __twr_v599;
    __twr_v601 = (uint64_t)(&_mng_filepath565);
    __twr_v602 = __twr_v601 + __twr_v587;
    __twr_v603 = *(uint64_t*)(__twr_v602);
    __twr_v604 = *(uint64_t*)(__twr_v601);
    __twr_v605 = __twr_v604 - __twr_v592;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v580)(__twr_v600, __twr_v603, __twr_v605);
    __twr_v606 = (uint64_t)(&TlUninitializeDynamicBuffer);
    ((void (*)(uint64_t))__twr_v606)(__twr_v601);
    __twr_l68:;
    _jkl_epilogue:;
}
...
uint64_t BtParseTarget() {
    ...
    uint64_t __twr_v648;
    uint64_t __twr_v649;
    uint64_t _mng_target650;
    uint64_t _mng_status651;
    uint64_t __twr_v652;
    uint64_t __twr_v653;
    uint64_t __twr_v654;
    uint64_t __twr_v655;
    ...
    uint64_t __twr_v668;
    uint64_t __twr_v669;
    uint64_t _mng_listhead670;
    uint64_t __twr_v671;
    uint64_t __twr_v672;
    uint64_t __twr_v673;
    uint64_t __twr_v674;
    uint64_t __twr_v675;
    uint64_t _mng_listhead676;
    uint64_t __twr_v677;
    uint64_t __twr_v678;
    uint64_t __twr_v679;
    uint64_t __twr_v680;
    ...
    uint64_t __twr_v710;
    uint64_t __twr_v711;
    __twr_v607 = (uint64_t)(&LexGetToken);
    __twr_v608 = (uint64_t)(&_mng_token609);
    ((void (*)(uint64_t))__twr_v607)(__twr_v608);
    __twr_v610 = 24ULL;
    __twr_v611 = __twr_v608 + __twr_v610;
    __twr_v612 = *(uint8_t*)(__twr_v611);
    __twr_v613 = 6ULL;
    if (__twr_v612 != __twr_v613) { goto __twr_l76; } else { goto __twr_l77; }
    __twr_l77:;
    __twr_v614 = 0ULL;
    _jkl_retv = __twr_v614;
    goto _jkl_epilogue;
    __twr_l76:;
    __twr_v615 = (uint64_t)(&_mng_token609);
    __twr_v616 = 24ULL;
    __twr_v617 = __twr_v615 + __twr_v616;
    __twr_v618 = *(uint8_t*)(__twr_v617);
    __twr_v619 = 1ULL;
    if (__twr_v618 == __twr_v619) { goto __twr_l78; } else { goto __twr_l79; }
    __twr_l79:;
    __twr_v620 = (uint64_t)(&LexTokenError);
    __twr_v621 = (uint64_t)(&_mng_token609);
    __twr_v622 = (uint64_t)(&"Expected TARGET");
    __twr_v623 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v620)(__twr_v621, __twr_v622, __twr_v623, __twr_v623, __twr_v623);
    __twr_l78:;
    __twr_v624 = (uint64_t)(&LexMatchToken);
    __twr_v625 = (uint64_t)(&_mng_nametoken626);
    __twr_v627 = 4ULL;
    __twr_v628 = 0ULL;
    __twr_v629 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v624)(__twr_v625, __twr_v627, __twr_v628);
    if (__twr_v629) { goto __twr_l80; } else { goto __twr_l81; }
    __twr_l81:;
    __twr_v630 = (uint64_t)(&LexTokenError);
    __twr_v631 = (uint64_t)(&_mng_nametoken626);
    __twr_v632 = (uint64_t)(&"Expected a string");
    __twr_v633 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v630)(__twr_v631, __twr_v632, __twr_v633, __twr_v633, __twr_v633);
    __twr_l80:;
    __twr_v634 = (uint64_t)(&_mng_nametoken626);
    __twr_v635 = *(uint64_t*)(__twr_v634);
    _mng_namestring636 = __twr_v635;
    __twr_v637 = (uint64_t)(&TlLookupHashTable);
    __twr_v638 = (uint64_t)(&BtTargetHashTable);
    __twr_v639 = 64ULL;
    __twr_v640 = _mng_namestring636 + __twr_v639;
    __twr_v641 = *(uint64_t*)(__twr_v640);
    __twr_v642 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v637)(__twr_v638, __twr_v641);
    if (!(__twr_v642)) { goto __twr_l82; } else { goto __twr_l83; }
    __twr_l83:;
    __twr_v643 = (uint64_t)(&LexTokenError);
    __twr_v644 = (uint64_t)(&_mng_nametoken626);
    __twr_v645 = (uint64_t)(&"Target already defined");
    __twr_v646 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v643)(__twr_v644, __twr_v645, __twr_v646, __twr_v646, __twr_v646);
    __twr_l82:;
    __twr_v647 = (uint64_t)(&TlBumpAlloc);
    __twr_v648 = 608ULL;
    __twr_v649 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v647)(__twr_v648, (uint64_t)(&_mng_target650));
    _mng_status651 = __twr_v649;
    if (!(_mng_status651)) { goto __twr_l84; } else { goto __twr_l85; }
    __twr_l85:;
    __twr_v652 = (uint64_t)(&TlInternalError);
    __twr_v653 = (uint64_t)(&"Failed to allocate target");
    __twr_v654 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v652)(__twr_v653, __twr_v654, __twr_v654, __twr_v654);
    __twr_l84:;
    __twr_v655 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v656 = 48ULL;
    __twr_v657 = _mng_target650 + __twr_v656;
    ((void (*)(uint64_t))__twr_v655)(__twr_v657);
    __twr_v658 = 312ULL;
    __twr_v659 = _mng_target650 + __twr_v658;
    ((void (*)(uint64_t))__twr_v655)(__twr_v659);
    __twr_v660 = 400ULL;
    __twr_v661 = _mng_target650 + __twr_v660;
    ((void (*)(uint64_t))__twr_v655)(__twr_v661);
    __twr_v662 = 136ULL;
    __twr_v663 = _mng_target650 + __twr_v662;
    ((void (*)(uint64_t))__twr_v655)(__twr_v663);
    __twr_v664 = 224ULL;
    __twr_v665 = _mng_target650 + __twr_v664;
    ((void (*)(uint64_t))__twr_v655)(__twr_v665);
    __twr_v666 = 520ULL;
    __twr_v667 = _mng_target650 + __twr_v666;
    ((void (*)(uint64_t))__twr_v655)(__twr_v667);
    __twr_v668 = 488ULL;
    __twr_v669 = _mng_target650 + __twr_v668;
    _mng_listhead670 = __twr_v669;
    __twr_v671 = 8ULL;
    __twr_v672 = _mng_listhead670 + __twr_v671;
    *(uint64_t*)(__twr_v672) = _mng_listhead670;
    __twr_v673 = 0ULL;
    *(uint64_t*)(_mng_listhead670) = _mng_listhead670;
    __twr_v674 = 504ULL;
    __twr_v675 = _mng_target650 + __twr_v674;
    _mng_listhead676 = __twr_v675;
    __twr_v677 = _mng_listhead676 + __twr_v671;
    *(uint64_t*)(__twr_v677) = _mng_listhead676;
    *(uint64_t*)(_mng_listhead676) = _mng_listhead676;
    __twr_v678 = (uint64_t)(&BtCurrentTarget);
    *(uint64_t*)(__twr_v678) = _mng_target650;
    __twr_v679 = (uint64_t)(&LexMatchToken);
    __twr_v680 = (uint64_t)(&_mng_token609);
    __twr_v681 = 3ULL;
    __twr_v682 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v679)(__twr_v680, __twr_v681, __twr_v673);
    if (__twr_v682) { goto __twr_l87; } else { goto __twr_l86; }
    __twr_l86:;
    __twr_v683 = (uint64_t)(&LexMatchToken);
    __twr_v684 = (uint64_t)(&_mng_token609);
    __twr_v685 = 2ULL;
    __twr_v686 = 0ULL;
    __twr_v687 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v683)(__twr_v684, __twr_v685, __twr_v686);
    if (__twr_v687) { goto __twr_l89; } else { goto __twr_l90; }
    __twr_l90:;
    __twr_v688 = (uint64_t)(&LexTokenError);
    __twr_v689 = (uint64_t)(&_mng_token609);
    __twr_v690 = (uint64_t)(&"Expected a target info specifier");
    __twr_v691 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v688)(__twr_v689, __twr_v690, __twr_v691, __twr_v691, __twr_v691);
    __twr_l89:;
    __twr_v692 = (uint64_t)(&BtTargetInfoSpecifiers);
    __twr_v693 = (uint64_t)(&_mng_token609);
    __twr_v694 = 25ULL;
    __twr_v695 = __twr_v693 + __twr_v694;
    __twr_v696 = *(uint8_t*)(__twr_v695);
    __twr_v697 = 3ULL;
    __twr_v698 = __twr_v696 << __twr_v697;
    __twr_v699 = __twr_v692 + __twr_v698;
    __twr_v700 = *(uint64_t*)(__twr_v699);
    ((void (*)())__twr_v700)();
    __twr_l88:;
    __twr_v701 = (uint64_t)(&LexMatchToken);
    __twr_v702 = (uint64_t)(&_mng_token609);
    __twr_v703 = 3ULL;
    __twr_v704 = 0ULL;
    __twr_v705 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v701)(__twr_v702, __twr_v703, __twr_v704);
    if (!(__twr_v705)) { goto __twr_l86; } else { goto __twr_l87; }
    __twr_l87:;
    __twr_v706 = (uint64_t)(&TlInsertHashTable);
    __twr_v707 = (uint64_t)(&BtTargetHashTable);
    __twr_v708 = 64ULL;
    __twr_v709 = _mng_namestring636 + __twr_v708;
    __twr_v710 = *(uint64_t*)(__twr_v709);
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v706)(__twr_v707, _mng_target650, __twr_v710);
    __twr_v711 = 1ULL;
...
void BtParse() {
    ...
    uint64_t __twr_v716;
    uint64_t __twr_v717;
    __twr_v712 = (uint64_t)(&TlInitializeHashTable);
    __twr_v713 = (uint64_t)(&BtTargetHashTable);
    ((void (*)(uint64_t))__twr_v712)(__twr_v713);
    __twr_v714 = (uint64_t)(&BtParseTarget);
    __twr_v715 = ((uint64_t (*)())__twr_v714)();
    if (!(__twr_v715)) { goto __twr_l93; } else { goto __twr_l92; }
    __twr_l92:;
    __twr_l94:;
    __twr_v716 = (uint64_t)(&BtParseTarget);
    __twr_v717 = ((uint64_t (*)())__twr_v716)();
    if (__twr_v717) { goto __twr_l92; } else { goto __twr_l93; }
    __twr_l93:;
    __twr_l91:;
    _jkl_epilogue:;
}
