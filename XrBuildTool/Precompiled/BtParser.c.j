...
void BtLookupConfigMacros() {
    ...
    *(uint64_t*)(__twr_v860) = __twr_v855;
    __twr_l117:;
    __twr_v861 = (uint64_t)(&TlLookupSymbolTable);
    __twr_v862 = (uint64_t)(&LexCurrentMacroScope);
    __twr_v863 = *(uint64_t*)(__twr_v862);
    __twr_v864 = (uint64_t)(&"ARCH_NAME_SUFFIX");
    __twr_v865 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v861)(__twr_v863, __twr_v864);
    _mng_macro772 = __twr_v865;
    if (!(_mng_macro772)) { goto __twr_l121; } else { goto __twr_l122; }
    __twr_l122:;
    __twr_v866 = 264ULL;
    __twr_v867 = _mng_macro772 + __twr_v866;
    __twr_v868 = *(uint8_t*)(__twr_v867);
    if (!(__twr_v868)) { goto __twr_l123; } else { goto __twr_l124; }
    __twr_l124:;
    __twr_v869 = (uint64_t)(&TlUserError);
    __twr_v870 = (uint64_t)(&"ARCH_NAME_SUFFIX is a function macro for some reason");
    __twr_v871 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v869)(__twr_v870, __twr_v871, __twr_v871, __twr_v871);
    __twr_l123:;
    __twr_v872 = (uint64_t)(&TlCopyString);
    __twr_v873 = (uint64_t)(&BtArchNameSuffix);
    __twr_v874 = 1ULL;
    __twr_v875 = 96ULL;
    __twr_v876 = _mng_macro772 + __twr_v875;
    __twr_v877 = *(uint64_t*)(__twr_v876);
    __twr_v878 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v872)(__twr_v873, __twr_v877, __twr_v878);
    __twr_v879 = (uint64_t)(&BtArchHasSuffix);
    *(uint64_t*)(__twr_v879) = __twr_v874;
    __twr_l121:;
    __twr_v880 = (uint64_t)(&TlLookupSymbolTable);
    __twr_v881 = (uint64_t)(&LexCurrentMacroScope);
    __twr_v882 = *(uint64_t*)(__twr_v881);
    __twr_v883 = (uint64_t)(&"CLEANUP");
    __twr_v884 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v880)(__twr_v882, __twr_v883);
    _mng_macro772 = __twr_v884;
    if (!(_mng_macro772)) { goto __twr_l125; } else { goto __twr_l126; }
    __twr_l126:;
    __twr_v885 = 264ULL;
    __twr_v886 = _mng_macro772 + __twr_v885;
    __twr_v887 = *(uint8_t*)(__twr_v886);
    if (!(__twr_v887)) { goto __twr_l127; } else { goto __twr_l128; }
    __twr_l128:;
    __twr_v888 = (uint64_t)(&TlUserError);
    __twr_v889 = (uint64_t)(&"CLEANUP is a function macro for some reason");
    __twr_v890 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v888)(__twr_v889, __twr_v890, __twr_v890, __twr_v890);
    __twr_l127:;
    __twr_v891 = 1ULL;
    __twr_v892 = (uint64_t)(&BtCleanUp);
    *(uint64_t*)(__twr_v892) = __twr_v891;
    __twr_l125:;
    __twr_l98:;
    _jkl_epilogue:;
}
