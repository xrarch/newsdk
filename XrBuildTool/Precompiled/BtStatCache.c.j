...
void BtInitializeStatCache() {
    uint64_t __twr_v158;
    uint64_t __twr_v159;
    __twr_v158 = (uint64_t)(&TlInitializeHashTable);
    __twr_v159 = (uint64_t)(&BtStatHashTable);
    ((void (*)(uint64_t))__twr_v158)(__twr_v159);
    __twr_l1:;
    _jkl_epilogue:;
}
uint64_t BtStatFile(uint64_t _mng_fullpath160) {
    uint64_t _jkl_retv;
    uint64_t __twr_v161;
    uint64_t __twr_v162;
    uint64_t __twr_v163;
    uint64_t __twr_v164;
    uint64_t _mng_created165;
    uint64_t _mng_statentry166;
    uint64_t __twr_v167;
    uint64_t __twr_v168;
    uint64_t __twr_v169;
    uint64_t __twr_v170;
    ...
    uint64_t __twr_v174;
    uint64_t __twr_v175;
    __twr_v161 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v162 = (uint64_t)(&BtStatHashTable);
    __twr_v163 = 60ULL;
    __twr_v164 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v161)(__twr_v162, __twr_v163, _mng_fullpath160, (uint64_t)(&_mng_created165));
    _mng_statentry166 = __twr_v164;
    if (!(_mng_created165)) { goto __twr_l3; } else { goto __twr_l4; }
    __twr_l4:;
    __twr_v167 = (uint64_t)(&TlStatFile);
    __twr_v168 = 48ULL;
    __twr_v169 = _mng_statentry166 + __twr_v168;
    __twr_v170 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v167)(_mng_fullpath160, __twr_v169);
    _mng_status171 = __twr_v170;
    if (!(_mng_status171)) { goto __twr_l5; } else { goto __twr_l6; }
    __twr_l6:;
    __twr_v172 = (uint64_t)(&TlRemoveHashTable);
    __twr_v173 = 0ULL;
    ((void (*)(uint64_t))__twr_v172)(_mng_statentry166);
    _jkl_retv = __twr_v173;
    goto _jkl_epilogue;
    __twr_l5:;
    __twr_l3:;
    __twr_v174 = 48ULL;
    __twr_v175 = _mng_statentry166 + __twr_v174;
