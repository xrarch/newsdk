...
void BtInitializeStatCache() {
    uint64_t __twr_v155;
    uint64_t __twr_v156;
    __twr_v155 = (uint64_t)(&TlInitializeHashTable);
    __twr_v156 = (uint64_t)(&BtStatHashTable);
    ((void (*)(uint64_t))__twr_v155)(__twr_v156);
    __twr_l1:;
    _jkl_epilogue:;
}
uint64_t BtStatFile(uint64_t _mng_fullpath157) {
    uint64_t _jkl_retv;
    uint64_t __twr_v158;
    uint64_t __twr_v159;
    uint64_t __twr_v160;
    uint64_t __twr_v161;
    uint64_t _mng_created162;
    uint64_t _mng_statentry163;
    uint64_t __twr_v164;
    uint64_t __twr_v165;
    uint64_t __twr_v166;
    uint64_t __twr_v167;
    ...
    uint64_t __twr_v171;
    uint64_t __twr_v172;
    __twr_v158 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v159 = (uint64_t)(&BtStatHashTable);
    __twr_v160 = 60ULL;
    __twr_v161 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v158)(__twr_v159, __twr_v160, _mng_fullpath157, (uint64_t)(&_mng_created162));
    _mng_statentry163 = __twr_v161;
    if (!(_mng_created162)) { goto __twr_l3; } else { goto __twr_l4; }
    __twr_l4:;
    __twr_v164 = (uint64_t)(&TlStatFile);
    __twr_v165 = 48ULL;
    __twr_v166 = _mng_statentry163 + __twr_v165;
    __twr_v167 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v164)(_mng_fullpath157, __twr_v166);
    _mng_status168 = __twr_v167;
    if (!(_mng_status168)) { goto __twr_l5; } else { goto __twr_l6; }
    __twr_l6:;
    __twr_v169 = (uint64_t)(&TlRemoveHashTable);
    __twr_v170 = 0ULL;
    ((void (*)(uint64_t))__twr_v169)(_mng_statentry163);
    _jkl_retv = __twr_v170;
    goto _jkl_epilogue;
    __twr_l5:;
    __twr_l3:;
    __twr_v171 = 48ULL;
    __twr_v172 = _mng_statentry163 + __twr_v171;
