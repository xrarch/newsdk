...
void BtInitializeStatCache() {
    uint64_t __twr_v140;
    uint64_t __twr_v141;
    __twr_v140 = (uint64_t)(&TlInitializeHashTable);
    __twr_v141 = (uint64_t)(&BtStatHashTable);
    ((void (*)(uint64_t))__twr_v140)(__twr_v141);
    __twr_l1:;
    _jkl_epilogue:;
}
uint64_t BtStatFile(uint64_t _mng_fullpath142) {
    uint64_t _jkl_retv;
    uint64_t __twr_v143;
    uint64_t __twr_v144;
    uint64_t __twr_v145;
    uint64_t __twr_v146;
    uint64_t _mng_created147;
    uint64_t _mng_statentry148;
    uint64_t __twr_v149;
    uint64_t __twr_v150;
    uint64_t __twr_v151;
    uint64_t __twr_v152;
    ...
    uint64_t __twr_v155;
    uint64_t __twr_v156;
    __twr_v143 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v144 = (uint64_t)(&BtStatHashTable);
    __twr_v145 = 56ULL;
    __twr_v146 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v143)(__twr_v144, __twr_v145, _mng_fullpath142, (uint64_t)(&_mng_created147));
    _mng_statentry148 = __twr_v146;
    if (!(_mng_created147)) { goto __twr_l3; } else { goto __twr_l4; }
    __twr_l4:;
    __twr_v149 = (uint64_t)(&TlStatFile);
    __twr_v150 = 48ULL;
    __twr_v151 = _mng_statentry148 + __twr_v150;
    __twr_v152 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v149)(_mng_fullpath142, __twr_v151);
    _mng_status153 = __twr_v152;
    if (!(_mng_status153)) { goto __twr_l5; } else { goto __twr_l6; }
    __twr_l6:;
    __twr_v154 = 0ULL;
    ...
    __twr_l3:;
    __twr_v155 = 48ULL;
    __twr_v156 = _mng_statentry148 + __twr_v155;
