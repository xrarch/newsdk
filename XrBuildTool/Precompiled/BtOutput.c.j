...
extern void LexStreamError_C(uint64_t _mng_filename158, uint64_t _mng_linenumber159, uint64_t _mng_linepos160, uint64_t _mng_str161, uint64_t _mng_err1162, uint64_t _mng_err2163, uint64_t _mng_err3164);
void LexStreamError(uint64_t _mng_str165, uint64_t _mng_err1166, uint64_t _mng_err2167, uint64_t _mng_err3168) {
    uint64_t __twr_v169;
    uint64_t __twr_v170;
    uint64_t _mng_stream171;
    uint64_t __twr_v172;
    uint64_t __twr_v173;
    uint64_t __twr_v174;
    uint64_t __twr_v175;
    ...
    uint64_t __twr_v183;
    uint64_t __twr_v184;
    __twr_v169 = (uint64_t)(&LexCurrentStream);
    __twr_v170 = *(uint64_t*)(__twr_v169);
    _mng_stream171 = __twr_v170;
    __twr_v172 = (uint64_t)(&LexStreamError_C);
    __twr_v173 = 8ULL;
    __twr_v174 = _mng_stream171 + __twr_v173;
    ...
    __twr_v181 = 48ULL;
    __twr_v182 = _mng_stream171 + __twr_v181;
    __twr_v183 = *(uint32_t*)(__twr_v182);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v172)(__twr_v177, __twr_v180, __twr_v183, _mng_str165, _mng_err1166, _mng_err2167, _mng_err3168);
    __twr_v184 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v184)();
    __twr_l1:;
    _jkl_epilogue:;
}
void LexTokenError(uint64_t _mng_token185, uint64_t _mng_str186, uint64_t _mng_err1187, uint64_t _mng_err2188, uint64_t _mng_err3189) {
    uint64_t __twr_v190;
    uint64_t __twr_v191;
    uint64_t __twr_v192;
    uint64_t __twr_v193;
    ...
    uint64_t __twr_v201;
    uint64_t __twr_v202;
    __twr_v190 = (uint64_t)(&LexStreamError_C);
    __twr_v191 = 8ULL;
    __twr_v192 = _mng_token185 + __twr_v191;
    __twr_v193 = *(uint64_t*)(__twr_v192);
    __twr_v194 = 304ULL;
    __twr_v195 = __twr_v193 + __twr_v194;
    __twr_v196 = 16ULL;
    __twr_v197 = _mng_token185 + __twr_v196;
    __twr_v198 = *(uint32_t*)(__twr_v197);
    __twr_v199 = 20ULL;
    __twr_v200 = _mng_token185 + __twr_v199;
    __twr_v201 = *(uint32_t*)(__twr_v200);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v190)(__twr_v195, __twr_v198, __twr_v201, _mng_str186, _mng_err1187, _mng_err2188, _mng_err3189);
