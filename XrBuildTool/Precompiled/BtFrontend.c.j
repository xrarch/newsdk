...
void BtUsage() {
    ...
    __twr_v137 = (uint64_t)(&" [configname] [targetname]\n");
...
void FeParseArguments(uint64_t _mng_argc151, uint64_t _mng_argv152) {
    ...
    __twr_l9:;
    __twr_v156 = (uint64_t)(&FeIsMacroArgument);
    __twr_v157 = 3ULL;
    __twr_v158 = _mng_i155 << __twr_v157;
    __twr_v159 = _mng_argv152 + __twr_v158;
    __twr_v160 = *(uint64_t*)(__twr_v159);
    __twr_v161 = ((uint64_t (*)(uint64_t))__twr_v156)(__twr_v160);
    if (!(__twr_v161)) { goto __twr_l14; } else { goto __twr_l13; }
    __twr_l13:;
    __twr_v162 = (uint64_t)(&LexDefineMacroFromArgumentString);
    __twr_v163 = 3ULL;
    __twr_v164 = _mng_i155 << __twr_v163;
    __twr_v165 = _mng_argv152 + __twr_v164;
    __twr_v166 = *(uint64_t*)(__twr_v165);
    ((void (*)(uint64_t))__twr_v162)(__twr_v166);
    goto __twr_l12;
    __twr_l14:;
    if (!(_mng_foundinput153)) { goto __twr_l16; } else { goto __twr_l15; }
    __twr_l15:;
    if (!(_mng_foundtarget154)) { goto __twr_l17; } else { goto __twr_l18; }
    __twr_l18:;
    __twr_v167 = (uint64_t)(&TlPrintString);
    __twr_v168 = (uint64_t)(&"Too many arguments specified!\n");
    ((void (*)(uint64_t))__twr_v167)(__twr_v168);
    __twr_v169 = (uint64_t)(&BtUsage);
    ((void (*)())__twr_v169)();
    __twr_l17:;
    __twr_v170 = (uint64_t)(&TlCopyString);
    __twr_v171 = (uint64_t)(&FeTargetName);
    __twr_v172 = 3ULL;
    __twr_v173 = _mng_i155 << __twr_v172;
    __twr_v174 = _mng_argv152 + __twr_v173;
    __twr_v175 = *(uint64_t*)(__twr_v174);
    __twr_v176 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v170)(__twr_v171, __twr_v175, __twr_v176);
    _mng_foundtarget154 = 1ULL;
    goto __twr_l12;
    __twr_l16:;
    _mng_foundinput153 = 1ULL;
    __twr_v177 = (uint64_t)(&TlCopyString);
    __twr_v178 = (uint64_t)(&FeInputFile);
    __twr_v179 = 3ULL;
    __twr_v180 = _mng_i155 << __twr_v179;
    __twr_v181 = _mng_argv152 + __twr_v180;
    __twr_v182 = *(uint64_t*)(__twr_v181);
    __twr_v183 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v177)(__twr_v178, __twr_v182, __twr_v183);
    __twr_l12:;
    __twr_v184 = 1ULL;
    __twr_v185 = _mng_i155 + __twr_v184;
    _mng_i155 = __twr_v185;
    __twr_l11:;
    if (_mng_i155 < _mng_argc151) { goto __twr_l9; } else { goto __twr_l10; }
    __twr_l10:;
    if (_mng_foundinput153) { goto __twr_l19; } else { goto __twr_l20; }
    __twr_l20:;
    __twr_v186 = (uint64_t)(&TlPrintString);
    __twr_v187 = (uint64_t)(&"Error: No config file specified.\n");
    ((void (*)(uint64_t))__twr_v186)(__twr_v187);
    __twr_v188 = (uint64_t)(&BtUsage);
    ((void (*)())__twr_v188)();
    __twr_l19:;
    if (_mng_foundtarget154) { goto __twr_l21; } else { goto __twr_l22; }
    __twr_l22:;
    __twr_v189 = (uint64_t)(&TlPrintString);
    __twr_v190 = (uint64_t)(&"Error: No target name specified.\n");
...
uint64_t FeCreateFileBlock(uint64_t _mng_includename192, uint64_t _mng_o_created) {
    uint64_t _jkl_retv;
    uint64_t __twr_v193;
    uint64_t __twr_v194;
    uint64_t __twr_v195;
    uint64_t __twr_v196;
    uint64_t _mng_created197;
    uint64_t _mng_fileblock198;
    uint64_t __twr_v199;
    uint64_t __twr_v200;
    uint64_t __twr_v201;
    uint64_t __twr_v202;
    uint64_t __twr_v203;
    uint64_t __twr_v204;
    __twr_v193 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v194 = (uint64_t)(&FeFileBlockHashTable);
    __twr_v195 = 560ULL;
    __twr_v196 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v193)(__twr_v194, __twr_v195, _mng_includename192, (uint64_t)(&_mng_created197));
    _mng_fileblock198 = __twr_v196;
    if (!(_mng_created197)) { goto __twr_l24; } else { goto __twr_l25; }
    __twr_l25:;
    __twr_v199 = (uint64_t)(&TlCopyString);
    __twr_v200 = 304ULL;
    __twr_v201 = _mng_fileblock198 + __twr_v200;
    __twr_v202 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v199)(__twr_v201, _mng_includename192, __twr_v202);
    __twr_v203 = 40ULL;
    __twr_v204 = _mng_fileblock198 + __twr_v203;
    *(uint64_t*)(__twr_v204) = __twr_v201;
    __twr_l24:;
    _jkl_retv = _mng_fileblock198;
    goto _jkl_epilogue;
    __twr_l23:;
    _jkl_epilogue:;
    *(uint64_t*)(_mng_o_created) = _mng_created197;
    return _jkl_retv;
}
void FeCopyPathFileBlock(uint64_t _mng_fileblock205, uint64_t _mng_filepath206) {
    uint64_t __twr_v207;
    uint64_t __twr_v208;
    uint64_t __twr_v209;
    uint64_t __twr_v210;
    ...
    __twr_v208 = 48ULL;
    __twr_v209 = _mng_fileblock205 + __twr_v208;
    __twr_v210 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v207)(__twr_v209, _mng_filepath206, __twr_v210);
    __twr_l26:;
    _jkl_epilogue:;
}
void FeInitialize(uint64_t _mng_argc211, uint64_t _mng_argv212) {
    uint64_t __twr_v213;
    uint64_t __twr_v214;
    uint64_t __twr_v215;
    uint64_t __twr_v216;
    ...
    __twr_v214 = (uint64_t)(&FeFileBlockHashTable);
    ((void (*)(uint64_t))__twr_v213)(__twr_v214);
    __twr_v215 = (uint64_t)(&LexInitializePreprocessor);
    ((void (*)())__twr_v215)();
    __twr_v216 = (uint64_t)(&FeParseArguments);
    ((void (*)(uint64_t, uint64_t))__twr_v216)(_mng_argc211, _mng_argv212);
    __twr_v217 = (uint64_t)(&TlOpenSource);
    __twr_v218 = (uint64_t)(&FeInputFile);
    __twr_v219 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v217)(__twr_v218, (uint64_t)(&__twr_v220));
    __twr_v221 = (uint64_t)(&FeInputFileHandle);
    *(uint64_t*)(__twr_v221) = __twr_v220;
    _mng_status222 = __twr_v219;
    if (!(_mng_status222)) { goto __twr_l28; } else { goto __twr_l29; }
    __twr_l29:;
    __twr_v223 = (uint64_t)(&TlUserError);
    __twr_v224 = (uint64_t)(&"Failed to open the config file.");
    __twr_v225 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v223)(__twr_v224, __twr_v225, __twr_v225, __twr_v225);
    __twr_l28:;
    __twr_v226 = (uint64_t)(&LexInitialize);
    ((void (*)())__twr_v226)();
    __twr_l27:;
    _jkl_epilogue:;
}
...
void BtBuild(uint64_t _mng_argc227, uint64_t _mng_argv228) {
    uint64_t __twr_v229;
    uint64_t __twr_v230;
    uint64_t __twr_v231;
    uint64_t __twr_v232;
    uint64_t __twr_v233;
    __twr_v229 = *(uint64_t*)(_mng_argv228);
    __twr_v230 = (uint64_t)(&BtBinaryName);
    *(uint64_t*)(__twr_v230) = __twr_v229;
    __twr_v231 = (uint64_t)(&FeInitialize);
    ((void (*)(uint64_t, uint64_t))__twr_v231)(_mng_argc227, _mng_argv228);
    __twr_v232 = (uint64_t)(&BtParse);
    ((void (*)())__twr_v232)();
    __twr_v233 = (uint64_t)(&BtBuildDag);
    ((void (*)())__twr_v233)();
    __twr_l30:;
    _jkl_epilogue:;
}
