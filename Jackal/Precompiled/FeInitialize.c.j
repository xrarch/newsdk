...
void FeParseArguments(uint64_t _mng_argc152, uint64_t _mng_argv153) {
    ...
    *(uint8_t*)(__twr_v156) = __twr_v154;
    ...
    __twr_v208 = 3ULL;
    __twr_v209 = _mng_i160 << __twr_v208;
    __twr_v210 = _mng_argv153 + __twr_v209;
    ...
    __twr_v216 = 3ULL;
    __twr_v217 = _mng_i160 << __twr_v216;
    __twr_v218 = _mng_argv153 + __twr_v217;
    __twr_v219 = *(uint64_t*)(__twr_v218);
    __twr_v220 = (uint64_t)(&"header=");
    __twr_v221 = 7ULL;
    __twr_v222 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v215)(__twr_v219, __twr_v220, __twr_v221);
    __twr_v223 = 0ULL;
    if (__twr_v222 != __twr_v223) { goto __twr_l19; } else { goto __twr_l18; }
    __twr_l18:;
    __twr_v224 = 3ULL;
    ...
    __twr_v230 = (uint64_t)(&FeOutputHeaders);
    *(uint64_t*)(__twr_v230) = __twr_v229;
    goto __twr_l11;
    __twr_l19:;
    __twr_v231 = (uint64_t)(&FeIsMacroArgument);
    __twr_v232 = 3ULL;
    __twr_v233 = _mng_i160 << __twr_v232;
    __twr_v234 = _mng_argv153 + __twr_v233;
    __twr_v235 = *(uint64_t*)(__twr_v234);
    __twr_v236 = ((uint64_t (*)(uint64_t))__twr_v231)(__twr_v235);
    if (!(__twr_v236)) { goto __twr_l21; } else { goto __twr_l20; }
    __twr_l20:;
    __twr_v237 = (uint64_t)(&LexDefineMacroFromArgumentString);
    __twr_v238 = 3ULL;
    __twr_v239 = _mng_i160 << __twr_v238;
    __twr_v240 = _mng_argv153 + __twr_v239;
    __twr_v241 = *(uint64_t*)(__twr_v240);
    ((void (*)(uint64_t))__twr_v237)(__twr_v241);
    goto __twr_l11;
    __twr_l21:;
    ...
    __twr_l25:;
    __twr_v242 = (uint64_t)(&TlUserError);
    __twr_v243 = (uint64_t)(&"Too many arguments specified!");
    __twr_v244 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v242)(__twr_v243, __twr_v244, __twr_v244, __twr_v244);
    __twr_l24:;
    _mng_foundoutput158 = 1ULL;
    __twr_v245 = (uint64_t)(&TlCopyString);
    __twr_v246 = (uint64_t)(&FeOutputFile);
    __twr_v247 = 3ULL;
    __twr_v248 = _mng_i160 << __twr_v247;
    __twr_v249 = _mng_argv153 + __twr_v248;
    __twr_v250 = *(uint64_t*)(__twr_v249);
    __twr_v251 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v245)(__twr_v246, __twr_v250, __twr_v251);
    goto __twr_l11;
    __twr_l23:;
    _mng_foundinput157 = 1ULL;
    __twr_v252 = (uint64_t)(&TlCopyString);
    __twr_v253 = (uint64_t)(&FeInputFile);
    __twr_v254 = 3ULL;
    __twr_v255 = _mng_i160 << __twr_v254;
    __twr_v256 = _mng_argv153 + __twr_v255;
    __twr_v257 = *(uint64_t*)(__twr_v256);
    __twr_v258 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v252)(__twr_v253, __twr_v257, __twr_v258);
    __twr_l11:;
    __twr_v259 = 1ULL;
    __twr_v260 = _mng_i160 + __twr_v259;
    _mng_i160 = __twr_v260;
    __twr_l10:;
    ...
    __twr_v262 = (uint64_t)(&"No input file specified.");
    __twr_v263 = 0ULL;
    ...
    __twr_l29:;
    __twr_v264 = (uint64_t)(&TlUserError);
    __twr_v265 = (uint64_t)(&"No output file specified.");
    __twr_v266 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v264)(__twr_v265, __twr_v266, __twr_v266, __twr_v266);
    __twr_l28:;
    if (_mng_foundtarget159) { goto __twr_l30; } else { goto __twr_l31; }
    __twr_l31:;
    __twr_v267 = (uint64_t)(&TlUserError);
    __twr_v268 = (uint64_t)(&"No target specified.");
    __twr_v269 = 0ULL;
...
uint64_t FeCreateFileBlock(uint64_t _mng_includename270, uint64_t _mng_o_created) {
    uint64_t _jkl_retv;
    uint64_t __twr_v271;
    uint64_t __twr_v272;
    uint64_t __twr_v273;
    uint64_t __twr_v274;
    uint64_t _mng_created275;
    uint64_t _mng_fileblock276;
    uint64_t __twr_v277;
    uint64_t __twr_v278;
    uint64_t __twr_v279;
    uint64_t __twr_v280;
    uint64_t __twr_v281;
    uint64_t __twr_v282;
    __twr_v271 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v272 = (uint64_t)(&FeFileBlockHashTable);
    __twr_v273 = 560ULL;
    __twr_v274 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v271)(__twr_v272, __twr_v273, _mng_includename270, (uint64_t)(&_mng_created275));
    _mng_fileblock276 = __twr_v274;
    if (!(_mng_created275)) { goto __twr_l33; } else { goto __twr_l34; }
    __twr_l34:;
    __twr_v277 = (uint64_t)(&TlCopyString);
    __twr_v278 = 304ULL;
    __twr_v279 = _mng_fileblock276 + __twr_v278;
    __twr_v280 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v277)(__twr_v279, _mng_includename270, __twr_v280);
    __twr_v281 = 40ULL;
    __twr_v282 = _mng_fileblock276 + __twr_v281;
    *(uint64_t*)(__twr_v282) = __twr_v279;
    __twr_l33:;
    _jkl_retv = _mng_fileblock276;
    goto _jkl_epilogue;
    __twr_l32:;
    _jkl_epilogue:;
    *(uint64_t*)(_mng_o_created) = _mng_created275;
    return _jkl_retv;
}
void FeCopyPathFileBlock(uint64_t _mng_fileblock283, uint64_t _mng_filepath284) {
    uint64_t __twr_v285;
    uint64_t __twr_v286;
    uint64_t __twr_v287;
    uint64_t __twr_v288;
    ...
    __twr_v286 = 48ULL;
    __twr_v287 = _mng_fileblock283 + __twr_v286;
    __twr_v288 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v285)(__twr_v287, _mng_filepath284, __twr_v288);
    __twr_l35:;
    _jkl_epilogue:;
}
...
void TrgInitialize() {
    ...
    uint64_t __twr_v306;
    uint64_t __twr_v307;
    __twr_v289 = (uint64_t)(&TrgInfoRecords);
    __twr_v290 = 0ULL;
    _mng_target291 = __twr_v289;
    __twr_v292 = *(uint64_t*)(_mng_target291);
    if (__twr_v292 == __twr_v290) { goto __twr_l38; } else { goto __twr_l37; }
    __twr_l37:;
    __twr_v293 = (uint64_t)(&TlCompareString);
    __twr_v294 = (uint64_t)(&FeTargetString);
    __twr_v295 = 0ULL;
    __twr_v296 = *(uint64_t*)(_mng_target291);
    __twr_v297 = *(uint64_t*)(__twr_v296);
    __twr_v298 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v293)(__twr_v294, __twr_v297);
    if (__twr_v298 != __twr_v295) { goto __twr_l40; } else { goto __twr_l41; }
    __twr_l41:;
    __twr_v299 = *(uint64_t*)(_mng_target291);
    __twr_v300 = (uint64_t)(&JklTargetInfo);
    *(uint64_t*)(__twr_v300) = __twr_v299;
    goto _jkl_epilogue;
    __twr_l40:;
    __twr_v301 = 8ULL;
    __twr_v302 = _mng_target291 + __twr_v301;
    _mng_target291 = __twr_v302;
    __twr_l39:;
    __twr_v303 = *(uint64_t*)(_mng_target291);
    __twr_v304 = 0ULL;
    if (__twr_v303 != __twr_v304) { goto __twr_l37; } else { goto __twr_l38; }
    __twr_l38:;
...
void FeInitialize(uint64_t _mng_argc308, uint64_t _mng_argv309) {
    ...
    *(uint64_t*)(__twr_v318) = __twr_v317;
    ...
    if (!(_mng_status319)) { goto __twr_l43; } else { goto __twr_l44; }
    __twr_l44:;
...
void FeOutputHeaderDependencies() {
    ...
    if (!(_mng_status331)) { goto __twr_l46; } else { goto __twr_l47; }
    __twr_l47:;
    ...
    if (_mng_head339 == _mng_entry345) { goto __twr_l49; } else { goto __twr_l48; }
    __twr_l48:;
    __twr_v346 = 16ULL;
    ...
    __twr_l50:;
    if (_mng_head339 != _mng_entry345) { goto __twr_l48; } else { goto __twr_l49; }
    __twr_l49:;
...
void JklCompileProgram(uint64_t _mng_argc368, uint64_t _mng_argv369) {
    ...
    uint64_t __twr_v390;
    uint64_t __twr_v391;
    __twr_v370 = (uint64_t)(&FeInitialize);
    ((void (*)(uint64_t, uint64_t))__twr_v370)(_mng_argc368, _mng_argv369);
    __twr_v371 = (uint64_t)(&PrsProgram);
    ((void (*)())__twr_v371)();
    __twr_v372 = (uint64_t)(&IrGenerate);
    ((void (*)())__twr_v372)();
    __twr_v373 = (uint64_t)(&IrSimplify);
    ((void (*)())__twr_v373)();
    __twr_v374 = (uint64_t)(&IrEliminateDeadVariables);
    ((void (*)())__twr_v374)();
    __twr_v375 = (uint64_t)(&TlOpenDestination);
    __twr_v376 = (uint64_t)(&FeOutputFile);
    __twr_v377 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v375)(__twr_v376, (uint64_t)(&__twr_v378));
    __twr_v379 = (uint64_t)(&FeOutputFileHandle);
    *(uint64_t*)(__twr_v379) = __twr_v378;
    _mng_status380 = __twr_v377;
    if (!(_mng_status380)) { goto __twr_l52; } else { goto __twr_l53; }
    __twr_l53:;
    __twr_v381 = (uint64_t)(&TlUserError);
    __twr_v382 = (uint64_t)(&"Failed to open destination file.");
    __twr_v383 = 0ULL;
    ...
    ((void (*)())__twr_v388)();
    __twr_v389 = (uint64_t)(&FeOutputHeaders);
    __twr_v390 = *(uint64_t*)(__twr_v389);
    if (!(__twr_v390)) { goto __twr_l54; } else { goto __twr_l55; }
    __twr_l55:;
    __twr_v391 = (uint64_t)(&FeOutputHeaderDependencies);
    ((void (*)())__twr_v391)();
    __twr_l54:;
    __twr_l51:;
    _jkl_epilogue:;
