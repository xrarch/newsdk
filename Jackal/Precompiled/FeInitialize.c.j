...
void FeParseArguments(uint64_t _mng_argc169, uint64_t _mng_argv170) {
    ...
    *(uint8_t*)(__twr_v177) = __twr_v171;
    ...
    __twr_v252 = (uint64_t)(&FeTargetString);
    __twr_v253 = __twr_v252 + __twr_v241;
    __twr_v254 = (uint64_t)(&"CHost");
    __twr_v255 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v251)(__twr_v253, __twr_v254);
    if (__twr_v255 == __twr_v239) { goto __twr_l17; } else { goto __twr_l18; }
    __twr_l17:;
    __twr_v256 = 1ULL;
    ...
    *(uint64_t*)(__twr_v257) = __twr_v256;
    ...
    __twr_l18:;
    __twr_v258 = 0ULL;
    __twr_v259 = (uint64_t)(&JklCHost);
    *(uint64_t*)(__twr_v259) = __twr_v258;
    __twr_l16:;
    __twr_v260 = 1ULL;
    _mng_foundtarget180 = __twr_v260;
    goto __twr_l9;
    __twr_l15:;
    __twr_v261 = (uint64_t)(&FeIsMacroArgument);
    __twr_v262 = 8ULL;
    __twr_v263 = _mng_i181 * __twr_v262;
    __twr_v264 = _mng_argv170 + __twr_v263;
    __twr_v265 = *(uint64_t*)(__twr_v264);
    __twr_v266 = ((uint64_t (*)(uint64_t))__twr_v261)(__twr_v265);
    if (__twr_v266) { goto __twr_l19; } else { goto __twr_l20; }
    __twr_l19:;
    __twr_v267 = (uint64_t)(&LexDefineMacroFromArgumentString);
    __twr_v268 = 8ULL;
    __twr_v269 = _mng_i181 * __twr_v268;
    __twr_v270 = _mng_argv170 + __twr_v269;
    ...
    __twr_l23:;
    __twr_v275 = 1ULL;
    _mng_foundoutput179 = __twr_v275;
    __twr_v276 = (uint64_t)(&TlCopyString);
    __twr_v277 = (uint64_t)(&FeOutputFile);
    __twr_v278 = 0ULL;
    __twr_v279 = __twr_v278 * __twr_v275;
    __twr_v280 = __twr_v277 + __twr_v279;
    __twr_v281 = 8ULL;
    __twr_v282 = _mng_i181 * __twr_v281;
    __twr_v283 = _mng_argv170 + __twr_v282;
    __twr_v284 = *(uint64_t*)(__twr_v283);
    __twr_v285 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v276)(__twr_v280, __twr_v284, __twr_v285);
    goto __twr_l9;
    __twr_l22:;
    __twr_v286 = 1ULL;
    _mng_foundinput178 = __twr_v286;
    __twr_v287 = (uint64_t)(&TlCopyString);
    __twr_v288 = (uint64_t)(&FeInputFile);
    __twr_v289 = 0ULL;
    __twr_v290 = __twr_v289 * __twr_v286;
    __twr_v291 = __twr_v288 + __twr_v290;
    __twr_v292 = 8ULL;
    __twr_v293 = _mng_i181 * __twr_v292;
    __twr_v294 = _mng_argv170 + __twr_v293;
    __twr_v295 = *(uint64_t*)(__twr_v294);
    __twr_v296 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v287)(__twr_v291, __twr_v295, __twr_v296);
    __twr_l9:;
    __twr_v297 = 1ULL;
    __twr_v298 = _mng_i181 + __twr_v297;
    _mng_i181 = __twr_v298;
    __twr_l8:;
    if (_mng_i181 < _mng_argc169) { goto __twr_l6; } else { goto __twr_l7; }
    __twr_l7:;
    if (_mng_foundinput178) { goto __twr_l25; } else { goto __twr_l26; }
    __twr_l26:;
    __twr_v299 = (uint64_t)(&TlUserError);
    __twr_v300 = (uint64_t)(&"No input file specified.");
    __twr_v301 = 0ULL;
    ...
    __twr_l28:;
    __twr_v302 = (uint64_t)(&TlUserError);
    __twr_v303 = (uint64_t)(&"No output file specified.");
    __twr_v304 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v302)(__twr_v303, __twr_v304, __twr_v304, __twr_v304);
    __twr_l27:;
    if (_mng_foundtarget180) { goto __twr_l29; } else { goto __twr_l30; }
    __twr_l30:;
    __twr_v305 = (uint64_t)(&TlCopyString);
    __twr_v306 = (uint64_t)(&FeTargetString);
    __twr_v307 = 0ULL;
    __twr_v308 = 1ULL;
    __twr_v309 = __twr_v307 * __twr_v308;
    __twr_v310 = __twr_v306 + __twr_v309;
    __twr_v311 = (uint64_t)(&"xr17032");
    __twr_v312 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v305)(__twr_v310, __twr_v311, __twr_v312);
    __twr_l29:;
}
uint64_t FeCreateFileBlock(uint64_t _mng_includename313, uint64_t _mng_created314) {
    uint64_t __twr_v315;
    uint64_t __twr_v316;
    uint64_t __twr_v317;
    uint64_t __twr_v318;
    uint64_t _mng_fileblock319;
    uint64_t __twr_v320;
    uint64_t __twr_v321;
    uint64_t __twr_v322;
    uint64_t __twr_v323;
    ...
    uint64_t __twr_v330;
    uint64_t __twr_v331;
    __twr_v315 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v316 = (uint64_t)(&FeFileBlockHashTable);
    __twr_v317 = 560ULL;
    __twr_v318 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v315)(__twr_v316, __twr_v317, _mng_includename313, _mng_created314);
    _mng_fileblock319 = __twr_v318;
    __twr_v320 = *(uint8_t*)(_mng_created314);
    if (__twr_v320) { goto __twr_l32; } else { goto __twr_l31; }
    __twr_l32:;
    __twr_v321 = (uint64_t)(&TlCopyString);
    __twr_v322 = 304ULL;
    __twr_v323 = _mng_fileblock319 + __twr_v322;
    __twr_v324 = 0ULL;
    __twr_v325 = 1ULL;
    __twr_v326 = __twr_v324 * __twr_v325;
    __twr_v327 = __twr_v323 + __twr_v326;
    __twr_v328 = 256ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v321)(__twr_v327, _mng_includename313, __twr_v328);
    __twr_v329 = _mng_fileblock319 + __twr_v324;
    __twr_v330 = 40ULL;
    __twr_v331 = __twr_v329 + __twr_v330;
    *(uint64_t*)(__twr_v331) = __twr_v327;
    __twr_l31:;
    return _mng_fileblock319;
}
...
void TrgInitialize() {
    ...
    __twr_v348 = *(uint64_t*)(_mng_target347);
    ...
    __twr_v356 = __twr_v355 + __twr_v351;
...
void FeInitialize(uint64_t _mng_argc368, uint64_t _mng_argv369) {
    ...
    if (_mng_status382) { goto __twr_l39; } else { goto __twr_l38; }
    __twr_l39:;
    ...
    if (_mng_status382) { goto __twr_l41; } else { goto __twr_l40; }
    __twr_l41:;
...
void JklCompileProgram(uint64_t _mng_argc400, uint64_t _mng_argv401) {
    ...
    ((void (*)())__twr_v404)();
    __twr_v405 = (uint64_t)(&JklTargetInfo);
