...
void IrEliminateForFunction(uint64_t _mng_funcsym229) {
    uint64_t __twr_v230;
    uint64_t __twr_v231;
    uint64_t __twr_v232;
    uint64_t __twr_v233;
    ...
    uint64_t __twr_v267;
    uint64_t __twr_v268;
    uint64_t _mng_src1269;
    uint64_t __twr_v270;
    uint64_t __twr_v271;
    uint64_t __twr_v272;
    uint64_t _mng_src2273;
    uint64_t __twr_v274;
    uint64_t __twr_v275;
    uint64_t __twr_v276;
    uint64_t __twr_v277;
    ...
    uint64_t __twr_v325;
    uint64_t __twr_v326;
    uint64_t _mng_arg327;
    uint64_t __twr_v328;
    uint64_t __twr_v329;
    uint64_t __twr_v330;
    uint64_t _mng_var331;
    uint64_t __twr_v332;
    uint64_t __twr_v333;
    uint64_t __twr_v334;
    uint64_t __twr_v335;
    ...
    uint64_t __twr_v372;
    __twr_v230 = 96ULL;
    __twr_v231 = _mng_funcsym229 + __twr_v230;
    ...
    if (__twr_v241) { goto __twr_l23; } else { goto __twr_l24; }
    __twr_l24:;
    __twr_v242 = (uint64_t)(&IrDeadVariableListHead);
    __twr_v243 = 24ULL;
    __twr_v244 = _mng_def238 + __twr_v243;
    __twr_v245 = 0ULL;
    __twr_v246 = 8ULL;
    __twr_v247 = __twr_v242 + __twr_v246;
    __twr_v248 = *(uint64_t*)(__twr_v247);
    __twr_v249 = 32ULL;
    __twr_v250 = _mng_def238 + __twr_v249;
    *(uint64_t*)(__twr_v250) = __twr_v248;
    *(uint64_t*)(__twr_v244) = __twr_v242;
    *(uint64_t*)(__twr_v248) = __twr_v244;
    *(uint64_t*)(__twr_v247) = __twr_v244;
    __twr_v251 = 1ULL;
    __twr_v252 = 96ULL;
    __twr_v253 = _mng_def238 + __twr_v252;
    ...
    *(uint32_t*)(__twr_v255) = __twr_v245;
    ...
    __twr_v257 = 0ULL;
    __twr_v258 = 40ULL;
    __twr_v259 = _mng_def238 + __twr_v258;
    *(uint64_t*)(__twr_v259) = __twr_v257;
    ...
    __twr_v264 = 72ULL;
    __twr_v265 = _mng_inst234 + __twr_v264;
    *(uint64_t*)(__twr_v265) = __twr_v263;
    *(uint64_t*)(__twr_v262) = _mng_inst234;
    __twr_l27:;
    __twr_l21:;
    __twr_v266 = 56ULL;
    __twr_v267 = _mng_inst234 + __twr_v266;
    __twr_v268 = *(uint64_t*)(__twr_v267);
    _mng_src1269 = __twr_v268;
    __twr_v270 = 64ULL;
    ...
    __twr_v277 = 1ULL;
    __twr_v278 = 48ULL;
    __twr_v279 = _mng_src1269 + __twr_v278;
    *(uint32_t*)(__twr_v279) = __twr_v277;
    __twr_v280 = 96ULL;
    __twr_v281 = _mng_src1269 + __twr_v280;
    *(uint8_t*)(__twr_v281) = __twr_v277;
    goto __twr_l31;
    __twr_l33:;
    __twr_v282 = 48ULL;
    __twr_v283 = _mng_src1269 + __twr_v282;
    __twr_v284 = *(uint32_t*)(__twr_v283);
    if (__twr_v284) { goto __twr_l34; } else { goto __twr_l35; }
    __twr_l35:;
    __twr_v285 = 24ULL;
    __twr_v286 = _mng_src1269 + __twr_v285;
    __twr_v287 = 8ULL;
    __twr_v288 = 32ULL;
    __twr_v289 = _mng_src1269 + __twr_v288;
    __twr_v290 = *(uint64_t*)(__twr_v289);
    __twr_v291 = *(uint64_t*)(__twr_v286);
    *(uint64_t*)(__twr_v290) = __twr_v291;
    __twr_v292 = __twr_v291 + __twr_v287;
    *(uint64_t*)(__twr_v292) = __twr_v290;
    __twr_l34:;
    __twr_v293 = 1ULL;
    __twr_v294 = 48ULL;
    __twr_v295 = _mng_src1269 + __twr_v294;
    __twr_v296 = *(uint32_t*)(__twr_v295);
    __twr_v297 = __twr_v296 + __twr_v293;
    *(uint32_t*)(__twr_v295) = __twr_v297;
    __twr_l31:;
    __twr_l29:;
    if (_mng_src2273) { goto __twr_l37; } else { goto __twr_l36; }
    __twr_l37:;
    __twr_v298 = 96ULL;
    __twr_v299 = _mng_src2273 + __twr_v298;
    __twr_v300 = *(uint8_t*)(__twr_v299);
    if (__twr_v300) { goto __twr_l40; } else { goto __twr_l39; }
    __twr_l39:;
    __twr_v301 = 1ULL;
    __twr_v302 = 48ULL;
    __twr_v303 = _mng_src2273 + __twr_v302;
    *(uint32_t*)(__twr_v303) = __twr_v301;
    __twr_v304 = 96ULL;
    __twr_v305 = _mng_src2273 + __twr_v304;
    *(uint8_t*)(__twr_v305) = __twr_v301;
    goto __twr_l38;
    __twr_l40:;
    __twr_v306 = 48ULL;
    __twr_v307 = _mng_src2273 + __twr_v306;
    __twr_v308 = *(uint32_t*)(__twr_v307);
    if (__twr_v308) { goto __twr_l41; } else { goto __twr_l42; }
    __twr_l42:;
    __twr_v309 = 24ULL;
    __twr_v310 = _mng_src2273 + __twr_v309;
    __twr_v311 = 8ULL;
    __twr_v312 = 32ULL;
    __twr_v313 = _mng_src2273 + __twr_v312;
    __twr_v314 = *(uint64_t*)(__twr_v313);
    __twr_v315 = *(uint64_t*)(__twr_v310);
    *(uint64_t*)(__twr_v314) = __twr_v315;
    __twr_v316 = __twr_v315 + __twr_v311;
    *(uint64_t*)(__twr_v316) = __twr_v314;
    __twr_l41:;
    __twr_v317 = 1ULL;
    __twr_v318 = 48ULL;
    __twr_v319 = _mng_src2273 + __twr_v318;
    __twr_v320 = *(uint32_t*)(__twr_v319);
    __twr_v321 = __twr_v320 + __twr_v317;
    *(uint32_t*)(__twr_v319) = __twr_v321;
    __twr_l38:;
    __twr_l36:;
    __twr_v322 = 88ULL;
    ...
    _mng_var331 = __twr_v330;
    __twr_v332 = 96ULL;
    __twr_v333 = __twr_v330 + __twr_v332;
    __twr_v334 = *(uint8_t*)(__twr_v333);
    if (__twr_v334) { goto __twr_l50; } else { goto __twr_l49; }
    __twr_l49:;
    __twr_v335 = 1ULL;
    __twr_v336 = 48ULL;
    __twr_v337 = _mng_var331 + __twr_v336;
    *(uint32_t*)(__twr_v337) = __twr_v335;
    __twr_v338 = 96ULL;
    __twr_v339 = _mng_var331 + __twr_v338;
    *(uint8_t*)(__twr_v339) = __twr_v335;
    goto __twr_l48;
    __twr_l50:;
    __twr_v340 = 48ULL;
    __twr_v341 = _mng_var331 + __twr_v340;
    __twr_v342 = *(uint32_t*)(__twr_v341);
    if (__twr_v342) { goto __twr_l51; } else { goto __twr_l52; }
    __twr_l52:;
    __twr_v343 = 24ULL;
    __twr_v344 = _mng_var331 + __twr_v343;
    __twr_v345 = 8ULL;
    __twr_v346 = 32ULL;
    __twr_v347 = _mng_var331 + __twr_v346;
    __twr_v348 = *(uint64_t*)(__twr_v347);
    __twr_v349 = *(uint64_t*)(__twr_v344);
    *(uint64_t*)(__twr_v348) = __twr_v349;
    __twr_v350 = __twr_v349 + __twr_v345;
    *(uint64_t*)(__twr_v350) = __twr_v348;
    __twr_l51:;
    __twr_v351 = 1ULL;
    __twr_v352 = 48ULL;
    __twr_v353 = _mng_var331 + __twr_v352;
    __twr_v354 = *(uint32_t*)(__twr_v353);
    __twr_v355 = __twr_v354 + __twr_v351;
    *(uint32_t*)(__twr_v353) = __twr_v355;
    __twr_l48:;
    __twr_v356 = *(uint64_t*)(_mng_arg327);
    _mng_arg327 = __twr_v356;
    __twr_l47:;
    if (_mng_arg327) { goto __twr_l45; } else { goto __twr_l46; }
    __twr_l46:;
    __twr_l43:;
    __twr_v357 = 32ULL;
    __twr_v358 = _mng_inst234 + __twr_v357;
    __twr_v359 = *(uint64_t*)(__twr_v358);
    _mng_inst234 = __twr_v359;
    __twr_l20:;
    if (_mng_inst234) { goto __twr_l18; } else { goto __twr_l19; }
    __twr_l19:;
    ...
    __twr_v366 = (uint64_t)(&IrEliminateDeadVariable);
    ((void (*)(uint64_t))__twr_v366)(__twr_v365);
    __twr_v367 = *(uint64_t*)(_mng_listentry363);
    __twr_v368 = 8ULL;
    __twr_v369 = _mng_listentry363 + __twr_v368;
    __twr_v370 = *(uint64_t*)(__twr_v369);
    __twr_v371 = *(uint64_t*)(_mng_listentry363);
    *(uint64_t*)(__twr_v370) = __twr_v371;
    __twr_v372 = __twr_v371 + __twr_v368;
    *(uint64_t*)(__twr_v372) = __twr_v370;
    _mng_listentry363 = __twr_v367;
    __twr_l55:;
    if (_mng_listentry363 != _mng_head361) { goto __twr_l53; } else { goto __twr_l54; }
    __twr_l54:;
}
void IrEliminateDeadVariables() {
    ...
    *(uint64_t*)(__twr_v375) = __twr_v373;
    *(uint64_t*)(__twr_v373) = __twr_v373;
    ...
    __twr_l58:;
    if (_mng_funcsym378) { goto __twr_l56; } else { goto __twr_l57; }
    __twr_l57:;
}
