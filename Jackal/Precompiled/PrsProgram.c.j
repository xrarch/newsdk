...
uint64_t PrsCreateAstNode(uint64_t _mng_type168, uint64_t _mng_token169) {
    ...
    if (!(__twr_v172)) { goto __twr_l3; } else { goto __twr_l4; }
    __twr_l4:;
...
void PrsInsertNodeIntoBlock(uint64_t _mng_block183, uint64_t _mng_node184) {
    ...
    *(uint64_t*)(__twr_v187) = __twr_v185;
    ...
    if (__twr_v190) { goto __twr_l7; } else { goto __twr_l6; }
    __twr_l6:;
...
void PrsPrintType(uint64_t _mng_type198) {
    ...
    __twr_v207 = 0ULL;
    if (__twr_v206 != __twr_v207) { goto __twr_l10; } else { goto __twr_l9; }
    __twr_l9:;
    ...
    __twr_v216 = 3ULL;
    if (__twr_v215 != __twr_v216) { goto __twr_l12; } else { goto __twr_l11; }
    __twr_l11:;
    ...
    __twr_v227 = 2ULL;
    if (__twr_v226 != __twr_v227) { goto __twr_l14; } else { goto __twr_l13; }
    __twr_l13:;
    ...
    __twr_v235 = 1ULL;
    if (__twr_v234 != __twr_v235) { goto __twr_l8; } else { goto __twr_l15; }
    __twr_l15:;
    ...
    if (!(__twr_v240)) { goto __twr_l18; } else { goto __twr_l17; }
    __twr_l17:;
...
uint64_t PrsIsLvalue(uint64_t _mng_node251) {
    ...
    __twr_v255 = 0ULL;
    if (__twr_v254 != __twr_v255) { goto __twr_l19; } else { goto __twr_l20; }
    __twr_l20:;
    ...
    __twr_v263 = 1ULL;
    if (__twr_v262 != __twr_v263) { goto __twr_l21; } else { goto __twr_l22; }
    __twr_l22:;
    __twr_v264 = 0ULL;
    ...
    __twr_v269 = 2ULL;
    if (__twr_v268 != __twr_v269) { goto __twr_l23; } else { goto __twr_l24; }
    __twr_l24:;
    __twr_v270 = 25ULL;
    __twr_v271 = _mng_node251 + __twr_v270;
    __twr_v272 = *(uint8_t*)(__twr_v271);
    __twr_v273 = 68ULL;
    if (__twr_v272 != __twr_v273) { goto __twr_l25; } else { goto __twr_l26; }
    __twr_l26:;
    __twr_v274 = 1ULL;
    ...
    __twr_v278 = 69ULL;
    if (__twr_v277 != __twr_v278) { goto __twr_l27; } else { goto __twr_l28; }
    __twr_l28:;
    __twr_v279 = 1ULL;
    ...
    __twr_v283 = 60ULL;
    if (__twr_v282 != __twr_v283) { goto __twr_l29; } else { goto __twr_l30; }
    __twr_l30:;
    __twr_v284 = 1ULL;
...
uint64_t PrsIsCompileTime(uint64_t _mng_node286) {
    ...
    __twr_v294 = 4ULL;
    if (__twr_v293 != __twr_v294) { goto __twr_l32; } else { goto __twr_l31; }
    __twr_l31:;
    __twr_v295 = 48ULL;
    ...
    __twr_v301 = 2ULL;
    if (__twr_v300 != __twr_v301) { goto __twr_l32; } else { goto __twr_l35; }
    __twr_l35:;
    __twr_v302 = 25ULL;
    __twr_v303 = _mng_node286 + __twr_v302;
    __twr_v304 = *(uint8_t*)(__twr_v303);
    __twr_v305 = 4ULL;
    if (__twr_v304 == __twr_v305) { goto __twr_l31; } else { goto __twr_l32; }
    __twr_l32:;
    __twr_v306 = 40ULL;
    __twr_v307 = _mng_node286 + __twr_v306;
    __twr_v308 = *(uint8_t*)(__twr_v307);
    __twr_v309 = 3ULL;
    if (__twr_v308 != __twr_v309) { goto __twr_l36; } else { goto __twr_l37; }
    __twr_l37:;
    __twr_v310 = 1ULL;
    ...
    __twr_v319 = 5ULL;
    if (__twr_v318 != __twr_v319) { goto __twr_l40; } else { goto __twr_l41; }
    __twr_l41:;
    __twr_v320 = 1ULL;
    ...
    __twr_v324 = 2ULL;
    if (__twr_v323 != __twr_v324) { goto __twr_l42; } else { goto __twr_l44; }
    __twr_l44:;
    __twr_v325 = 25ULL;
    __twr_v326 = _mng_node286 + __twr_v325;
    __twr_v327 = *(uint8_t*)(__twr_v326);
    __twr_v328 = 82ULL;
    if (__twr_v327 != __twr_v328) { goto __twr_l42; } else { goto __twr_l43; }
    __twr_l43:;
    __twr_v329 = 48ULL;
    ...
    if (__twr_v335 != __twr_v331) { goto __twr_l45; } else { goto __twr_l46; }
    __twr_l46:;
    __twr_v336 = 1ULL;
...
uint64_t PrsFieldSequence(uint64_t _mng_o_offset) {
    ...
    __twr_v352 = 84ULL;
    if (__twr_v351 == __twr_v352) { goto __twr_l49; } else { goto __twr_l50; }
    __twr_l50:;
    ...
    __twr_v363 = 3ULL;
    if (__twr_v362 == __twr_v363) { goto __twr_l51; } else { goto __twr_l52; }
    __twr_l52:;
    ...
    __twr_v387 = 3ULL;
    if (__twr_v386 != __twr_v387) { goto __twr_l58; } else { goto __twr_l57; }
    __twr_l57:;
    ...
    __twr_v392 = 6ULL;
    if (__twr_v391 != __twr_v392) { goto __twr_l60; } else { goto __twr_l61; }
    __twr_l61:;
    ...
    __twr_v404 = 3ULL;
    if (__twr_v403 == __twr_v404) { goto __twr_l57; } else { goto __twr_l58; }
    __twr_l58:;
    __twr_v405 = 80ULL;
    __twr_v406 = _mng_type371 + __twr_v405;
    __twr_v407 = *(uint8_t*)(__twr_v406);
    __twr_v408 = 5ULL;
    if (__twr_v407 == __twr_v408) { goto __twr_l62; } else { goto __twr_l63; }
    __twr_l63:;
    ...
    if (__twr_v419) { goto __twr_l64; } else { goto __twr_l65; }
    __twr_l65:;
    ...
    __twr_v429 = 84ULL;
    if (__twr_v428 == __twr_v429) { goto __twr_l66; } else { goto __twr_l67; }
    __twr_l67:;
    ...
    if (__twr_v446) { goto __twr_l68; } else { goto __twr_l69; }
    __twr_l69:;
    goto __twr_l56;
    __twr_l68:;
    goto __twr_l55;
...
uint64_t PrsCheckType(uint64_t _mng_errtoken448, uint64_t _mng_type1449, uint64_t _mng_type2450, uint64_t _mng_errstring451, uint64_t _mng_equivalence452) {
    ...
    uint64_t __twr_v737;
    uint64_t __twr_v738;
    if (_mng_type1449 == _mng_type2450) { goto __twr_l71; } else { goto __twr_l70; }
    __twr_l71:;
    __twr_v453 = 0ULL;
    ...
    __twr_v457 = 3ULL;
    if (__twr_v456 != __twr_v457) { goto __twr_l73; } else { goto __twr_l72; }
    __twr_l72:;
    ...
    __twr_v462 = 6ULL;
    if (__twr_v461 != __twr_v462) { goto __twr_l75; } else { goto __twr_l76; }
    __twr_l76:;
    ...
    __twr_v474 = 3ULL;
    if (__twr_v473 == __twr_v474) { goto __twr_l72; } else { goto __twr_l73; }
    __twr_l73:;
    __twr_v475 = 80ULL;
    __twr_v476 = _mng_type2450 + __twr_v475;
    __twr_v477 = *(uint8_t*)(__twr_v476);
    __twr_v478 = 3ULL;
    if (__twr_v477 != __twr_v478) { goto __twr_l78; } else { goto __twr_l77; }
    __twr_l77:;
    ...
    __twr_v483 = 6ULL;
    if (__twr_v482 != __twr_v483) { goto __twr_l80; } else { goto __twr_l81; }
    __twr_l81:;
    ...
    __twr_v495 = 3ULL;
    if (__twr_v494 == __twr_v495) { goto __twr_l77; } else { goto __twr_l78; }
    __twr_l78:;
    if (_mng_type1449 == _mng_type2450) { goto __twr_l83; } else { goto __twr_l82; }
    __twr_l83:;
    __twr_v496 = 0ULL;
    ...
    if (__twr_v499 == __twr_v501) { goto __twr_l84; } else { goto __twr_l85; }
    __twr_l85:;
    ...
    __twr_v509 = 0ULL;
    if (__twr_v508 != __twr_v509) { goto __twr_l86; } else { goto __twr_l87; }
    __twr_l87:;
    __twr_v510 = *(uint8_t*)(_mng_type1449);
    _mng_primtype1511 = __twr_v510;
    __twr_v512 = *(uint8_t*)(_mng_type2450);
    _mng_primtype2513 = __twr_v512;
    if (__twr_v510 != __twr_v512) { goto __twr_l88; } else { goto __twr_l89; }
    __twr_l89:;
    __twr_v514 = 0ULL;
    _jkl_retv = __twr_v514;
    goto _jkl_epilogue;
    __twr_l88:;
    if (_mng_equivalence452) { goto __twr_l91; } else { goto __twr_l90; }
    __twr_l91:;
    if (_mng_primtype1511 != _mng_primtype2513) { goto __twr_l93; } else { goto __twr_l92; }
    __twr_l93:;
    ...
    if (!(__twr_v521)) { goto __twr_l94; } else { goto __twr_l95; }
    __twr_l95:;
    __twr_v522 = 1ULL;
    ...
    __twr_l94:;
    __twr_v523 = 1ULL;
    if (_mng_primtype1511 <= __twr_v523) { goto __twr_l98; } else { goto __twr_l99; }
    __twr_l99:;
    __twr_v524 = 6ULL;
    if (_mng_primtype1511 >= __twr_v524) { goto __twr_l98; } else { goto __twr_l97; }
    __twr_l97:;
    __twr_v525 = 7ULL;
    if (_mng_primtype2513 <= __twr_v525) { goto __twr_l100; } else { goto __twr_l102; }
    __twr_l102:;
    __twr_v526 = 12ULL;
    if (_mng_primtype2513 >= __twr_v526) { goto __twr_l100; } else { goto __twr_l101; }
    __twr_l101:;
    ...
    __twr_l98:;
    __twr_v531 = 1ULL;
    if (_mng_primtype2513 <= __twr_v531) { goto __twr_l96; } else { goto __twr_l104; }
    __twr_l104:;
    __twr_v532 = 6ULL;
    if (_mng_primtype2513 >= __twr_v532) { goto __twr_l96; } else { goto __twr_l103; }
    __twr_l103:;
    ...
    __twr_v541 = 2ULL;
    if (__twr_v540 != __twr_v541) { goto __twr_l105; } else { goto __twr_l106; }
    __twr_l106:;
    __twr_v542 = *(uint64_t*)(_mng_type1449);
    _mng_type1base543 = __twr_v542;
    if (_mng_equivalence452) { goto __twr_l107; } else { goto __twr_l110; }
    __twr_l110:;
    __twr_v544 = 80ULL;
    __twr_v545 = _mng_type1base543 + __twr_v544;
    __twr_v546 = *(uint8_t*)(__twr_v545);
    __twr_v547 = 0ULL;
    if (__twr_v546 != __twr_v547) { goto __twr_l107; } else { goto __twr_l109; }
    __twr_l109:;
    __twr_v548 = 0ULL;
    __twr_v549 = *(uint8_t*)(_mng_type1base543);
    if (__twr_v549 != __twr_v548) { goto __twr_l107; } else { goto __twr_l108; }
    __twr_l108:;
    __twr_v550 = 0ULL;
    ...
    if (_mng_equivalence452) { goto __twr_l111; } else { goto __twr_l114; }
    __twr_l114:;
    __twr_v553 = 80ULL;
    __twr_v554 = _mng_type2base552 + __twr_v553;
    __twr_v555 = *(uint8_t*)(__twr_v554);
    __twr_v556 = 0ULL;
    if (__twr_v555 != __twr_v556) { goto __twr_l111; } else { goto __twr_l113; }
    __twr_l113:;
    __twr_v557 = 0ULL;
    __twr_v558 = *(uint8_t*)(_mng_type2base552);
    if (__twr_v558 != __twr_v557) { goto __twr_l111; } else { goto __twr_l112; }
    __twr_l112:;
    __twr_v559 = 0ULL;
    ...
    __twr_v563 = 4ULL;
    if (__twr_v562 != __twr_v563) { goto __twr_l115; } else { goto __twr_l117; }
    __twr_l117:;
    __twr_v564 = 80ULL;
    __twr_v565 = _mng_type2base552 + __twr_v564;
    __twr_v566 = *(uint8_t*)(__twr_v565);
    __twr_v567 = 4ULL;
    if (__twr_v566 != __twr_v567) { goto __twr_l115; } else { goto __twr_l116; }
    __twr_l116:;
    __twr_v568 = 69ULL;
    __twr_v569 = _mng_type1base543 + __twr_v568;
    __twr_v570 = *(uint8_t*)(__twr_v569);
    if (!(__twr_v570)) { goto __twr_l120; } else { goto __twr_l119; }
    __twr_l119:;
    __twr_v571 = 24ULL;
    __twr_v572 = _mng_type2base552 + __twr_v571;
    __twr_v573 = *(uint64_t*)(__twr_v572);
    if (__twr_v573 == _mng_type1base543) { goto __twr_l121; } else { goto __twr_l122; }
    __twr_l122:;
    ...
    if (!(__twr_v580)) { goto __twr_l124; } else { goto __twr_l123; }
    __twr_l123:;
    __twr_v581 = 24ULL;
    __twr_v582 = _mng_type1base543 + __twr_v581;
    __twr_v583 = *(uint64_t*)(__twr_v582);
    if (__twr_v583 == _mng_type2base552) { goto __twr_l125; } else { goto __twr_l126; }
    __twr_l126:;
    ...
    if (__twr_v590 == __twr_v592) { goto __twr_l118; } else { goto __twr_l127; }
    __twr_l127:;
    ...
    __twr_v604 = 5ULL;
    if (__twr_v603 != __twr_v604) { goto __twr_l128; } else { goto __twr_l129; }
    __twr_l129:;
    if (_mng_type1449 != _mng_type2450) { goto __twr_l131; } else { goto __twr_l130; }
    __twr_l131:;
    ...
    __twr_v613 = 1ULL;
    if (__twr_v612 != __twr_v613) { goto __twr_l132; } else { goto __twr_l133; }
    __twr_l133:;
    __twr_v614 = 24ULL;
    ...
    if (__twr_v616 == __twr_v618) { goto __twr_l134; } else { goto __twr_l135; }
    __twr_l135:;
    ...
    if (!(__twr_v625)) { goto __twr_l136; } else { goto __twr_l137; }
    __twr_l137:;
    __twr_v626 = 8ULL;
    ...
    if (__twr_v628 == __twr_v630) { goto __twr_l138; } else { goto __twr_l139; }
    __twr_l139:;
    ...
    __twr_v643 = 4ULL;
    if (__twr_v642 != __twr_v643) { goto __twr_l140; } else { goto __twr_l141; }
    __twr_l141:;
    __twr_v644 = 24ULL;
    ...
    if (__twr_v646 == __twr_v648) { goto __twr_l142; } else { goto __twr_l143; }
    __twr_l143:;
    ...
    if (!(__twr_v655)) { goto __twr_l146; } else { goto __twr_l145; }
    __twr_l145:;
    __twr_v656 = 8ULL;
    __twr_v657 = _mng_type2450 + __twr_v656;
    __twr_v658 = *(uint64_t*)(__twr_v657);
    if (__twr_v658) { goto __twr_l147; } else { goto __twr_l148; }
    __twr_l148:;
    ...
    if (!(__twr_v673)) { goto __twr_l144; } else { goto __twr_l149; }
    __twr_l149:;
    ...
    if (__twr_v680 == __twr_v682) { goto __twr_l150; } else { goto __twr_l151; }
    __twr_l151:;
    ...
    if (__twr_v689 == __twr_v691) { goto __twr_l152; } else { goto __twr_l153; }
    __twr_l153:;
    ...
    if (!(__twr_v696)) { goto __twr_l155; } else { goto __twr_l154; }
    __twr_l154:;
    ...
    if (!(__twr_v711)) { goto __twr_l157; } else { goto __twr_l158; }
    __twr_l158:;
    ...
    __twr_l156:;
    if (_mng_arg1697) { goto __twr_l154; } else { goto __twr_l155; }
    __twr_l155:;
    __twr_v735 = 0ULL;
...
uint64_t PrsAtom() {
    ...
    __twr_v745 = 20ULL;
    if (__twr_v744 != __twr_v745) { goto __twr_l161; } else { goto __twr_l160; }
    __twr_l160:;
    ...
    *(uint64_t*)(__twr_v753) = __twr_v751;
    ...
    __twr_v758 = 18ULL;
    if (__twr_v757 != __twr_v758) { goto __twr_l163; } else { goto __twr_l162; }
    __twr_l162:;
    ...
    __twr_v763 = 83ULL;
    if (__twr_v762 != __twr_v763) { goto __twr_l164; } else { goto __twr_l165; }
    __twr_l165:;
    ...
    __twr_v774 = 4ULL;
    if (__twr_v773 != __twr_v774) { goto __twr_l168; } else { goto __twr_l167; }
    __twr_l167:;
    ...
    *(uint64_t*)(__twr_v783) = __twr_v781;
    ...
    __twr_v787 = 1ULL;
    if (__twr_v786 != __twr_v787) { goto __twr_l170; } else { goto __twr_l169; }
    __twr_l169:;
    ...
    __twr_v800 = 19ULL;
    if (__twr_v799 != __twr_v800) { goto __twr_l172; } else { goto __twr_l171; }
    __twr_l171:;
    ...
    __twr_v809 = 3ULL;
    if (__twr_v808 != __twr_v809) { goto __twr_l174; } else { goto __twr_l175; }
    __twr_l175:;
    ...
    __twr_v814 = 70ULL;
    if (__twr_v813 != __twr_v814) { goto __twr_l174; } else { goto __twr_l173; }
    __twr_l173:;
    ...
    if (__twr_v821) { goto __twr_l176; } else { goto __twr_l177; }
    __twr_l177:;
    ...
    __twr_v830 = 3ULL;
    if (__twr_v829 != __twr_v830) { goto __twr_l179; } else { goto __twr_l178; }
    __twr_l178:;
    ...
    if (__twr_v842) { goto __twr_l180; } else { goto __twr_l181; }
    __twr_l181:;
    ...
    if (__twr_v853) { goto __twr_l182; } else { goto __twr_l183; }
    __twr_l183:;
    ...
    *(uint64_t*)(__twr_v860) = __twr_v858;
    ...
    if (!(__twr_v861)) { goto __twr_l184; } else { goto __twr_l185; }
    __twr_l185:;
    ...
    __twr_v867 = 4ULL;
    if (__twr_v866 != __twr_v867) { goto __twr_l187; } else { goto __twr_l186; }
    __twr_l186:;
    ...
    __twr_v872 = 33ULL;
    if (__twr_v871 != __twr_v872) { goto __twr_l190; } else { goto __twr_l189; }
    __twr_l189:;
    ...
    *(uint64_t*)(__twr_v879) = __twr_v877;
    ...
    __twr_v884 = 13ULL;
    if (__twr_v883 == __twr_v884) { goto __twr_l191; } else { goto __twr_l192; }
    __twr_l192:;
    ...
    __twr_v889 = 23ULL;
    if (__twr_v888 != __twr_v889) { goto __twr_l188; } else { goto __twr_l191; }
    __twr_l191:;
    ...
    *(uint64_t*)(__twr_v896) = __twr_v894;
    ...
    __twr_v901 = 16ULL;
    if (__twr_v900 != __twr_v901) { goto __twr_l194; } else { goto __twr_l193; }
    __twr_l193:;
    ...
    __twr_v910 = 3ULL;
    if (__twr_v909 != __twr_v910) { goto __twr_l196; } else { goto __twr_l195; }
    __twr_l195:;
    ...
    __twr_v915 = 6ULL;
    if (__twr_v914 != __twr_v915) { goto __twr_l198; } else { goto __twr_l199; }
    __twr_l199:;
    ...
    __twr_v927 = 3ULL;
    if (__twr_v926 == __twr_v927) { goto __twr_l195; } else { goto __twr_l196; }
    __twr_l196:;
    __twr_v928 = 72ULL;
    __twr_v929 = _mng_type904 + __twr_v928;
    __twr_v930 = *(uint64_t*)(__twr_v929);
    __twr_v931 = 4294967295ULL;
    if (__twr_v930 != __twr_v931) { goto __twr_l200; } else { goto __twr_l201; }
    __twr_l201:;
    ...
    *(uint64_t*)(__twr_v944) = __twr_v942;
    ...
    __twr_v949 = 17ULL;
    if (__twr_v948 != __twr_v949) { goto __twr_l203; } else { goto __twr_l202; }
    __twr_l202:;
...
uint64_t PrsExpression(uint64_t _mng_minprecedence963) {
    ...
    if (!(__twr_v972)) { goto __twr_l205; } else { goto __twr_l204; }
    __twr_l204:;
    ...
    if (__twr_v984) { goto __twr_l207; } else { goto __twr_l208; }
    __twr_l208:;
    ...
    if (__twr_v991 >= _mng_minprecedence963) { goto __twr_l209; } else { goto __twr_l210; }
    __twr_l210:;
    ...
    *(uint64_t*)(__twr_v1000) = _mng_atomnode966;
    ...
    if (__twr_v1003) { goto __twr_l211; } else { goto __twr_l212; }
    __twr_l212:;
    ...
    *(uint64_t*)(__twr_v1012) = __twr_v1010;
    ...
    if (!(__twr_v1013)) { goto __twr_l213; } else { goto __twr_l214; }
    __twr_l214:;
    ...
    if (__twr_v1019) { goto __twr_l204; } else { goto __twr_l205; }
    __twr_l205:;
...
void PrsCheckConstant(uint64_t _mng_errtoken1020, uint64_t _mng_type1021, uint64_t _mng_value1022) {
    ...
    __twr_v1026 = 0ULL;
    if (__twr_v1025 == __twr_v1026) { goto __twr_l215; } else { goto __twr_l216; }
    __twr_l216:;
    goto _jkl_epilogue;
    __twr_l215:;
    ...
    if (__twr_v1033 == _mng_value1022) { goto __twr_l217; } else { goto __twr_l218; }
    __twr_l218:;
...
void PrsParseArrayInitializer(uint64_t _mng_errtoken1041, uint64_t _mng_type1042, uint64_t _mng_bytearray1043, uint64_t _mng_bparray1044) {
    ...
    __twr_v1050 = 3ULL;
    if (__twr_v1049 != __twr_v1050) { goto __twr_l220; } else { goto __twr_l219; }
    __twr_l219:;
    ...
    __twr_v1058 = 3ULL;
    if (__twr_v1057 == __twr_v1058) { goto __twr_l219; } else { goto __twr_l220; }
    __twr_l220:;
    __twr_v1059 = 0ULL;
    __twr_v1060 = 16ULL;
    ...
    if (!(__twr_v1075)) { goto __twr_l224; } else { goto __twr_l225; }
    __twr_l225:;
    goto __twr_l223;
    __twr_l224:;
    ...
    if (!(__twr_v1080)) { goto __twr_l226; } else { goto __twr_l227; }
    __twr_l227:;
    ...
    if (__twr_v1088) { goto __twr_l228; } else { goto __twr_l229; }
    __twr_l229:;
    ...
    if (__twr_v1097) { goto __twr_l230; } else { goto __twr_l231; }
    __twr_l231:;
    ...
    __twr_v1105 = 3ULL;
    if (__twr_v1104 == __twr_v1105) { goto __twr_l232; } else { goto __twr_l233; }
    __twr_l233:;
    ...
    if (__twr_v1111 < _mng_bound1067) { goto __twr_l234; } else { goto __twr_l235; }
    __twr_l235:;
    ...
    __twr_l226:;
    if (_mng_index1068 >= _mng_bound1067) { goto __twr_l237; } else { goto __twr_l236; }
    __twr_l237:;
    ...
    if (!(__twr_v1133)) { goto __twr_l238; } else { goto __twr_l239; }
    __twr_l239:;
    goto __twr_l223;
    __twr_l238:;
    ...
    if (__twr_v1138) { goto __twr_l240; } else { goto __twr_l241; }
    __twr_l241:;
...
void PrsParseStructInitializer(uint64_t _mng_errtoken1143, uint64_t _mng_type1144, uint64_t _mng_bytearray1145, uint64_t _mng_bparray1146) {
    ...
    if (!(__twr_v1152)) { goto __twr_l244; } else { goto __twr_l245; }
    __twr_l245:;
    goto __twr_l243;
    __twr_l244:;
    ...
    if (__twr_v1158) { goto __twr_l246; } else { goto __twr_l247; }
    __twr_l247:;
    ...
    if (__twr_v1168) { goto __twr_l248; } else { goto __twr_l249; }
    __twr_l249:;
    ...
    __twr_v1177 = 84ULL;
    if (__twr_v1176 == __twr_v1177) { goto __twr_l250; } else { goto __twr_l251; }
    __twr_l251:;
    ...
    if (__twr_v1189) { goto __twr_l252; } else { goto __twr_l253; }
    __twr_l253:;
    ...
    if (__twr_v1198) { goto __twr_l254; } else { goto __twr_l255; }
    __twr_l255:;
    ...
    __twr_v1214 = 3ULL;
    if (__twr_v1213 != __twr_v1214) { goto __twr_l257; } else { goto __twr_l256; }
    __twr_l256:;
    ...
    __twr_v1222 = 3ULL;
    if (__twr_v1221 == __twr_v1222) { goto __twr_l256; } else { goto __twr_l257; }
    __twr_l257:;
    ...
    if (!(__twr_v1233)) { goto __twr_l259; } else { goto __twr_l260; }
    __twr_l260:;
    goto __twr_l243;
    __twr_l259:;
    ...
    if (__twr_v1238) { goto __twr_l261; } else { goto __twr_l262; }
    __twr_l262:;
...
uint64_t PrsParseInitializer(uint64_t _mng_errtoken1243, uint64_t _mng_type1244, uint64_t _mng_bytearray1245, uint64_t _mng_bparray1246) {
    ...
    __twr_v1250 = 1ULL;
    if (__twr_v1249 == __twr_v1250) { goto __twr_l263; } else { goto __twr_l265; }
    __twr_l265:;
    __twr_v1251 = 80ULL;
    __twr_v1252 = _mng_type1244 + __twr_v1251;
    __twr_v1253 = *(uint8_t*)(__twr_v1252);
    __twr_v1254 = 5ULL;
    if (__twr_v1253 == __twr_v1254) { goto __twr_l263; } else { goto __twr_l264; }
    __twr_l264:;
    ...
    if (!(__twr_v1260)) { goto __twr_l266; } else { goto __twr_l267; }
    __twr_l267:;
    ...
    __twr_v1272 = 3ULL;
    if (__twr_v1271 != __twr_v1272) { goto __twr_l268; } else { goto __twr_l269; }
    __twr_l269:;
    ...
    __twr_l268:;
    if (_mng_bytearray1245) { goto __twr_l270; } else { goto __twr_l271; }
    __twr_l271:;
    ...
    if (__twr_v1278) { goto __twr_l272; } else { goto __twr_l273; }
    __twr_l273:;
    ...
    __twr_v1285 = 3ULL;
    if (__twr_v1284 != __twr_v1285) { goto __twr_l276; } else { goto __twr_l275; }
    __twr_l275:;
    ...
    if (__twr_v1295 >= __twr_v1300) { goto __twr_l277; } else { goto __twr_l278; }
    __twr_l278:;
    ...
    *(uint64_t*)(_mng_bparray1246) = _mng_expr1268;
    ...
    if (__twr_v1309) { goto __twr_l279; } else { goto __twr_l280; }
    __twr_l280:;
    ...
    __twr_v1317 = 1ULL;
    if (__twr_v1316 != __twr_v1317) { goto __twr_l281; } else { goto __twr_l283; }
    __twr_l283:;
    __twr_v1318 = 24ULL;
    __twr_v1319 = _mng_type1244 + __twr_v1318;
    __twr_v1320 = *(uint8_t*)(__twr_v1319);
    if (__twr_v1320) { goto __twr_l281; } else { goto __twr_l282; }
    __twr_l282:;
    ...
    if (_mng_bytearray1245) { goto __twr_l284; } else { goto __twr_l285; }
    __twr_l285:;
    ...
    if (!(__twr_v1335)) { goto __twr_l286; } else { goto __twr_l287; }
    __twr_l287:;
    ...
    if (!(__twr_v1352)) { goto __twr_l288; } else { goto __twr_l289; }
    __twr_l289:;
    ...
    *(uint64_t*)(__twr_v1371) = __twr_v1369;
    ...
    __twr_v1386 = 1ULL;
    if (__twr_v1385 != __twr_v1386) { goto __twr_l292; } else { goto __twr_l291; }
    __twr_l291:;
...
uint64_t PrsEvaluateType(uint64_t _mng_node1389) {
    ...
    if (!(__twr_v1392)) { goto __twr_l293; } else { goto __twr_l294; }
    __twr_l294:;
    __twr_v1393 = 80ULL;
    ...
    __twr_v1399 = 0ULL;
    if (__twr_v1398 != __twr_v1399) { goto __twr_l297; } else { goto __twr_l296; }
    __twr_l296:;
    ...
    __twr_v1408 = 4ULL;
    if (__twr_v1407 != __twr_v1408) { goto __twr_l299; } else { goto __twr_l298; }
    __twr_l298:;
    ...
    __twr_v1414 = 3ULL;
    if (__twr_v1413 != __twr_v1414) { goto __twr_l301; } else { goto __twr_l300; }
    __twr_l300:;
    __twr_v1415 = 24ULL;
    __twr_v1416 = _mng_node1389 + __twr_v1415;
    __twr_v1417 = *(uint8_t*)(__twr_v1416);
    __twr_v1418 = 4ULL;
    if (__twr_v1417 != __twr_v1418) { goto __twr_l304; } else { goto __twr_l305; }
    __twr_l305:;
    __twr_v1419 = 25ULL;
    __twr_v1420 = _mng_node1389 + __twr_v1419;
    __twr_v1421 = *(uint8_t*)(__twr_v1420);
    __twr_v1422 = 23ULL;
    if (__twr_v1421 != __twr_v1422) { goto __twr_l304; } else { goto __twr_l303; }
    __twr_l303:;
    ...
    __twr_v1430 = 2ULL;
    if (__twr_v1429 != __twr_v1430) { goto __twr_l307; } else { goto __twr_l306; }
    __twr_l306:;
    ...
    __twr_v1451 = 3ULL;
    if (__twr_v1450 != __twr_v1451) { goto __twr_l309; } else { goto __twr_l308; }
    __twr_l308:;
    ...
    __twr_v1456 = 6ULL;
    if (__twr_v1455 != __twr_v1456) { goto __twr_l311; } else { goto __twr_l312; }
    __twr_l312:;
    ...
    __twr_v1467 = 3ULL;
    if (__twr_v1466 == __twr_v1467) { goto __twr_l308; } else { goto __twr_l309; }
    __twr_l309:;
    __twr_v1468 = 80ULL;
...
uint64_t PrsTypeIsDeclarable(uint64_t _mng_errtoken1470, uint64_t _mng_type1471) {
    ...
    if (!(__twr_v1474)) { goto __twr_l313; } else { goto __twr_l314; }
    __twr_l314:;
    __twr_v1475 = 1ULL;
    ...
    __twr_v1480 = 3ULL;
    if (__twr_v1479 != __twr_v1480) { goto __twr_l316; } else { goto __twr_l315; }
    __twr_l315:;
    ...
    __twr_v1485 = 6ULL;
    if (__twr_v1484 != __twr_v1485) { goto __twr_l318; } else { goto __twr_l319; }
    __twr_l319:;
    ...
    __twr_v1496 = 3ULL;
    if (__twr_v1495 == __twr_v1496) { goto __twr_l315; } else { goto __twr_l316; }
    __twr_l316:;
    __twr_v1497 = 80ULL;
    __twr_v1498 = _mng_type1471 + __twr_v1497;
    __twr_v1499 = *(uint8_t*)(__twr_v1498);
    __twr_v1500 = 4ULL;
    if (__twr_v1499 != __twr_v1500) { goto __twr_l320; } else { goto __twr_l321; }
    __twr_l321:;
    __twr_v1501 = 0ULL;
    ...
    __twr_v1505 = 0ULL;
    if (__twr_v1504 != __twr_v1505) { goto __twr_l322; } else { goto __twr_l324; }
    __twr_l324:;
    __twr_v1506 = 0ULL;
    __twr_v1507 = *(uint8_t*)(_mng_type1471);
    if (__twr_v1507 != __twr_v1506) { goto __twr_l322; } else { goto __twr_l323; }
    __twr_l323:;
    __twr_v1508 = 0ULL;
...
uint64_t PrsTypeIsValue(uint64_t _mng_errtoken1512, uint64_t _mng_type1513) {
    ...
    if (!(__twr_v1516)) { goto __twr_l325; } else { goto __twr_l326; }
    __twr_l326:;
    __twr_v1517 = 1ULL;
    ...
    __twr_v1522 = 3ULL;
    if (__twr_v1521 != __twr_v1522) { goto __twr_l328; } else { goto __twr_l327; }
    __twr_l327:;
    ...
    __twr_v1527 = 6ULL;
    if (__twr_v1526 != __twr_v1527) { goto __twr_l330; } else { goto __twr_l331; }
    __twr_l331:;
    ...
    __twr_v1538 = 3ULL;
    if (__twr_v1537 == __twr_v1538) { goto __twr_l327; } else { goto __twr_l328; }
    __twr_l328:;
    __twr_v1539 = 80ULL;
    __twr_v1540 = _mng_type1513 + __twr_v1539;
    __twr_v1541 = *(uint8_t*)(__twr_v1540);
    __twr_v1542 = 4ULL;
    if (__twr_v1541 != __twr_v1542) { goto __twr_l332; } else { goto __twr_l333; }
    __twr_l333:;
    __twr_v1543 = 0ULL;
    ...
    __twr_v1547 = 5ULL;
    if (__twr_v1546 != __twr_v1547) { goto __twr_l334; } else { goto __twr_l335; }
    __twr_l335:;
    __twr_v1548 = 0ULL;
    ...
    __twr_v1552 = 1ULL;
    if (__twr_v1551 != __twr_v1552) { goto __twr_l336; } else { goto __twr_l337; }
    __twr_l337:;
    __twr_v1553 = 0ULL;
    ...
    __twr_v1557 = 0ULL;
    if (__twr_v1556 != __twr_v1557) { goto __twr_l338; } else { goto __twr_l340; }
    __twr_l340:;
    __twr_v1558 = 0ULL;
    __twr_v1559 = *(uint8_t*)(_mng_type1513);
    if (__twr_v1559 != __twr_v1558) { goto __twr_l338; } else { goto __twr_l339; }
    __twr_l339:;
    __twr_v1560 = 0ULL;
...
void PrsCheckNodeIsValue(uint64_t _mng_node1564) {
    ...
    if (__twr_v1568) { goto __twr_l341; } else { goto __twr_l342; }
    __twr_l342:;
...
uint64_t PrsHasSideEffect(uint64_t _mng_node1572) {
    ...
    __twr_v1576 = 2ULL;
    if (__twr_v1575 != __twr_v1576) { goto __twr_l343; } else { goto __twr_l345; }
    __twr_l345:;
    __twr_v1577 = 25ULL;
    __twr_v1578 = _mng_node1572 + __twr_v1577;
    __twr_v1579 = *(uint8_t*)(__twr_v1578);
    __twr_v1580 = 70ULL;
    if (__twr_v1579 != __twr_v1580) { goto __twr_l343; } else { goto __twr_l344; }
    __twr_l344:;
    __twr_v1581 = 1ULL;
...
void PrsType(uint64_t _mng_type1583, uint64_t _mng_depth1584) {
    ...
    __twr_v1591 = 2ULL;
    if (__twr_v1590 != __twr_v1591) { goto __twr_l348; } else { goto __twr_l347; }
    __twr_l347:;
    ...
    if (__twr_v1601) { goto __twr_l349; } else { goto __twr_l350; }
    __twr_l350:;
    ...
    *(uint64_t*)(__twr_v1631) = __twr_v1629;
    ...
    __twr_v1636 = 3ULL;
    if (__twr_v1635 != __twr_v1636) { goto __twr_l352; } else { goto __twr_l353; }
    __twr_l353:;
    ...
    __twr_v1641 = 69ULL;
    if (__twr_v1640 != __twr_v1641) { goto __twr_l352; } else { goto __twr_l351; }
    __twr_l351:;
    ...
    *(uint64_t*)(__twr_v1662) = __twr_v1660;
    ...
    __twr_v1667 = 18ULL;
    if (__twr_v1666 != __twr_v1667) { goto __twr_l355; } else { goto __twr_l354; }
    __twr_l354:;
    ...
    __twr_v1674 = 84ULL;
    if (__twr_v1673 != __twr_v1674) { goto __twr_l358; } else { goto __twr_l357; }
    __twr_l357:;
    __twr_v1675 = 140ULL;
    __twr_v1676 = _mng_symbol1670 + __twr_v1675;
    __twr_v1677 = *(uint8_t*)(__twr_v1676);
    __twr_v1678 = 3ULL;
    if (__twr_v1677 == __twr_v1678) { goto __twr_l359; } else { goto __twr_l361; }
    __twr_l361:;
    __twr_v1679 = 140ULL;
    __twr_v1680 = _mng_symbol1670 + __twr_v1679;
    __twr_v1681 = *(uint8_t*)(__twr_v1680);
    __twr_v1682 = 6ULL;
    if (__twr_v1681 == __twr_v1682) { goto __twr_l359; } else { goto __twr_l360; }
    __twr_l360:;
    ...
    *(uint64_t*)(_mng_type1583) = _mng_symbol1670;
    ...
    __twr_l346:;
    if (_mng_depth1584) { goto __twr_l363; } else { goto __twr_l362; }
    __twr_l363:;
    goto _jkl_epilogue;
    __twr_l362:;
    ...
    if (__twr_v1701) { goto __twr_l364; } else { goto __twr_l365; }
    __twr_l365:;
    goto _jkl_epilogue;
    __twr_l364:;
    __twr_v1702 = 1ULL;
    ...
    __twr_v1715 = 3ULL;
    if (__twr_v1714 != __twr_v1715) { goto __twr_l367; } else { goto __twr_l366; }
    __twr_l366:;
    ...
    __twr_v1720 = 6ULL;
    if (__twr_v1719 != __twr_v1720) { goto __twr_l369; } else { goto __twr_l370; }
    __twr_l370:;
    ...
    __twr_v1732 = 3ULL;
    if (__twr_v1731 == __twr_v1732) { goto __twr_l366; } else { goto __twr_l367; }
    __twr_l367:;
    ...
    if (__twr_v1735) { goto __twr_l371; } else { goto __twr_l372; }
    __twr_l372:;
    ...
    if (__twr_v1742 != __twr_v1743) { goto __twr_l373; } else { goto __twr_l374; }
    __twr_l374:;
    ...
    *(uint8_t*)(__twr_v1770) = _mng_elementalign1751;
    if (_mng_arraytail1765) { goto __twr_l378; } else { goto __twr_l377; }
    __twr_l378:;
    ...
    *(uint64_t*)(__twr_v1773) = _mng_arraytail1765;
    ...
    if (!(__twr_v1776)) { goto __twr_l381; } else { goto __twr_l380; }
    __twr_l380:;
    __twr_v1777 = 1ULL;
    if (_mng_dimensions1703 <= __twr_v1777) { goto __twr_l382; } else { goto __twr_l383; }
    __twr_l383:;
    ...
    *(uint8_t*)(__twr_v1785) = __twr_v1783;
    ...
    __twr_v1793 = 3ULL;
    if (__twr_v1792 == __twr_v1793) { goto __twr_l384; } else { goto __twr_l385; }
    __twr_l385:;
    ...
    if (__twr_v1801 != __twr_v1800) { goto __twr_l386; } else { goto __twr_l387; }
    __twr_l387:;
    ...
    *(uint8_t*)(__twr_v1814) = __twr_v1812;
    ...
    if (__twr_v1819) { goto __twr_l388; } else { goto __twr_l389; }
    __twr_l389:;
    ...
    if (__twr_v1828) { goto __twr_l390; } else { goto __twr_l391; }
    __twr_l391:;
    goto __twr_l376;
    __twr_l390:;
    if (_mng_boundless1705) { goto __twr_l393; } else { goto __twr_l392; }
    __twr_l393:;
    ...
    *(uint64_t*)(_mng_arraytail1765) = _mng_basetype1708;
    if (_mng_boundless1705) { goto __twr_l394; } else { goto __twr_l395; }
    __twr_l395:;
    _mng_walkptr1837 = _mng_arraytail1765;
    if (_mng_arraytail1765) { goto __twr_l396; } else { goto __twr_l397; }
    __twr_l396:;
    __twr_v1838 = 16ULL;
    ...
    *(uint64_t*)(__twr_v1845) = __twr_v1843;
    ...
    __twr_l398:;
    if (_mng_walkptr1837) { goto __twr_l396; } else { goto __twr_l397; }
    __twr_l397:;
    __twr_l394:;
    _jkl_epilogue:;
}
void PrsFoundSymbol(uint64_t _mng_token1849, uint64_t _mng_symbol1850, uint64_t _mng_flags1851, uint64_t _mng_global1852, uint64_t _mng_newtype1853) {
    ...
    __twr_v1857 = 84ULL;
    if (__twr_v1856 != __twr_v1857) { goto __twr_l401; } else { goto __twr_l400; }
    __twr_l400:;
    __twr_v1858 = 140ULL;
    __twr_v1859 = _mng_symbol1850 + __twr_v1858;
    __twr_v1860 = *(uint8_t*)(__twr_v1859);
    __twr_v1861 = 1ULL;
    if (__twr_v1860 == __twr_v1861) { goto __twr_l402; } else { goto __twr_l403; }
    __twr_l403:;
    ...
    if (!(__twr_v1866)) { goto __twr_l404; } else { goto __twr_l405; }
    __twr_l405:;
    ...
    if (__twr_v1874) { goto __twr_l406; } else { goto __twr_l407; }
    __twr_l407:;
    ...
    __twr_l406:;
    if (_mng_global1852) { goto __twr_l408; } else { goto __twr_l409; }
    __twr_l409:;
    ...
    if (_mng_global1852) { goto __twr_l411; } else { goto __twr_l410; }
    __twr_l411:;
    ...
    *(uint64_t*)(__twr_v1900) = __twr_v1899;
    ...
    if (__twr_v1902 != _mng_symbol1850) { goto __twr_l414; } else { goto __twr_l413; }
    __twr_l413:;
    ...
    *(uint64_t*)(__twr_v1908) = _mng_dummyextern1891;
    ...
    if (!(__twr_v1911)) { goto __twr_l417; } else { goto __twr_l416; }
    __twr_l416:;
    __twr_v1913 = 64ULL;
    ...
    *(uint64_t*)(__twr_v1923) = __twr_v1917;
    if (!(__twr_v1917)) { goto __twr_l420; } else { goto __twr_l419; }
    __twr_l419:;
    __twr_v1924 = 64ULL;
    ...
    *(uint8_t*)(__twr_v1930) = __twr_v1928;
    if (_mng_global1852) { goto __twr_l422; } else { goto __twr_l421; }
    __twr_l422:;
    ...
    *(uint64_t*)(__twr_v1938) = __twr_v1932;
    if (!(__twr_v1932)) { goto __twr_l425; } else { goto __twr_l424; }
    __twr_l424:;
    __twr_v1939 = 64ULL;
    ...
    *(uint64_t*)(__twr_v1946) = _mng_newtype1853;
    ...
    if (!(__twr_v1948)) { goto __twr_l428; } else { goto __twr_l427; }
    __twr_l427:;
...
uint64_t PrsVariableDeclaration(uint64_t _mng_token1958, uint64_t _mng_flags1959, uint64_t _mng_global1960) {
    ...
    if (__twr_v1970) { goto __twr_l429; } else { goto __twr_l430; }
    __twr_l430:;
    ...
    if (__twr_v1976) { goto __twr_l431; } else { goto __twr_l432; }
    __twr_l432:;
    ...
    if (__twr_v1985) { goto __twr_l433; } else { goto __twr_l434; }
    __twr_l434:;
    __twr_v1986 = 0ULL;
    ...
    if (_mng_hasinitializer1966) { goto __twr_l436; } else { goto __twr_l435; }
    __twr_l436:;
    __twr_v1989 = 1ULL;
    __twr_v1990 = _mng_flags1959 & __twr_v1989;
    if (!(__twr_v1990)) { goto __twr_l437; } else { goto __twr_l438; }
    __twr_l438:;
    ...
    __twr_l437:;
    if (_mng_type1964) { goto __twr_l441; } else { goto __twr_l440; }
    __twr_l440:;
    ...
    if (__twr_v2000) { goto __twr_l442; } else { goto __twr_l443; }
    __twr_l443:;
    ...
    __twr_v2008 = 3ULL;
    if (__twr_v2007 != __twr_v2008) { goto __twr_l445; } else { goto __twr_l444; }
    __twr_l444:;
    ...
    __twr_v2013 = 6ULL;
    if (__twr_v2012 != __twr_v2013) { goto __twr_l447; } else { goto __twr_l448; }
    __twr_l448:;
    ...
    __twr_v2024 = 3ULL;
    if (__twr_v2023 == __twr_v2024) { goto __twr_l444; } else { goto __twr_l445; }
    __twr_l445:;
    ...
    __twr_v2031 = 5ULL;
    if (__twr_v2030 == __twr_v2031) { goto __twr_l449; } else { goto __twr_l450; }
    __twr_l450:;
    ...
    __twr_v2041 = 1ULL;
    if (__twr_v2040 != __twr_v2041) { goto __twr_l451; } else { goto __twr_l453; }
    __twr_l453:;
    __twr_v2042 = 24ULL;
    __twr_v2043 = _mng_type1964 + __twr_v2042;
    __twr_v2044 = *(uint8_t*)(__twr_v2043);
    if (__twr_v2044) { goto __twr_l451; } else { goto __twr_l452; }
    __twr_l452:;
    ...
    if (_mng_global1960) { goto __twr_l456; } else { goto __twr_l455; }
    __twr_l455:;
    if (_mng_hasinitializer1966) { goto __twr_l458; } else { goto __twr_l457; }
    __twr_l458:;
    ...
    *(uint64_t*)(__twr_v2060) = _mng_initialnode1988;
    ...
    goto __twr_l454;
    __twr_l456:;
    if (_mng_initialnode1988) { goto __twr_l460; } else { goto __twr_l461; }
    __twr_l460:;
    __twr_v2064 = (uint64_t)(&PrsIsCompileTime);
    __twr_v2065 = ((uint64_t (*)(uint64_t))__twr_v2064)(_mng_initialnode1988);
    if (__twr_v2065) { goto __twr_l462; } else { goto __twr_l463; }
    __twr_l463:;
    ...
    *(uint64_t*)(__twr_v2070) = _mng_initialnode1988;
    ...
    if (__twr_v2073 != __twr_v2074) { goto __twr_l464; } else { goto __twr_l465; }
    __twr_l465:;
    __twr_v2075 = 40ULL;
    __twr_v2076 = _mng_initialnode1988 + __twr_v2075;
    __twr_v2077 = *(uint8_t*)(__twr_v2076);
    __twr_v2078 = 3ULL;
    if (__twr_v2077 != __twr_v2078) { goto __twr_l468; } else { goto __twr_l469; }
    __twr_l469:;
    __twr_v2079 = 48ULL;
    __twr_v2080 = _mng_initialnode1988 + __twr_v2079;
    __twr_v2081 = 0ULL;
    __twr_v2082 = *(uint64_t*)(__twr_v2080);
    if (__twr_v2082 != __twr_v2081) { goto __twr_l468; } else { goto __twr_l467; }
    __twr_l467:;
    ...
    *(uint64_t*)(__twr_v2091) = __twr_v2089;
    ...
    if (__twr_v2094 != __twr_v2095) { goto __twr_l470; } else { goto __twr_l471; }
    __twr_l471:;
...
uint64_t PrsGlobalDeclaration() {
    ...
    __twr_v2105 = 22ULL;
    if (__twr_v2104 != __twr_v2105) { goto __twr_l472; } else { goto __twr_l473; }
    __twr_l473:;
    __twr_v2106 = 0ULL;
    ...
    __twr_v2111 = 18ULL;
    if (__twr_v2110 == __twr_v2111) { goto __twr_l474; } else { goto __twr_l476; }
    __twr_l476:;
    ...
    __twr_v2116 = 6ULL;
    if (__twr_v2115 == __twr_v2116) { goto __twr_l474; } else { goto __twr_l475; }
    __twr_l475:;
    ...
    __twr_v2125 = 18ULL;
    if (__twr_v2124 != __twr_v2125) { goto __twr_l477; } else { goto __twr_l478; }
    __twr_l478:;
    ...
    if (__twr_v2131) { goto __twr_l479; } else { goto __twr_l480; }
    __twr_l480:;
...
uint64_t PrsParseBlock(uint64_t _mng_o_terminator) {
    ...
    if (!(__twr_v2154)) { goto __twr_l481; } else { goto __twr_l482; }
    __twr_l482:;
    ...
    *(uint64_t*)(__twr_v2166) = _mng_block2155;
    ...
    if (!(__twr_v2174)) { goto __twr_l485; } else { goto __twr_l486; }
    __twr_l486:;
    ...
    if (__twr_v2182 != __twr_v2181) { goto __twr_l487; } else { goto __twr_l488; }
    __twr_l488:;
    ...
    __twr_v2196 = 3ULL;
    if (__twr_v2194 != __twr_v2196) { goto __twr_l489; } else { goto __twr_l490; }
    __twr_l490:;
    ...
    __twr_l489:;
    __twr_v2201 = 1ULL;
    if (_mng_blockstate2195 != __twr_v2201) { goto __twr_l491; } else { goto __twr_l492; }
    __twr_l492:;
    ...
    __twr_v2206 = 10ULL;
    if (__twr_v2205 == __twr_v2206) { goto __twr_l493; } else { goto __twr_l494; }
    __twr_l494:;
    ...
    __twr_l491:;
    __twr_v2211 = 2ULL;
    if (_mng_blockstate2195 != __twr_v2211) { goto __twr_l495; } else { goto __twr_l496; }
    __twr_l496:;
    goto __twr_l484;
    __twr_l495:;
    ...
    if (!(__twr_v2219)) { goto __twr_l497; } else { goto __twr_l498; }
    __twr_l498:;
    ...
    __twr_v2236 = 18ULL;
    if (__twr_v2235 != __twr_v2236) { goto __twr_l499; } else { goto __twr_l500; }
    __twr_l500:;
    ...
    if (!(__twr_v2242)) { goto __twr_l501; } else { goto __twr_l502; }
    __twr_l502:;
    __twr_v2243 = 1ULL;
    _mng_decl2230 = __twr_v2243;
    __twr_l501:;
    __twr_l499:;
    if (_mng_decl2230) { goto __twr_l504; } else { goto __twr_l505; }
    __twr_l504:;
    ...
    if (!(__twr_v2258)) { goto __twr_l508; } else { goto __twr_l507; }
    __twr_l507:;
    ...
    if (__twr_v2265) { goto __twr_l509; } else { goto __twr_l510; }
    __twr_l510:;
    ...
    if (__twr_v2273) { goto __twr_l511; } else { goto __twr_l512; }
    __twr_l512:;
    ...
    *(uint64_t*)(__twr_v2278) = _mng_leftexpr2253;
    ...
    if (__twr_v2287) { goto __twr_l513; } else { goto __twr_l514; }
    __twr_l514:;
    ...
    *(uint64_t*)(__twr_v2292) = _mng_rightexpr2282;
    ...
    __twr_v2297 = 71ULL;
    if (__twr_v2296 != __twr_v2297) { goto __twr_l515; } else { goto __twr_l516; }
    __twr_l516:;
    ...
    __twr_v2306 = 3ULL;
    if (__twr_v2305 != __twr_v2306) { goto __twr_l517; } else { goto __twr_l518; }
    __twr_l518:;
    ...
    if (!(__twr_v2313)) { goto __twr_l519; } else { goto __twr_l520; }
    __twr_l520:;
...
void PrsParseCompoundTypeIndex(uint64_t _mng_operator2316, uint64_t _mng_node2317) {
    ...
    __twr_v2327 = 5ULL;
    if (__twr_v2326 == __twr_v2327) { goto __twr_l521; } else { goto __twr_l522; }
    __twr_l522:;
    ...
    if (__twr_v2338) { goto __twr_l523; } else { goto __twr_l524; }
    __twr_l524:;
    ...
    __twr_v2347 = 84ULL;
    if (__twr_v2346 == __twr_v2347) { goto __twr_l525; } else { goto __twr_l526; }
    __twr_l526:;
...
void PrsParseArrayIndex(uint64_t _mng_operator2357, uint64_t _mng_node2358) {
    ...
    __twr_v2368 = 1ULL;
    if (__twr_v2367 == __twr_v2368) { goto __twr_l527; } else { goto __twr_l529; }
    __twr_l529:;
    __twr_v2369 = 80ULL;
    __twr_v2370 = _mng_lefttype2364 + __twr_v2369;
    __twr_v2371 = *(uint8_t*)(__twr_v2370);
    __twr_v2372 = 2ULL;
    if (__twr_v2371 == __twr_v2372) { goto __twr_l527; } else { goto __twr_l528; }
    __twr_l528:;
    ...
    *(uint64_t*)(__twr_v2382) = __twr_v2378;
    ...
    if (__twr_v2387) { goto __twr_l530; } else { goto __twr_l531; }
    __twr_l531:;
    ...
    __twr_v2395 = 1ULL;
    if (__twr_v2394 != __twr_v2395) { goto __twr_l532; } else { goto __twr_l535; }
    __twr_l535:;
    __twr_v2396 = 24ULL;
    __twr_v2397 = _mng_lefttype2364 + __twr_v2396;
    __twr_v2398 = *(uint8_t*)(__twr_v2397);
    if (!(__twr_v2398)) { goto __twr_l532; } else { goto __twr_l534; }
    __twr_l534:;
    __twr_v2399 = 40ULL;
    __twr_v2400 = _mng_right2379 + __twr_v2399;
    __twr_v2401 = *(uint8_t*)(__twr_v2400);
    __twr_v2402 = 3ULL;
    if (__twr_v2401 != __twr_v2402) { goto __twr_l532; } else { goto __twr_l533; }
    __twr_l533:;
    __twr_v2403 = 48ULL;
    ...
    if (__twr_v2405 < __twr_v2408) { goto __twr_l536; } else { goto __twr_l537; }
    __twr_l537:;
...
void PrsParseFunctionCall(uint64_t _mng_operator2412, uint64_t _mng_node2413) {
    ...
    __twr_v2424 = 4ULL;
    if (__twr_v2423 == __twr_v2424) { goto __twr_l538; } else { goto __twr_l540; }
    __twr_l540:;
    __twr_v2425 = 80ULL;
    __twr_v2426 = _mng_lefttype2420 + __twr_v2425;
    __twr_v2427 = *(uint8_t*)(__twr_v2426);
    __twr_v2428 = 2ULL;
    if (__twr_v2427 == __twr_v2428) { goto __twr_l538; } else { goto __twr_l539; }
    __twr_l539:;
    ...
    __twr_v2435 = 2ULL;
    if (__twr_v2434 != __twr_v2435) { goto __twr_l541; } else { goto __twr_l542; }
    __twr_l542:;
    ...
    __twr_v2440 = 4ULL;
    if (__twr_v2439 == __twr_v2440) { goto __twr_l543; } else { goto __twr_l544; }
    __twr_l544:;
    ...
    *(uint64_t*)(__twr_v2458) = __twr_v2453;
    ...
    if (!(__twr_v2466)) { goto __twr_l547; } else { goto __twr_l548; }
    __twr_l548:;
    goto __twr_l546;
    __twr_l547:;
    __twr_v2467 = 1ULL;
    ...
    if (__twr_v2468 <= __twr_v2471) { goto __twr_l549; } else { goto __twr_l551; }
    __twr_l551:;
    __twr_v2472 = 68ULL;
    __twr_v2473 = _mng_lefttype2420 + __twr_v2472;
    __twr_v2474 = *(uint8_t*)(__twr_v2473);
    if (__twr_v2474) { goto __twr_l549; } else { goto __twr_l550; }
    __twr_l550:;
    ...
    __twr_l549:;
    if (_mng_refarg2460) { goto __twr_l554; } else { goto __twr_l552; }
    __twr_l554:;
    __twr_v2478 = 48ULL;
    __twr_v2479 = _mng_refarg2460 + __twr_v2478;
    __twr_v2480 = *(uint8_t*)(__twr_v2479);
    __twr_v2481 = 2ULL;
    if (__twr_v2480 != __twr_v2481) { goto __twr_l552; } else { goto __twr_l553; }
    __twr_l553:;
    ...
    if (__twr_v2486) { goto __twr_l555; } else { goto __twr_l556; }
    __twr_l556:;
    ...
    if (__twr_v2499) { goto __twr_l557; } else { goto __twr_l558; }
    __twr_l558:;
    ...
    __twr_l557:;
    if (_mng_refarg2460) { goto __twr_l560; } else { goto __twr_l561; }
    __twr_l560:;
    __twr_v2503 = 48ULL;
    __twr_v2504 = _mng_refarg2460 + __twr_v2503;
    __twr_v2505 = *(uint8_t*)(__twr_v2504);
    __twr_v2506 = 2ULL;
    if (__twr_v2505 != __twr_v2506) { goto __twr_l562; } else { goto __twr_l564; }
    __twr_l564:;
    __twr_v2507 = (uint64_t)(&PrsIsLvalue);
    __twr_v2508 = ((uint64_t (*)(uint64_t))__twr_v2507)(_mng_argnode2494);
    if (__twr_v2508) { goto __twr_l562; } else { goto __twr_l563; }
    __twr_l563:;
    ...
    __twr_v2524 = 3ULL;
    if (__twr_v2523 != __twr_v2524) { goto __twr_l565; } else { goto __twr_l566; }
    __twr_l566:;
    ...
    *(uint64_t*)(__twr_v2540) = __twr_v2538;
    if (_mng_argtail2456) { goto __twr_l569; } else { goto __twr_l568; }
    __twr_l568:;
    __twr_v2541 = 64ULL;
    ...
    *(uint64_t*)(__twr_v2544) = _mng_argnode2494;
    ...
    if (!(__twr_v2549)) { goto __twr_l570; } else { goto __twr_l571; }
    __twr_l571:;
    goto __twr_l546;
    __twr_l570:;
    ...
    if (__twr_v2554) { goto __twr_l572; } else { goto __twr_l573; }
    __twr_l573:;
    ...
    goto __twr_l545;
    __twr_l546:;
    if (_mng_varargcount2454) { goto __twr_l575; } else { goto __twr_l574; }
    __twr_l575:;
    __twr_v2559 = 48ULL;
    __twr_v2560 = _mng_lefttype2420 + __twr_v2559;
    __twr_v2561 = *(uint64_t*)(__twr_v2560);
    _mng_vartable2562 = __twr_v2561;
    if (__twr_v2561) { goto __twr_l578; } else { goto __twr_l577; }
    __twr_l577:;
    ...
    if (!(__twr_v2565)) { goto __twr_l579; } else { goto __twr_l580; }
    __twr_l580:;
    ...
    *(uint64_t*)(__twr_v2590) = _mng_vartabletype2579;
    ...
    if (__twr_v2599 <= __twr_v2603) { goto __twr_l581; } else { goto __twr_l582; }
    __twr_l582:;
    __twr_v2604 = 72ULL;
    ...
    *(uint32_t*)(__twr_v2607) = _mng_varargcount2454;
    ...
    if (_mng_argcount2455 >= __twr_v2610) { goto __twr_l583; } else { goto __twr_l584; }
    __twr_l584:;
...
void PrsParsePtrDereference(uint64_t _mng_operator2614, uint64_t _mng_node2615) {
    ...
    __twr_v2625 = 2ULL;
    if (__twr_v2624 == __twr_v2625) { goto __twr_l585; } else { goto __twr_l586; }
    __twr_l586:;
...
void PrsParseMul(uint64_t _mng_operator2632, uint64_t _mng_node2633) {
    ...
    __twr_v2646 = 3ULL;
    if (__twr_v2645 == __twr_v2646) { goto __twr_l587; } else { goto __twr_l589; }
    __twr_l589:;
    __twr_v2647 = 40ULL;
    __twr_v2648 = _mng_right2641 + __twr_v2647;
    __twr_v2649 = *(uint8_t*)(__twr_v2648);
    __twr_v2650 = 3ULL;
    if (__twr_v2649 == __twr_v2650) { goto __twr_l587; } else { goto __twr_l588; }
    __twr_l588:;
    goto _jkl_epilogue;
    __twr_l587:;
    __twr_v2651 = 40ULL;
    ...
    __twr_v2654 = 3ULL;
    if (__twr_v2653 != __twr_v2654) { goto __twr_l590; } else { goto __twr_l592; }
    __twr_l592:;
    __twr_v2655 = 40ULL;
    __twr_v2656 = _mng_right2641 + __twr_v2655;
    __twr_v2657 = *(uint8_t*)(__twr_v2656);
    __twr_v2658 = 3ULL;
    if (__twr_v2657 != __twr_v2658) { goto __twr_l590; } else { goto __twr_l591; }
    __twr_l591:;
    __twr_v2659 = 3ULL;
    __twr_v2660 = 40ULL;
    ...
    *(uint64_t*)(__twr_v2668) = __twr_v2667;
    ...
    __twr_v2672 = 3ULL;
    if (__twr_v2671 != __twr_v2672) { goto __twr_l593; } else { goto __twr_l594; }
    __twr_l594:;
    __twr_v2673 = 48ULL;
    ...
    *(uint64_t*)(__twr_v2674) = _mng_right2641;
    ...
    __twr_v2681 = 3ULL;
    if (__twr_v2680 != __twr_v2681) { goto __twr_l595; } else { goto __twr_l596; }
    __twr_l596:;
    __twr_v2682 = 48ULL;
    __twr_v2683 = _mng_right2641 + __twr_v2682;
    __twr_v2684 = 0ULL;
    __twr_v2685 = *(uint64_t*)(__twr_v2683);
    if (__twr_v2685 != __twr_v2684) { goto __twr_l599; } else { goto __twr_l598; }
    __twr_l598:;
    __twr_v2686 = 3ULL;
    __twr_v2687 = 40ULL;
    ...
    *(uint64_t*)(__twr_v2691) = __twr_v2689;
    ...
    __twr_v2695 = 1ULL;
    if (__twr_v2694 != __twr_v2695) { goto __twr_l597; } else { goto __twr_l600; }
    __twr_l600:;
    ...
    if (__twr_v2702 == __twr_v2704) { goto __twr_l601; } else { goto __twr_l602; }
    __twr_l602:;
    __twr_v2705 = 63ULL;
    __twr_v2706 = 25ULL;
...
void PrsParseDivide(uint64_t _mng_operator2710, uint64_t _mng_node2711) {
    ...
    __twr_v2724 = 3ULL;
    if (__twr_v2723 == __twr_v2724) { goto __twr_l603; } else { goto __twr_l605; }
    __twr_l605:;
    __twr_v2725 = 40ULL;
    __twr_v2726 = _mng_right2719 + __twr_v2725;
    __twr_v2727 = *(uint8_t*)(__twr_v2726);
    __twr_v2728 = 3ULL;
    if (__twr_v2727 == __twr_v2728) { goto __twr_l603; } else { goto __twr_l604; }
    __twr_l604:;
    goto _jkl_epilogue;
    __twr_l603:;
    __twr_v2729 = 40ULL;
    ...
    __twr_v2732 = 3ULL;
    if (__twr_v2731 != __twr_v2732) { goto __twr_l606; } else { goto __twr_l608; }
    __twr_l608:;
    __twr_v2733 = 40ULL;
    __twr_v2734 = _mng_right2719 + __twr_v2733;
    __twr_v2735 = *(uint8_t*)(__twr_v2734);
    __twr_v2736 = 3ULL;
    if (__twr_v2735 != __twr_v2736) { goto __twr_l606; } else { goto __twr_l607; }
    __twr_l607:;
    __twr_v2737 = 48ULL;
    __twr_v2738 = _mng_right2719 + __twr_v2737;
    __twr_v2739 = 0ULL;
    __twr_v2740 = *(uint64_t*)(__twr_v2738);
    if (__twr_v2740 != __twr_v2739) { goto __twr_l609; } else { goto __twr_l610; }
    __twr_l610:;
    ...
    *(uint64_t*)(__twr_v2753) = __twr_v2752;
    ...
    __twr_v2757 = 3ULL;
    if (__twr_v2756 != __twr_v2757) { goto __twr_l611; } else { goto __twr_l612; }
    __twr_l612:;
    __twr_v2758 = 48ULL;
    __twr_v2759 = _mng_right2719 + __twr_v2758;
    __twr_v2760 = *(uint64_t*)(__twr_v2759);
    __twr_v2761 = 1ULL;
    if (__twr_v2760 != __twr_v2761) { goto __twr_l613; } else { goto __twr_l614; }
    __twr_l614:;
    ...
    if (__twr_v2768 == __twr_v2770) { goto __twr_l615; } else { goto __twr_l616; }
    __twr_l616:;
    __twr_v2771 = 64ULL;
    __twr_v2772 = 25ULL;
...
void PrsParseModulo(uint64_t _mng_operator2776, uint64_t _mng_node2777) {
    ...
    __twr_v2790 = 3ULL;
    if (__twr_v2789 == __twr_v2790) { goto __twr_l617; } else { goto __twr_l619; }
    __twr_l619:;
    __twr_v2791 = 40ULL;
    __twr_v2792 = _mng_right2785 + __twr_v2791;
    __twr_v2793 = *(uint8_t*)(__twr_v2792);
    __twr_v2794 = 3ULL;
    if (__twr_v2793 == __twr_v2794) { goto __twr_l617; } else { goto __twr_l618; }
    __twr_l618:;
    goto _jkl_epilogue;
    __twr_l617:;
    __twr_v2795 = 40ULL;
    ...
    __twr_v2798 = 3ULL;
    if (__twr_v2797 != __twr_v2798) { goto __twr_l620; } else { goto __twr_l622; }
    __twr_l622:;
    __twr_v2799 = 40ULL;
    __twr_v2800 = _mng_right2785 + __twr_v2799;
    __twr_v2801 = *(uint8_t*)(__twr_v2800);
    __twr_v2802 = 3ULL;
    if (__twr_v2801 != __twr_v2802) { goto __twr_l620; } else { goto __twr_l621; }
    __twr_l621:;
    __twr_v2803 = 48ULL;
    __twr_v2804 = _mng_right2785 + __twr_v2803;
    __twr_v2805 = 0ULL;
    __twr_v2806 = *(uint64_t*)(__twr_v2804);
    if (__twr_v2806 != __twr_v2805) { goto __twr_l623; } else { goto __twr_l624; }
    __twr_l624:;
    ...
    *(uint64_t*)(__twr_v2819) = __twr_v2818;
    ...
    __twr_v2823 = 3ULL;
    if (__twr_v2822 != __twr_v2823) { goto __twr_l625; } else { goto __twr_l626; }
    __twr_l626:;
    __twr_v2824 = 48ULL;
    __twr_v2825 = _mng_right2785 + __twr_v2824;
    __twr_v2826 = *(uint64_t*)(__twr_v2825);
    __twr_v2827 = 1ULL;
    if (__twr_v2826 != __twr_v2827) { goto __twr_l627; } else { goto __twr_l628; }
    __twr_l628:;
    __twr_v2828 = 3ULL;
    __twr_v2829 = 40ULL;
    ...
    *(uint64_t*)(__twr_v2833) = __twr_v2831;
    ...
    if (__twr_v2838 == __twr_v2839) { goto __twr_l629; } else { goto __twr_l630; }
    __twr_l630:;
    __twr_v2840 = 50ULL;
    __twr_v2841 = 25ULL;
...
void PrsParsePlus(uint64_t _mng_operator2848, uint64_t _mng_node2849) {
    ...
    __twr_v2862 = 3ULL;
    if (__twr_v2861 == __twr_v2862) { goto __twr_l631; } else { goto __twr_l633; }
    __twr_l633:;
    __twr_v2863 = 40ULL;
    __twr_v2864 = _mng_right2857 + __twr_v2863;
    __twr_v2865 = *(uint8_t*)(__twr_v2864);
    __twr_v2866 = 3ULL;
    if (__twr_v2865 == __twr_v2866) { goto __twr_l631; } else { goto __twr_l632; }
    __twr_l632:;
    goto _jkl_epilogue;
    __twr_l631:;
    __twr_v2867 = 40ULL;
    ...
    __twr_v2870 = 3ULL;
    if (__twr_v2869 != __twr_v2870) { goto __twr_l634; } else { goto __twr_l636; }
    __twr_l636:;
    __twr_v2871 = 40ULL;
    __twr_v2872 = _mng_right2857 + __twr_v2871;
    __twr_v2873 = *(uint8_t*)(__twr_v2872);
    __twr_v2874 = 3ULL;
    if (__twr_v2873 != __twr_v2874) { goto __twr_l634; } else { goto __twr_l635; }
    __twr_l635:;
    __twr_v2875 = 3ULL;
    __twr_v2876 = 40ULL;
    ...
    *(uint64_t*)(__twr_v2884) = __twr_v2883;
    ...
    __twr_v2888 = 3ULL;
    if (__twr_v2887 != __twr_v2888) { goto __twr_l637; } else { goto __twr_l639; }
    __twr_l639:;
    __twr_v2889 = 48ULL;
    __twr_v2890 = _mng_right2857 + __twr_v2889;
    __twr_v2891 = 0ULL;
    __twr_v2892 = *(uint64_t*)(__twr_v2890);
    if (__twr_v2892 != __twr_v2891) { goto __twr_l637; } else { goto __twr_l638; }
    __twr_l638:;
    ...
    __twr_v2898 = 3ULL;
    if (__twr_v2897 != __twr_v2898) { goto __twr_l640; } else { goto __twr_l641; }
    __twr_l641:;
    __twr_v2899 = 48ULL;
    ...
    *(uint64_t*)(__twr_v2900) = _mng_right2857;
    ...
    __twr_v2907 = 2ULL;
    if (__twr_v2906 != __twr_v2907) { goto __twr_l642; } else { goto __twr_l643; }
    __twr_l643:;
    __twr_v2908 = 48ULL;
    ...
    __twr_v2915 = 56ULL;
    if (__twr_v2914 != __twr_v2915) { goto __twr_l646; } else { goto __twr_l647; }
    __twr_l647:;
    __twr_v2916 = 56ULL;
    ...
    __twr_v2922 = 3ULL;
    if (__twr_v2921 != __twr_v2922) { goto __twr_l646; } else { goto __twr_l645; }
    __twr_l645:;
    __twr_v2923 = 48ULL;
    ...
    *(uint64_t*)(__twr_v2933) = __twr_v2932;
    ...
    __twr_v2937 = 57ULL;
    if (__twr_v2936 != __twr_v2937) { goto __twr_l649; } else { goto __twr_l650; }
    __twr_l650:;
    __twr_v2938 = 56ULL;
    ...
    __twr_v2944 = 3ULL;
    if (__twr_v2943 != __twr_v2944) { goto __twr_l649; } else { goto __twr_l648; }
    __twr_l648:;
    __twr_v2945 = 48ULL;
    ...
    *(uint8_t*)(__twr_v2958) = __twr_v2956;
    ...
    __twr_v2962 = 57ULL;
    if (__twr_v2961 != __twr_v2962) { goto __twr_l644; } else { goto __twr_l652; }
    __twr_l652:;
    __twr_v2963 = 48ULL;
    ...
    __twr_v2969 = 3ULL;
    if (__twr_v2968 != __twr_v2969) { goto __twr_l644; } else { goto __twr_l651; }
    __twr_l651:;
    __twr_v2970 = 48ULL;
...
void PrsParseMinus(uint64_t _mng_operator2985, uint64_t _mng_node2986) {
    ...
    __twr_v2999 = 3ULL;
    if (__twr_v2998 == __twr_v2999) { goto __twr_l653; } else { goto __twr_l655; }
    __twr_l655:;
    __twr_v3000 = 40ULL;
    __twr_v3001 = _mng_right2994 + __twr_v3000;
    __twr_v3002 = *(uint8_t*)(__twr_v3001);
    __twr_v3003 = 3ULL;
    if (__twr_v3002 == __twr_v3003) { goto __twr_l653; } else { goto __twr_l654; }
    __twr_l654:;
    goto _jkl_epilogue;
    __twr_l653:;
    __twr_v3004 = 40ULL;
    ...
    __twr_v3007 = 3ULL;
    if (__twr_v3006 != __twr_v3007) { goto __twr_l656; } else { goto __twr_l658; }
    __twr_l658:;
    __twr_v3008 = 40ULL;
    __twr_v3009 = _mng_right2994 + __twr_v3008;
    __twr_v3010 = *(uint8_t*)(__twr_v3009);
    __twr_v3011 = 3ULL;
    if (__twr_v3010 != __twr_v3011) { goto __twr_l656; } else { goto __twr_l657; }
    __twr_l657:;
    __twr_v3012 = 3ULL;
    __twr_v3013 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3021) = __twr_v3020;
    ...
    __twr_v3025 = 3ULL;
    if (__twr_v3024 != __twr_v3025) { goto __twr_l659; } else { goto __twr_l661; }
    __twr_l661:;
    __twr_v3026 = 48ULL;
    __twr_v3027 = _mng_right2994 + __twr_v3026;
    __twr_v3028 = 0ULL;
    __twr_v3029 = *(uint64_t*)(__twr_v3027);
    if (__twr_v3029 != __twr_v3028) { goto __twr_l659; } else { goto __twr_l660; }
    __twr_l660:;
    ...
    __twr_v3035 = 2ULL;
    if (__twr_v3034 != __twr_v3035) { goto __twr_l662; } else { goto __twr_l663; }
    __twr_l663:;
    __twr_v3036 = 48ULL;
    ...
    __twr_v3043 = 57ULL;
    if (__twr_v3042 != __twr_v3043) { goto __twr_l666; } else { goto __twr_l665; }
    __twr_l665:;
    __twr_v3044 = 56ULL;
    ...
    __twr_v3050 = 3ULL;
    if (__twr_v3049 != __twr_v3050) { goto __twr_l669; } else { goto __twr_l668; }
    __twr_l668:;
    __twr_v3051 = 48ULL;
    ...
    *(uint64_t*)(__twr_v3061) = __twr_v3060;
    ...
    __twr_v3068 = 3ULL;
    if (__twr_v3067 != __twr_v3068) { goto __twr_l667; } else { goto __twr_l670; }
    __twr_l670:;
    __twr_v3069 = 48ULL;
    ...
    *(uint64_t*)(__twr_v3080) = __twr_v3079;
    ...
    __twr_v3084 = 56ULL;
    if (__twr_v3083 != __twr_v3084) { goto __twr_l664; } else { goto __twr_l672; }
    __twr_l672:;
    __twr_v3085 = 56ULL;
    ...
    __twr_v3091 = 3ULL;
    if (__twr_v3090 != __twr_v3091) { goto __twr_l664; } else { goto __twr_l671; }
    __twr_l671:;
    __twr_v3092 = 48ULL;
    ...
    *(uint64_t*)(__twr_v3105) = __twr_v3104;
    ...
    __twr_v3109 = 2ULL;
    if (__twr_v3108 != __twr_v3109) { goto __twr_l673; } else { goto __twr_l674; }
    __twr_l674:;
    __twr_v3110 = 48ULL;
    ...
    __twr_v3117 = 57ULL;
    if (__twr_v3116 != __twr_v3117) { goto __twr_l677; } else { goto __twr_l676; }
    __twr_l676:;
    __twr_v3118 = 56ULL;
    ...
    __twr_v3124 = 3ULL;
    if (__twr_v3123 != __twr_v3124) { goto __twr_l680; } else { goto __twr_l679; }
    __twr_l679:;
    __twr_v3125 = 48ULL;
    ...
    *(uint64_t*)(__twr_v3135) = __twr_v3134;
    ...
    __twr_v3142 = 3ULL;
    if (__twr_v3141 != __twr_v3142) { goto __twr_l678; } else { goto __twr_l681; }
    __twr_l681:;
    __twr_v3143 = 48ULL;
    ...
    *(uint64_t*)(__twr_v3155) = __twr_v3154;
    ...
    __twr_v3159 = 56ULL;
    if (__twr_v3158 != __twr_v3159) { goto __twr_l675; } else { goto __twr_l683; }
    __twr_l683:;
    __twr_v3160 = 56ULL;
    ...
    __twr_v3166 = 3ULL;
    if (__twr_v3165 != __twr_v3166) { goto __twr_l675; } else { goto __twr_l682; }
    __twr_l682:;
    __twr_v3167 = 48ULL;
...
void PrsParseLeftShift(uint64_t _mng_operator3178, uint64_t _mng_node3179) {
    ...
    __twr_v3192 = 3ULL;
    if (__twr_v3191 != __twr_v3192) { goto __twr_l684; } else { goto __twr_l686; }
    __twr_l686:;
    __twr_v3193 = 40ULL;
    __twr_v3194 = _mng_right3187 + __twr_v3193;
    __twr_v3195 = *(uint8_t*)(__twr_v3194);
    __twr_v3196 = 3ULL;
    if (__twr_v3195 != __twr_v3196) { goto __twr_l684; } else { goto __twr_l685; }
    __twr_l685:;
    __twr_v3197 = 3ULL;
    __twr_v3198 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3206) = __twr_v3205;
    ...
    __twr_v3210 = 3ULL;
    if (__twr_v3209 != __twr_v3210) { goto __twr_l687; } else { goto __twr_l689; }
    __twr_l689:;
    __twr_v3211 = 48ULL;
    __twr_v3212 = _mng_right3187 + __twr_v3211;
    __twr_v3213 = 0ULL;
    __twr_v3214 = *(uint64_t*)(__twr_v3212);
    if (__twr_v3214 != __twr_v3213) { goto __twr_l687; } else { goto __twr_l688; }
    __twr_l688:;
...
void PrsParseRightShift(uint64_t _mng_operator3217, uint64_t _mng_node3218) {
    ...
    __twr_v3231 = 3ULL;
    if (__twr_v3230 != __twr_v3231) { goto __twr_l690; } else { goto __twr_l692; }
    __twr_l692:;
    __twr_v3232 = 40ULL;
    __twr_v3233 = _mng_right3226 + __twr_v3232;
    __twr_v3234 = *(uint8_t*)(__twr_v3233);
    __twr_v3235 = 3ULL;
    if (__twr_v3234 != __twr_v3235) { goto __twr_l690; } else { goto __twr_l691; }
    __twr_l691:;
    __twr_v3236 = 3ULL;
    __twr_v3237 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3245) = __twr_v3244;
    ...
    __twr_v3249 = 3ULL;
    if (__twr_v3248 != __twr_v3249) { goto __twr_l693; } else { goto __twr_l695; }
    __twr_l695:;
    __twr_v3250 = 48ULL;
    __twr_v3251 = _mng_right3226 + __twr_v3250;
    __twr_v3252 = 0ULL;
    __twr_v3253 = *(uint64_t*)(__twr_v3251);
    if (__twr_v3253 != __twr_v3252) { goto __twr_l693; } else { goto __twr_l694; }
    __twr_l694:;
...
void PrsParseBitAnd(uint64_t _mng_operator3256, uint64_t _mng_node3257) {
    ...
    __twr_v3270 = 3ULL;
    if (__twr_v3269 != __twr_v3270) { goto __twr_l696; } else { goto __twr_l698; }
    __twr_l698:;
    __twr_v3271 = 40ULL;
    __twr_v3272 = _mng_right3265 + __twr_v3271;
    __twr_v3273 = *(uint8_t*)(__twr_v3272);
    __twr_v3274 = 3ULL;
    if (__twr_v3273 != __twr_v3274) { goto __twr_l696; } else { goto __twr_l697; }
    __twr_l697:;
    __twr_v3275 = 3ULL;
    __twr_v3276 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3284) = __twr_v3283;
    ...
    __twr_v3288 = 3ULL;
    if (__twr_v3287 != __twr_v3288) { goto __twr_l699; } else { goto __twr_l700; }
    __twr_l700:;
    __twr_v3289 = 48ULL;
    ...
    *(uint64_t*)(__twr_v3290) = _mng_right3265;
    ...
    __twr_v3297 = 3ULL;
    if (__twr_v3296 != __twr_v3297) { goto __twr_l701; } else { goto __twr_l703; }
    __twr_l703:;
    __twr_v3298 = 48ULL;
    __twr_v3299 = _mng_right3265 + __twr_v3298;
    __twr_v3300 = 0ULL;
    __twr_v3301 = *(uint64_t*)(__twr_v3299);
    if (__twr_v3301 != __twr_v3300) { goto __twr_l701; } else { goto __twr_l702; }
    __twr_l702:;
    __twr_v3302 = 3ULL;
    __twr_v3303 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3307) = __twr_v3305;
    ...
    __twr_v3311 = 3ULL;
    if (__twr_v3310 != __twr_v3311) { goto __twr_l704; } else { goto __twr_l706; }
    __twr_l706:;
    __twr_v3312 = 48ULL;
    __twr_v3313 = _mng_right3265 + __twr_v3312;
    __twr_v3314 = *(uint64_t*)(__twr_v3313);
    __twr_v3315 = 18446744073709551615ULL;
    if (__twr_v3314 != __twr_v3315) { goto __twr_l704; } else { goto __twr_l705; }
    __twr_l705:;
...
void PrsParseBitXor(uint64_t _mng_operator3318, uint64_t _mng_node3319) {
    ...
    __twr_v3332 = 3ULL;
    if (__twr_v3331 != __twr_v3332) { goto __twr_l707; } else { goto __twr_l709; }
    __twr_l709:;
    __twr_v3333 = 40ULL;
    __twr_v3334 = _mng_right3327 + __twr_v3333;
    __twr_v3335 = *(uint8_t*)(__twr_v3334);
    __twr_v3336 = 3ULL;
    if (__twr_v3335 != __twr_v3336) { goto __twr_l707; } else { goto __twr_l708; }
    __twr_l708:;
    __twr_v3337 = 3ULL;
    __twr_v3338 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3346) = __twr_v3345;
    ...
    __twr_v3350 = 3ULL;
    if (__twr_v3349 != __twr_v3350) { goto __twr_l710; } else { goto __twr_l711; }
    __twr_l711:;
    __twr_v3351 = 48ULL;
    ...
    *(uint64_t*)(__twr_v3352) = _mng_right3327;
    ...
    __twr_v3359 = 3ULL;
    if (__twr_v3358 != __twr_v3359) { goto __twr_l712; } else { goto __twr_l714; }
    __twr_l714:;
    __twr_v3360 = 48ULL;
    __twr_v3361 = _mng_right3327 + __twr_v3360;
    __twr_v3362 = 0ULL;
    __twr_v3363 = *(uint64_t*)(__twr_v3361);
    if (__twr_v3363 != __twr_v3362) { goto __twr_l712; } else { goto __twr_l713; }
    __twr_l713:;
    ...
    __twr_v3369 = 3ULL;
    if (__twr_v3368 != __twr_v3369) { goto __twr_l715; } else { goto __twr_l717; }
    __twr_l717:;
    __twr_v3370 = 48ULL;
    __twr_v3371 = _mng_right3327 + __twr_v3370;
    __twr_v3372 = *(uint64_t*)(__twr_v3371);
    __twr_v3373 = 18446744073709551615ULL;
    if (__twr_v3372 != __twr_v3373) { goto __twr_l715; } else { goto __twr_l716; }
    __twr_l716:;
    __twr_v3374 = 2ULL;
    __twr_v3375 = 40ULL;
...
void PrsParseBitOr(uint64_t _mng_operator3380, uint64_t _mng_node3381) {
    ...
    __twr_v3394 = 3ULL;
    if (__twr_v3393 != __twr_v3394) { goto __twr_l718; } else { goto __twr_l720; }
    __twr_l720:;
    __twr_v3395 = 40ULL;
    __twr_v3396 = _mng_right3389 + __twr_v3395;
    __twr_v3397 = *(uint8_t*)(__twr_v3396);
    __twr_v3398 = 3ULL;
    if (__twr_v3397 != __twr_v3398) { goto __twr_l718; } else { goto __twr_l719; }
    __twr_l719:;
    __twr_v3399 = 3ULL;
    __twr_v3400 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3408) = __twr_v3407;
    ...
    __twr_v3412 = 3ULL;
    if (__twr_v3411 != __twr_v3412) { goto __twr_l721; } else { goto __twr_l722; }
    __twr_l722:;
    __twr_v3413 = 48ULL;
    ...
    *(uint64_t*)(__twr_v3414) = _mng_right3389;
    ...
    __twr_v3421 = 3ULL;
    if (__twr_v3420 != __twr_v3421) { goto __twr_l723; } else { goto __twr_l725; }
    __twr_l725:;
    __twr_v3422 = 48ULL;
    __twr_v3423 = _mng_right3389 + __twr_v3422;
    __twr_v3424 = 0ULL;
    __twr_v3425 = *(uint64_t*)(__twr_v3423);
    if (__twr_v3425 != __twr_v3424) { goto __twr_l723; } else { goto __twr_l724; }
    __twr_l724:;
...
void PrsParseLessThan(uint64_t _mng_operator3428, uint64_t _mng_node3429) {
    ...
    __twr_v3442 = 3ULL;
    if (__twr_v3441 != __twr_v3442) { goto __twr_l726; } else { goto __twr_l728; }
    __twr_l728:;
    __twr_v3443 = 40ULL;
    __twr_v3444 = _mng_right3437 + __twr_v3443;
    __twr_v3445 = *(uint8_t*)(__twr_v3444);
    __twr_v3446 = 3ULL;
    if (__twr_v3445 != __twr_v3446) { goto __twr_l726; } else { goto __twr_l727; }
    __twr_l727:;
    __twr_v3447 = 3ULL;
    __twr_v3448 = 40ULL;
...
void PrsParseGreaterThan(uint64_t _mng_operator3457, uint64_t _mng_node3458) {
    ...
    __twr_v3471 = 3ULL;
    if (__twr_v3470 != __twr_v3471) { goto __twr_l729; } else { goto __twr_l731; }
    __twr_l731:;
    __twr_v3472 = 40ULL;
    __twr_v3473 = _mng_right3466 + __twr_v3472;
    __twr_v3474 = *(uint8_t*)(__twr_v3473);
    __twr_v3475 = 3ULL;
    if (__twr_v3474 != __twr_v3475) { goto __twr_l729; } else { goto __twr_l730; }
    __twr_l730:;
    __twr_v3476 = 3ULL;
    __twr_v3477 = 40ULL;
...
void PrsParseLtEq(uint64_t _mng_operator3486, uint64_t _mng_node3487) {
    ...
    __twr_v3500 = 3ULL;
    if (__twr_v3499 != __twr_v3500) { goto __twr_l732; } else { goto __twr_l734; }
    __twr_l734:;
    __twr_v3501 = 40ULL;
    __twr_v3502 = _mng_right3495 + __twr_v3501;
    __twr_v3503 = *(uint8_t*)(__twr_v3502);
    __twr_v3504 = 3ULL;
    if (__twr_v3503 != __twr_v3504) { goto __twr_l732; } else { goto __twr_l733; }
    __twr_l733:;
    __twr_v3505 = 3ULL;
    __twr_v3506 = 40ULL;
...
void PrsParseGtEq(uint64_t _mng_operator3515, uint64_t _mng_node3516) {
    ...
    __twr_v3529 = 3ULL;
    if (__twr_v3528 != __twr_v3529) { goto __twr_l735; } else { goto __twr_l737; }
    __twr_l737:;
    __twr_v3530 = 40ULL;
    __twr_v3531 = _mng_right3524 + __twr_v3530;
    __twr_v3532 = *(uint8_t*)(__twr_v3531);
    __twr_v3533 = 3ULL;
    if (__twr_v3532 != __twr_v3533) { goto __twr_l735; } else { goto __twr_l736; }
    __twr_l736:;
    __twr_v3534 = 3ULL;
    __twr_v3535 = 40ULL;
...
void PrsParseEquiv(uint64_t _mng_operator3544, uint64_t _mng_node3545) {
    ...
    __twr_v3558 = 3ULL;
    if (__twr_v3557 != __twr_v3558) { goto __twr_l738; } else { goto __twr_l740; }
    __twr_l740:;
    __twr_v3559 = 40ULL;
    __twr_v3560 = _mng_right3553 + __twr_v3559;
    __twr_v3561 = *(uint8_t*)(__twr_v3560);
    __twr_v3562 = 3ULL;
    if (__twr_v3561 != __twr_v3562) { goto __twr_l738; } else { goto __twr_l739; }
    __twr_l739:;
    __twr_v3563 = 3ULL;
    __twr_v3564 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3572) = __twr_v3571;
    ...
    __twr_v3576 = 3ULL;
    if (__twr_v3575 != __twr_v3576) { goto __twr_l741; } else { goto __twr_l742; }
    __twr_l742:;
    __twr_v3577 = 48ULL;
...
void PrsParseNotEquiv(uint64_t _mng_operator3582, uint64_t _mng_node3583) {
    ...
    __twr_v3596 = 3ULL;
    if (__twr_v3595 != __twr_v3596) { goto __twr_l743; } else { goto __twr_l745; }
    __twr_l745:;
    __twr_v3597 = 40ULL;
    __twr_v3598 = _mng_right3591 + __twr_v3597;
    __twr_v3599 = *(uint8_t*)(__twr_v3598);
    __twr_v3600 = 3ULL;
    if (__twr_v3599 != __twr_v3600) { goto __twr_l743; } else { goto __twr_l744; }
    __twr_l744:;
    __twr_v3601 = 3ULL;
    __twr_v3602 = 40ULL;
    ...
    *(uint64_t*)(__twr_v3610) = __twr_v3609;
    ...
    __twr_v3614 = 3ULL;
    if (__twr_v3613 != __twr_v3614) { goto __twr_l746; } else { goto __twr_l747; }
    __twr_l747:;
    __twr_v3615 = 48ULL;
...
void PrsParseAnd(uint64_t _mng_operator3620, uint64_t _mng_node3621) {
    ...
    __twr_v3634 = 3ULL;
    if (__twr_v3633 != __twr_v3634) { goto __twr_l748; } else { goto __twr_l750; }
    __twr_l750:;
    __twr_v3635 = 40ULL;
    __twr_v3636 = _mng_right3629 + __twr_v3635;
    __twr_v3637 = *(uint8_t*)(__twr_v3636);
    __twr_v3638 = 3ULL;
    if (__twr_v3637 != __twr_v3638) { goto __twr_l748; } else { goto __twr_l749; }
    __twr_l749:;
    __twr_v3639 = 3ULL;
    __twr_v3640 = 40ULL;
    ...
    *(uint8_t*)(__twr_v3641) = __twr_v3639;
    ...
    if (!(__twr_v3644)) { goto __twr_l753; } else { goto __twr_l751; }
    __twr_l751:;
    __twr_v3645 = 48ULL;
    __twr_v3646 = _mng_right3629 + __twr_v3645;
    __twr_v3647 = *(uint64_t*)(__twr_v3646);
    if (!(__twr_v3647)) { goto __twr_l753; } else { goto __twr_l752; }
    __twr_l752:;
    __twr_v3648 = 1ULL;
...
void PrsParseOr(uint64_t _mng_operator3653, uint64_t _mng_node3654) {
    ...
    __twr_v3667 = 3ULL;
    if (__twr_v3666 != __twr_v3667) { goto __twr_l755; } else { goto __twr_l757; }
    __twr_l757:;
    __twr_v3668 = 40ULL;
    __twr_v3669 = _mng_right3662 + __twr_v3668;
    __twr_v3670 = *(uint8_t*)(__twr_v3669);
    __twr_v3671 = 3ULL;
    if (__twr_v3670 != __twr_v3671) { goto __twr_l755; } else { goto __twr_l756; }
    __twr_l756:;
    __twr_v3672 = 3ULL;
    __twr_v3673 = 40ULL;
    ...
    *(uint8_t*)(__twr_v3674) = __twr_v3672;
    ...
    if (__twr_v3677) { goto __twr_l759; } else { goto __twr_l758; }
    __twr_l758:;
    __twr_v3678 = 48ULL;
    __twr_v3679 = _mng_right3662 + __twr_v3678;
    __twr_v3680 = *(uint64_t*)(__twr_v3679);
    if (!(__twr_v3680)) { goto __twr_l760; } else { goto __twr_l759; }
    __twr_l759:;
    __twr_v3681 = 1ULL;
...
void PrsParseAddrOf(uint64_t _mng_operator3686, uint64_t _mng_node3687) {
    ...
    *(uint8_t*)(__twr_v3690) = __twr_v3688;
    ...
    if (__twr_v3696) { goto __twr_l762; } else { goto __twr_l763; }
    __twr_l763:;
    ...
    __twr_v3703 = 0ULL;
    if (__twr_v3702 != __twr_v3703) { goto __twr_l764; } else { goto __twr_l765; }
    __twr_l765:;
    ...
    if (__twr_v3707 == __twr_v3711) { goto __twr_l766; } else { goto __twr_l767; }
    __twr_l767:;
    ...
    __twr_v3717 = 5ULL;
    if (__twr_v3716 == __twr_v3717) { goto __twr_l768; } else { goto __twr_l769; }
    __twr_l769:;
...
void PrsParseInverse(uint64_t _mng_operator3721, uint64_t _mng_node3722) {
    ...
    __twr_v3731 = 3ULL;
    if (__twr_v3730 != __twr_v3731) { goto __twr_l770; } else { goto __twr_l771; }
    __twr_l771:;
    __twr_v3732 = 3ULL;
    __twr_v3733 = 40ULL;
...
void PrsParseNot(uint64_t _mng_operator3756, uint64_t _mng_node3757) {
    ...
    __twr_v3766 = 2ULL;
    if (__twr_v3765 != __twr_v3766) { goto __twr_l772; } else { goto __twr_l774; }
    __twr_l774:;
    __twr_v3767 = 25ULL;
    __twr_v3768 = _mng_left3761 + __twr_v3767;
    __twr_v3769 = *(uint8_t*)(__twr_v3768);
    __twr_v3770 = 22ULL;
    if (__twr_v3769 != __twr_v3770) { goto __twr_l772; } else { goto __twr_l773; }
    __twr_l773:;
    ...
    __twr_v3779 = 3ULL;
    if (__twr_v3778 != __twr_v3779) { goto __twr_l775; } else { goto __twr_l776; }
    __twr_l776:;
    __twr_v3780 = 3ULL;
    __twr_v3781 = 40ULL;
...
void PrsParseBitNot(uint64_t _mng_operator3788, uint64_t _mng_node3789) {
    ...
    __twr_v3798 = 2ULL;
    if (__twr_v3797 != __twr_v3798) { goto __twr_l777; } else { goto __twr_l779; }
    __twr_l779:;
    __twr_v3799 = 25ULL;
    __twr_v3800 = _mng_left3793 + __twr_v3799;
    __twr_v3801 = *(uint8_t*)(__twr_v3800);
    __twr_v3802 = 65ULL;
    if (__twr_v3801 != __twr_v3802) { goto __twr_l777; } else { goto __twr_l778; }
    __twr_l778:;
    ...
    __twr_v3811 = 3ULL;
    if (__twr_v3810 != __twr_v3811) { goto __twr_l780; } else { goto __twr_l781; }
    __twr_l781:;
    __twr_v3812 = 3ULL;
    __twr_v3813 = 40ULL;
...
void PrsParseCast(uint64_t _mng_operator3820, uint64_t _mng_node3821) {
    ...
    *(uint64_t*)(__twr_v3826) = __twr_v3824;
    ...
    if (__twr_v3834) { goto __twr_l782; } else { goto __twr_l783; }
    __twr_l783:;
...
void PrsParseContainerOf(uint64_t _mng_operator3845, uint64_t _mng_node3846) {
    ...
    *(uint64_t*)(__twr_v3858) = __twr_v3856;
    ...
    if (__twr_v3866) { goto __twr_l784; } else { goto __twr_l785; }
    __twr_l785:;
...
void PrsParseSizeOfValue(uint64_t _mng_operator3906, uint64_t _mng_node3907) {
    ...
    if (__twr_v3916 != __twr_v3917) { goto __twr_l786; } else { goto __twr_l787; }
    __twr_l787:;
...
uint64_t PrsCreateNamedType(uint64_t _mng_token3929) {
    ...
    __twr_v3935 = 84ULL;
    if (__twr_v3934 != __twr_v3935) { goto __twr_l788; } else { goto __twr_l789; }
    __twr_l789:;
    __twr_v3936 = 140ULL;
    __twr_v3937 = _mng_symbol3931 + __twr_v3936;
    __twr_v3938 = *(uint8_t*)(__twr_v3937);
    __twr_v3939 = 6ULL;
    if (__twr_v3938 == __twr_v3939) { goto __twr_l790; } else { goto __twr_l791; }
    __twr_l791:;
...
uint64_t PrsParseEnum() {
    ...
    if (__twr_v3951) { goto __twr_l792; } else { goto __twr_l793; }
    __twr_l793:;
    ...
    if (__twr_v3965) { goto __twr_l794; } else { goto __twr_l795; }
    __twr_l795:;
    ...
    *(uint64_t*)(__twr_v3975) = __twr_v3971;
    ...
    if (!(__twr_v3982)) { goto __twr_l798; } else { goto __twr_l799; }
    __twr_l799:;
    goto __twr_l797;
    __twr_l798:;
    ...
    if (__twr_v3987) { goto __twr_l800; } else { goto __twr_l801; }
    __twr_l801:;
    ...
    __twr_v3996 = 84ULL;
    if (__twr_v3995 != __twr_v3996) { goto __twr_l802; } else { goto __twr_l803; }
    __twr_l803:;
    ...
    *(uint64_t*)(__twr_v4008) = _mng_value3976;
    ...
    if (!(__twr_v4012)) { goto __twr_l804; } else { goto __twr_l805; }
    __twr_l805:;
    ...
    __twr_v4020 = 3ULL;
    if (__twr_v4019 == __twr_v4020) { goto __twr_l806; } else { goto __twr_l807; }
    __twr_l807:;
    ...
    *(uint64_t*)(__twr_v4028) = __twr_v4026;
    ...
    if (!(__twr_v4035)) { goto __twr_l808; } else { goto __twr_l809; }
    __twr_l809:;
    goto __twr_l797;
    __twr_l808:;
    ...
    if (__twr_v4040) { goto __twr_l810; } else { goto __twr_l811; }
    __twr_l811:;
...
uint64_t PrsParseFnSignature(uint64_t _mng_flags4045, uint64_t _mng_fnptr4046, uint64_t _mng_o_outsymbol) {
    ...
    if (!(__twr_v4052)) { goto __twr_l812; } else { goto __twr_l813; }
    __twr_l813:;
    ...
    if (__twr_v4058) { goto __twr_l814; } else { goto __twr_l815; }
    __twr_l815:;
    ...
    __twr_v4067 = 83ULL;
    if (__twr_v4066 != __twr_v4067) { goto __twr_l816; } else { goto __twr_l817; }
    __twr_l817:;
    ...
    __twr_l816:;
    if (_mng_fnptr4046) { goto __twr_l819; } else { goto __twr_l818; }
    __twr_l819:;
    ...
    __twr_v4082 = 3ULL;
    if (__twr_v4081 == __twr_v4082) { goto __twr_l820; } else { goto __twr_l821; }
    __twr_l821:;
    ...
    __twr_v4093 = 2ULL;
    if (__twr_v4092 == __twr_v4093) { goto __twr_l822; } else { goto __twr_l823; }
    __twr_l823:;
    ...
    __twr_v4102 = 4ULL;
    if (__twr_v4101 == __twr_v4102) { goto __twr_l824; } else { goto __twr_l825; }
    __twr_l825:;
    ...
    if (__twr_v4111) { goto __twr_l826; } else { goto __twr_l827; }
    __twr_l827:;
    ...
    if (__twr_v4121) { goto __twr_l828; } else { goto __twr_l829; }
    __twr_l829:;
    ...
    if (_mng_fnptr4046) { goto __twr_l831; } else { goto __twr_l830; }
    __twr_l831:;
    ...
    if (__twr_v4137) { goto __twr_l832; } else { goto __twr_l833; }
    __twr_l833:;
    ...
    *(uint64_t*)(__twr_v4171) = __twr_v4149;
    ...
    if (!(__twr_v4178)) { goto __twr_l836; } else { goto __twr_l837; }
    __twr_l837:;
    goto __twr_l835;
    __twr_l836:;
    ...
    if (!(__twr_v4181)) { goto __twr_l838; } else { goto __twr_l839; }
    __twr_l839:;
    ...
    __twr_v4191 = 5ULL;
    if (__twr_v4190 == __twr_v4191) { goto __twr_l840; } else { goto __twr_l841; }
    __twr_l841:;
    ...
    __twr_v4200 = 18ULL;
    if (__twr_v4199 != __twr_v4200) { goto __twr_l844; } else { goto __twr_l843; }
    __twr_l843:;
    __twr_v4201 = 1ULL;
    __twr_v4202 = 48ULL;
    ...
    *(uint8_t*)(__twr_v4203) = __twr_v4201;
    ...
    if (__twr_v4207 != __twr_v4205) { goto __twr_l846; } else { goto __twr_l845; }
    __twr_l845:;
    __twr_v4208 = 2ULL;
    __twr_v4209 = 48ULL;
    ...
    *(uint8_t*)(__twr_v4210) = __twr_v4208;
    ...
    __twr_v4215 = 67ULL;
    if (__twr_v4214 != __twr_v4215) { goto __twr_l842; } else { goto __twr_l847; }
    __twr_l847:;
    __twr_v4216 = 1ULL;
    __twr_v4217 = 68ULL;
    __twr_v4218 = _mng_type4144 + __twr_v4217;
    *(uint8_t*)(__twr_v4218) = __twr_v4216;
    if (_mng_fnptr4046) { goto __twr_l848; } else { goto __twr_l849; }
    __twr_l849:;
    ...
    if (__twr_v4224) { goto __twr_l850; } else { goto __twr_l851; }
    __twr_l851:;
    ...
    __twr_v4233 = 84ULL;
    if (__twr_v4232 != __twr_v4233) { goto __twr_l852; } else { goto __twr_l853; }
    __twr_l853:;
    ...
    *(uint64_t*)(__twr_v4251) = __twr_v4249;
    ...
    if (__twr_v4254) { goto __twr_l854; } else { goto __twr_l855; }
    __twr_l855:;
    ...
    __twr_v4263 = 84ULL;
    if (__twr_v4262 != __twr_v4263) { goto __twr_l856; } else { goto __twr_l857; }
    __twr_l857:;
    ...
    *(uint64_t*)(__twr_v4281) = __twr_v4279;
    ...
    if (__twr_v4286) { goto __twr_l858; } else { goto __twr_l859; }
    __twr_l859:;
    ...
    *(uint64_t*)(_mng_arg4182) = __twr_v4292;
    if (_mng_argtail4172) { goto __twr_l862; } else { goto __twr_l861; }
    __twr_l861:;
    ...
    *(uint64_t*)(_mng_argtail4172) = _mng_arg4182;
    ...
    __twr_v4303 = 18ULL;
    if (__twr_v4302 == __twr_v4303) { goto __twr_l863; } else { goto __twr_l864; }
    __twr_l864:;
    ...
    __twr_v4312 = 84ULL;
    if (__twr_v4311 != __twr_v4312) { goto __twr_l865; } else { goto __twr_l866; }
    __twr_l866:;
    ...
    *(uint8_t*)(__twr_v4335) = __twr_v4333;
    ...
    if (__twr_v4339) { goto __twr_l867; } else { goto __twr_l868; }
    __twr_l868:;
    ...
    *(uint64_t*)(__twr_v4347) = __twr_v4345;
    ...
    if (__twr_v4354) { goto __twr_l869; } else { goto __twr_l870; }
    __twr_l870:;
    ...
    if (!(__twr_v4363)) { goto __twr_l871; } else { goto __twr_l872; }
    __twr_l872:;
    goto __twr_l835;
    __twr_l871:;
    ...
    if (__twr_v4368) { goto __twr_l873; } else { goto __twr_l874; }
    __twr_l874:;
    ...
    goto __twr_l834;
    __twr_l835:;
    if (_mng_fnptr4046) { goto __twr_l876; } else { goto __twr_l877; }
    __twr_l877:;
    __twr_v4373 = 1ULL;
    __twr_v4374 = _mng_flags4045 & __twr_v4373;
    if (!(__twr_v4374)) { goto __twr_l875; } else { goto __twr_l876; }
    __twr_l876:;
    ...
    if (!(__twr_v4381)) { goto __twr_l880; } else { goto __twr_l879; }
    __twr_l879:;
    ...
    if (__twr_v4390) { goto __twr_l881; } else { goto __twr_l882; }
    __twr_l882:;
    ...
    *(uint64_t*)(__twr_v4396) = _mng_returntype4384;
    ...
    ((void (*)())__twr_v4397)();
    __twr_l878:;
    if (_mng_fnptr4046) { goto __twr_l883; } else { goto __twr_l885; }
    __twr_l885:;
    __twr_v4398 = 1ULL;
    __twr_v4399 = _mng_flags4045 & __twr_v4398;
    __twr_v4400 = 0ULL;
    if (__twr_v4399 != __twr_v4400) { goto __twr_l883; } else { goto __twr_l884; }
    __twr_l884:;
    __twr_v4401 = (uint64_t)(&LexResetScope);
    __twr_v4402 = ((uint64_t (*)(uint64_t))__twr_v4401)(_mng_oldscope4151);
    __twr_l883:;
    if (_mng_fnptrtype4048) { goto __twr_l887; } else { goto __twr_l886; }
    __twr_l887:;
    ...
    *(uint64_t*)(__twr_v4409) = _mng_fnptrtype4048;
    __twr_l886:;
    if (_mng_fnptr4046) { goto __twr_l888; } else { goto __twr_l889; }
    __twr_l889:;
...
uint64_t PrsParseFnDeclaration(uint64_t _mng_flags4414) {
    ...
    if (!(__twr_v4421)) { goto __twr_l890; } else { goto __twr_l891; }
    __twr_l891:;
    ...
    if (__twr_v4424 != __twr_v4425) { goto __twr_l892; } else { goto __twr_l893; }
    __twr_l893:;
    ...
    *(uint64_t*)(__twr_v4456) = __twr_v4437;
    ...
    if (!(__twr_v4458)) { goto __twr_l896; } else { goto __twr_l895; }
    __twr_l895:;
...
uint64_t PrsParseCompoundType(uint64_t _mng_subtype4493, uint64_t _mng_ispacked4494) {
    ...
    if (__twr_v4503) { goto __twr_l897; } else { goto __twr_l898; }
    __twr_l898:;
    ...
    *(uint64_t*)(__twr_v4522) = __twr_v4513;
    ...
    if (!(__twr_v4530)) { goto __twr_l901; } else { goto __twr_l902; }
    __twr_l902:;
    ...
    if (__twr_v4537) { goto __twr_l903; } else { goto __twr_l904; }
    __twr_l904:;
    ...
    __twr_v4546 = 83ULL;
    if (__twr_v4545 == __twr_v4546) { goto __twr_l905; } else { goto __twr_l906; }
    __twr_l906:;
    ...
    if (__twr_v4560) { goto __twr_l907; } else { goto __twr_l908; }
    __twr_l908:;
    ...
    *(uint64_t*)(__twr_v4569) = __twr_v4566;
    ...
    __twr_v4575 = 3ULL;
    if (__twr_v4574 != __twr_v4575) { goto __twr_l910; } else { goto __twr_l909; }
    __twr_l909:;
    ...
    __twr_v4580 = 6ULL;
    if (__twr_v4579 != __twr_v4580) { goto __twr_l912; } else { goto __twr_l913; }
    __twr_l913:;
    ...
    __twr_v4592 = 3ULL;
    if (__twr_v4591 == __twr_v4592) { goto __twr_l909; } else { goto __twr_l910; }
    __twr_l910:;
    ...
    if (__twr_v4595) { goto __twr_l914; } else { goto __twr_l915; }
    __twr_l915:;
    ...
    if (__twr_v4602 != __twr_v4603) { goto __twr_l916; } else { goto __twr_l917; }
    __twr_l917:;
    ...
    if (__twr_v4610 <= _mng_minalignment4523) { goto __twr_l918; } else { goto __twr_l919; }
    __twr_l919:;
    __twr_v4611 = 81ULL;
    ...
    __twr_l918:;
    __twr_v4614 = 30ULL;
    if (_mng_subtype4493 != __twr_v4614) { goto __twr_l922; } else { goto __twr_l921; }
    __twr_l921:;
    if (_mng_ispacked4494) { goto __twr_l923; } else { goto __twr_l924; }
    __twr_l924:;
    __twr_v4615 = 81ULL;
    ...
    *(uint64_t*)(__twr_v4631) = __twr_v4629;
    ...
    if (__twr_v4634 <= _mng_offset4524) { goto __twr_l925; } else { goto __twr_l926; }
    __twr_l926:;
    __twr_v4635 = 72ULL;
    ...
    if (!(__twr_v4642)) { goto __twr_l927; } else { goto __twr_l928; }
    __twr_l928:;
    goto __twr_l900;
    __twr_l927:;
    ...
    if (__twr_v4647) { goto __twr_l929; } else { goto __twr_l930; }
    __twr_l930:;
...
uint64_t PrsParseType() {
    ...
    if (__twr_v4674) { goto __twr_l931; } else { goto __twr_l932; }
    __twr_l932:;
    ...
    if (__twr_v4688) { goto __twr_l933; } else { goto __twr_l934; }
    __twr_l934:;
    ...
    *(uint64_t*)(__twr_v4699) = __twr_v4694;
    ...
    __twr_v4704 = 3ULL;
    if (__twr_v4703 != __twr_v4704) { goto __twr_l936; } else { goto __twr_l935; }
    __twr_l935:;
    ...
    __twr_v4709 = 6ULL;
    if (__twr_v4708 != __twr_v4709) { goto __twr_l938; } else { goto __twr_l939; }
    __twr_l939:;
    goto __twr_l936;
    __twr_l938:;
    ...
    if (_mng_type4695 != __twr_v4713) { goto __twr_l940; } else { goto __twr_l941; }
    __twr_l941:;
    ...
    __twr_v4721 = 3ULL;
    if (__twr_v4720 == __twr_v4721) { goto __twr_l935; } else { goto __twr_l936; }
    __twr_l936:;
...
uint64_t PrsParseStorageClassSpecifier(uint64_t _mng_flags4722) {
    ...
    if (!(__twr_v4727)) { goto __twr_l944; } else { goto __twr_l943; }
    __twr_l943:;
    ...
    if (__twr_v4736) { goto __twr_l945; } else { goto __twr_l946; }
    __twr_l946:;
    ...
    if (__twr_v4746) { goto __twr_l947; } else { goto __twr_l948; }
    __twr_l948:;
...
void PrsParseBreak(uint64_t _mng_token4767) {
    ...
    if (__twr_v4769) { goto __twr_l949; } else { goto __twr_l950; }
    __twr_l950:;
...
void PrsParseContinue(uint64_t _mng_token4779) {
    ...
    if (__twr_v4781) { goto __twr_l951; } else { goto __twr_l952; }
    __twr_l952:;
...
void PrsParseGoTo(uint64_t _mng_token4791) {
    ...
    if (__twr_v4803) { goto __twr_l953; } else { goto __twr_l954; }
    __twr_l954:;
    ...
    __twr_v4815 = 84ULL;
    if (__twr_v4814 != __twr_v4815) { goto __twr_l957; } else { goto __twr_l956; }
    __twr_l956:;
    __twr_v4816 = 140ULL;
    __twr_v4817 = _mng_symbol4811 + __twr_v4816;
    __twr_v4818 = *(uint8_t*)(__twr_v4817);
    __twr_v4819 = 5ULL;
    if (__twr_v4818 == __twr_v4819) { goto __twr_l958; } else { goto __twr_l960; }
    __twr_l960:;
    __twr_v4820 = 140ULL;
    __twr_v4821 = _mng_symbol4811 + __twr_v4820;
    __twr_v4822 = *(uint8_t*)(__twr_v4821);
    __twr_v4823 = 2ULL;
    if (__twr_v4822 == __twr_v4823) { goto __twr_l958; } else { goto __twr_l959; }
    __twr_l959:;
...
void PrsParseIf(uint64_t _mng_token4848) {
    ...
    *(uint64_t*)(__twr_v4859) = __twr_v4853;
    ...
    if (!(__twr_v4864)) { goto __twr_l963; } else { goto __twr_l964; }
    __twr_l964:;
    ...
    *(uint64_t*)(__twr_v4875) = __twr_v4871;
    ...
    if (__twr_v4881) { goto __twr_l965; } else { goto __twr_l966; }
    __twr_l966:;
    ...
    *(uint64_t*)(__twr_v4896) = __twr_v4893;
    ...
    ((void (*)())__twr_v4899)();
    if (_mng_ignore4860) { goto __twr_l968; } else { goto __twr_l970; }
    __twr_l970:;
    __twr_v4900 = 40ULL;
    __twr_v4901 = _mng_cond4872 + __twr_v4900;
    __twr_v4902 = *(uint8_t*)(__twr_v4901);
    __twr_v4903 = 3ULL;
    if (__twr_v4902 != __twr_v4903) { goto __twr_l969; } else { goto __twr_l971; }
    __twr_l971:;
    __twr_v4904 = 48ULL;
    __twr_v4905 = _mng_cond4872 + __twr_v4904;
    __twr_v4906 = 0ULL;
    __twr_v4907 = *(uint64_t*)(__twr_v4905);
    if (__twr_v4907 != __twr_v4906) { goto __twr_l969; } else { goto __twr_l968; }
    __twr_l968:;
    __twr_v4908 = 16ULL;
    ...
    if (!(__twr_v4913)) { goto __twr_l972; } else { goto __twr_l973; }
    __twr_l973:;
    ...
    *(uint64_t*)(_mng_thiscase4865) = __twr_v4918;
    ...
    if (__twr_v4921) { goto __twr_l976; } else { goto __twr_l975; }
    __twr_l975:;
    __twr_v4922 = 48ULL;
    ...
    *(uint64_t*)(__twr_v4928) = _mng_thiscase4865;
    ...
    __twr_v4932 = 3ULL;
    if (__twr_v4931 != __twr_v4932) { goto __twr_l977; } else { goto __twr_l979; }
    __twr_l979:;
    __twr_v4933 = 48ULL;
    __twr_v4934 = _mng_cond4872 + __twr_v4933;
    __twr_v4935 = *(uint64_t*)(__twr_v4934);
    if (!(__twr_v4935)) { goto __twr_l977; } else { goto __twr_l978; }
    __twr_l978:;
    __twr_v4936 = 1ULL;
    ...
    __twr_l967:;
    __twr_v4937 = 10ULL;
    if (_mng_terminator4894 != __twr_v4937) { goto __twr_l980; } else { goto __twr_l981; }
    __twr_l981:;
    goto __twr_l962;
    __twr_l980:;
    __twr_v4938 = 8ULL;
    if (_mng_terminator4894 != __twr_v4938) { goto __twr_l982; } else { goto __twr_l983; }
    __twr_l983:;
    __twr_v4939 = 1ULL;
    ...
    __twr_l982:;
    __twr_v4940 = 9ULL;
    if (_mng_terminator4894 != __twr_v4940) { goto __twr_l984; } else { goto __twr_l985; }
    __twr_l985:;
    goto __twr_l961;
    __twr_l984:;
    ...
    goto __twr_l961;
    __twr_l962:;
    if (_mng_elsenext4861) { goto __twr_l987; } else { goto __twr_l986; }
    __twr_l987:;
    ...
    ((void (*)())__twr_v4956)();
    if (_mng_ignore4860) { goto __twr_l989; } else { goto __twr_l990; }
    __twr_l989:;
    __twr_v4957 = 20ULL;
    __twr_v4958 = _mng_elseblock4953 + __twr_v4957;
    __twr_v4959 = *(uint32_t*)(__twr_v4958);
    if (!(__twr_v4959)) { goto __twr_l991; } else { goto __twr_l992; }
    __twr_l992:;
...
void PrsParseLeave(uint64_t _mng_token4968) {
    ...
    if (!(__twr_v4973)) { goto __twr_l993; } else { goto __twr_l994; }
    __twr_l994:;
...
void PrsParseReturn(uint64_t _mng_token4986) {
    ...
    if (__twr_v4991) { goto __twr_l995; } else { goto __twr_l996; }
    __twr_l996:;
    ...
    if (__twr_v5011) { goto __twr_l997; } else { goto __twr_l998; }
    __twr_l998:;
    ...
    __twr_v5022 = 3ULL;
    if (__twr_v5021 != __twr_v5022) { goto __twr_l999; } else { goto __twr_l1000; }
    __twr_l1000:;
...
void PrsParseWhile(uint64_t _mng_token5029) {
    ...
    *(uint64_t*)(__twr_v5040) = __twr_v5036;
    ...
    if (__twr_v5045) { goto __twr_l1001; } else { goto __twr_l1002; }
    __twr_l1002:;
    ...
    *(uint32_t*)(__twr_v5056) = __twr_v5065;
    ...
    __twr_v5072 = 3ULL;
    if (__twr_v5071 != __twr_v5072) { goto __twr_l1003; } else { goto __twr_l1005; }
    __twr_l1005:;
    __twr_v5073 = 48ULL;
    __twr_v5074 = _mng_cond5037 + __twr_v5073;
    __twr_v5075 = 0ULL;
    __twr_v5076 = *(uint64_t*)(__twr_v5074);
    if (__twr_v5076 != __twr_v5075) { goto __twr_l1003; } else { goto __twr_l1004; }
    __twr_l1004:;
    __twr_v5077 = 56ULL;
    ...
    if (!(__twr_v5082)) { goto __twr_l1006; } else { goto __twr_l1007; }
    __twr_l1007:;
...
void PrsParseLabel(uint64_t _mng_token5097) {
    ...
    if (__twr_v5109) { goto __twr_l1008; } else { goto __twr_l1009; }
    __twr_l1009:;
    ...
    __twr_v5121 = 84ULL;
    if (__twr_v5120 != __twr_v5121) { goto __twr_l1012; } else { goto __twr_l1011; }
    __twr_l1011:;
    __twr_v5122 = 140ULL;
    __twr_v5123 = _mng_symbol5117 + __twr_v5122;
    __twr_v5124 = *(uint8_t*)(__twr_v5123);
    __twr_v5125 = 5ULL;
    if (__twr_v5124 == __twr_v5125) { goto __twr_l1013; } else { goto __twr_l1014; }
    __twr_l1014:;
...
uint64_t PrsEvalArrayIndex(uint64_t _mng_node5158) {
    ...
    __twr_v5168 = 1ULL;
    if (__twr_v5167 != __twr_v5168) { goto __twr_l1015; } else { goto __twr_l1016; }
    __twr_l1016:;
...
uint64_t PrsEvalFunctionCall(uint64_t _mng_node5171) {
    ...
    if (__twr_v5180) { goto __twr_l1017; } else { goto __twr_l1018; }
    __twr_l1018:;
...
uint64_t PrsEvalArithmetic(uint64_t _mng_node5194) {
    ...
    __twr_v5209 = 2ULL;
    if (__twr_v5208 != __twr_v5209) { goto __twr_l1019; } else { goto __twr_l1020; }
    __twr_l1020:;
    ...
    __twr_v5216 = 2ULL;
    if (__twr_v5215 != __twr_v5216) { goto __twr_l1021; } else { goto __twr_l1022; }
    __twr_l1022:;
    ...
    __twr_v5220 = 3ULL;
    if (__twr_v5219 != __twr_v5220) { goto __twr_l1023; } else { goto __twr_l1024; }
    __twr_l1024:;
    _jkl_retv = _mng_righttype5212;
    goto _jkl_epilogue;
    __twr_l1023:;
    ...
    __twr_v5224 = 3ULL;
    if (__twr_v5223 != __twr_v5224) { goto __twr_l1025; } else { goto __twr_l1026; }
    __twr_l1026:;
    _jkl_retv = _mng_lefttype5205;
    goto _jkl_epilogue;
    __twr_l1025:;
...
void PrsProgram() {
    ...
    if (!(__twr_v5360)) { goto __twr_l1028; } else { goto __twr_l1027; }
    __twr_l1027:;
    __twr_l1029:;
    __twr_v5361 = (uint64_t)(&PrsGlobalDeclaration);
    __twr_v5362 = ((uint64_t (*)())__twr_v5361)();
    if (__twr_v5362) { goto __twr_l1027; } else { goto __twr_l1028; }
    __twr_l1028:;
    _jkl_epilogue:;
}
