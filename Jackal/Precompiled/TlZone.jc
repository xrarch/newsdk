...
void TlInitializeZone(uint64_t _mng_zone102, uint64_t _mng_blocksize103) {
    ...
    __twr_v109 = _mng_blocksize103 & __twr_v108;
    _mng_blocksize103 = __twr_v109;
    __twr_v110 = 0ULL;
    __twr_v111 = _mng_zone102 + __twr_v110;
    *(uint64_t*)(__twr_v111) = _mng_blocksize103;
    __twr_v112 = 0ULL;
    __twr_v113 = 8ULL;
    __twr_v114 = _mng_zone102 + __twr_v113;
...
uint64_t TlAllocateFromZone(uint64_t _mng_zone115) {
    ...
    uint64_t __twr_v126;
    uint64_t __twr_v127;
    uint64_t _mng_blocksize128;
    uint64_t __twr_v129;
    uint64_t __twr_v130;
    uint64_t _mng_chunksize131;
    uint64_t __twr_v132;
    uint64_t __twr_v133;
    uint64_t _mng_chunk134;
    uint64_t __twr_v135;
    ...
    if (_mng_block119) { goto __twr_l4; } else { goto __twr_l3; }
    __twr_l4:;
    __twr_v120 = 0ULL;
    __twr_v121 = _mng_block119 + __twr_v120;
    __twr_v122 = *(uint64_t*)(__twr_v121);
    __twr_v123 = 8ULL;
    __twr_v124 = _mng_zone115 + __twr_v123;
    *(uint64_t*)(__twr_v124) = __twr_v122;
    return _mng_block119;
    __twr_l3:;
    __twr_v125 = 0ULL;
    __twr_v126 = _mng_zone115 + __twr_v125;
    __twr_v127 = *(uint64_t*)(__twr_v126);
    _mng_blocksize128 = __twr_v127;
    __twr_v129 = 5ULL;
    __twr_v130 = _mng_blocksize128 << __twr_v129;
    _mng_chunksize131 = __twr_v130;
    __twr_v132 = (uint64_t)(&TlBumpAlloc);
    __twr_v133 = (uint64_t)(&_mng_chunk134);
    __twr_v135 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v132)(_mng_chunksize131, __twr_v133);
    _mng_status136 = __twr_v135;
    if (_mng_status136) { goto __twr_l6; } else { goto __twr_l5; }
    __twr_l6:;
    ...
    __twr_v140 = 0ULL;
    __twr_v141 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v137)(__twr_v138, __twr_v139, __twr_v140, __twr_v141);
    __twr_l5:;
    _mng_block119 = _mng_chunk134;
    __twr_v142 = _mng_chunk134 + _mng_blocksize128;
    _mng_chunk134 = __twr_v142;
    __twr_v143 = 1ULL;
    _mng_i144 = __twr_v143;
    __twr_v145 = 32ULL;
    if (_mng_i144 < __twr_v145) { goto __twr_l7; } else { goto __twr_l8; }
    __twr_l7:;
    __twr_v146 = 8ULL;
    __twr_v147 = _mng_zone115 + __twr_v146;
    __twr_v148 = *(uint64_t*)(__twr_v147);
    __twr_v149 = 0ULL;
    __twr_v150 = _mng_chunk134 + __twr_v149;
    *(uint64_t*)(__twr_v150) = __twr_v148;
    __twr_v151 = 8ULL;
    __twr_v152 = _mng_zone115 + __twr_v151;
    *(uint64_t*)(__twr_v152) = _mng_chunk134;
    __twr_v153 = 1ULL;
    __twr_v154 = _mng_i144 + __twr_v153;
    _mng_i144 = __twr_v154;
    __twr_v155 = _mng_chunk134 + _mng_blocksize128;
    _mng_chunk134 = __twr_v155;
    __twr_l9:;
    __twr_v156 = 32ULL;
    if (_mng_i144 < __twr_v156) { goto __twr_l7; } else { goto __twr_l8; }
    __twr_l8:;
    return _mng_block119;
}
void TlFreeToZone(uint64_t _mng_zone157, uint64_t _mng_block158) {
    uint64_t _mng_blockheader159;
    uint64_t __twr_v160;
    uint64_t __twr_v161;
    uint64_t __twr_v162;
    uint64_t __twr_v163;
    ...
    uint64_t __twr_v165;
    uint64_t __twr_v166;
    _mng_blockheader159 = _mng_block158;
    __twr_v160 = 8ULL;
    __twr_v161 = _mng_zone157 + __twr_v160;
    __twr_v162 = *(uint64_t*)(__twr_v161);
    __twr_v163 = 0ULL;
    __twr_v164 = _mng_blockheader159 + __twr_v163;
    *(uint64_t*)(__twr_v164) = __twr_v162;
    __twr_v165 = 8ULL;
    __twr_v166 = _mng_zone157 + __twr_v165;
    *(uint64_t*)(__twr_v166) = _mng_blockheader159;
}
