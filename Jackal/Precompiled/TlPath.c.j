...
uint64_t TlMatchPath(uint64_t _mng_path114, uint64_t _mng_pathset115, uint64_t _mng_resultingpath116, uint64_t _mng_o_handle) {
    ...
    __twr_v129 = 0ULL;
    if (__twr_v128 != __twr_v129) { goto __twr_l12; } else { goto __twr_l13; }
    __twr_l13:;
    ...
    ((void (*)(uint64_t))__twr_v131)(_mng_resultingpath116);
    __twr_v132 = 1ULL;
    _mng_initialized120 = 1ULL;
    __twr_v133 = (uint64_t)(&TlCopyIntoDynamicBuffer);
    __twr_v134 = _mng_pathset115 + _mng_lastoff122;
    __twr_v135 = _mng_i121 - _mng_lastoff122;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v133)(_mng_resultingpath116, __twr_v134, __twr_v135);
    __twr_v136 = 16ULL;
    __twr_v137 = _mng_resultingpath116 + __twr_v136;
    __twr_v138 = *(uint64_t*)(__twr_v137);
    __twr_v139 = *(uint64_t*)(_mng_resultingpath116);
    ...
    __twr_v145 = 47ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v144)(_mng_resultingpath116, __twr_v145);
    __twr_l17:;
    __twr_v146 = (uint64_t)(&TlCopyIntoDynamicBuffer);
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v146)(_mng_resultingpath116, _mng_path114, _mng_pathlen119);
    __twr_v147 = (uint64_t)(&TlInsertDynamicBuffer);
    __twr_v148 = 0ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v147)(_mng_resultingpath116, __twr_v148);
    __twr_v149 = (uint64_t)(&TlOpenSource);
    __twr_v150 = 16ULL;
    __twr_v151 = _mng_resultingpath116 + __twr_v150;
    ...
    __twr_l19:;
    __twr_v157 = 1ULL;
    __twr_v158 = _mng_i121 + __twr_v157;
    _mng_lastoff122 = __twr_v158;
    _mng_length123 = 0ULL;
    goto __twr_l10;
    __twr_l12:;
    __twr_v159 = _mng_pathset115 + _mng_i121;
    __twr_v160 = *(uint8_t*)(__twr_v159);
    __twr_v161 = 58ULL;
    if (__twr_v160 != __twr_v161) { goto __twr_l22; } else { goto __twr_l21; }
    __twr_l21:;
    __twr_v162 = 1ULL;
    __twr_v163 = _mng_i121 + __twr_v162;
    _mng_lastoff122 = __twr_v163;
    _mng_length123 = 0ULL;
    goto __twr_l10;
    __twr_l22:;
    __twr_v164 = _mng_pathset115 + _mng_i121;
    __twr_v165 = *(uint8_t*)(__twr_v164);
    __twr_v166 = 0ULL;
    if (__twr_v165 != __twr_v166) { goto __twr_l24; } else { goto __twr_l23; }
    __twr_l23:;
    goto __twr_l9;
    goto __twr_l10;
    __twr_l24:;
    __twr_v167 = 1ULL;
    __twr_v168 = _mng_length123 + __twr_v167;
    _mng_length123 = __twr_v168;
    __twr_l10:;
    __twr_v169 = 1ULL;
    __twr_v170 = _mng_i121 + __twr_v169;
    _mng_i121 = __twr_v170;
    goto __twr_l8;
    __twr_l9:;
    if (!(_mng_initialized120)) { goto __twr_l25; } else { goto __twr_l26; }
    __twr_l26:;
    __twr_v171 = (uint64_t)(&TlUninitializeDynamicBuffer);
    ((void (*)(uint64_t))__twr_v171)(_mng_resultingpath116);
    __twr_l25:;
    __twr_v172 = 0ULL;
