...
void TlCopyParentPath(uint64_t _mng_srcpath102, uint64_t _mng_destpath103) {
    ...
    __twr_v107 = *(uint8_t*)(_mng_srcpath102);
    if (!(__twr_v107)) { goto __twr_l2; } else { goto __twr_l1; }
    __twr_l1:;
    __twr_v108 = _mng_srcpath102 + _mng_i105;
    __twr_v109 = *(uint8_t*)(__twr_v108);
    __twr_v110 = 47ULL;
    if (__twr_v109 != __twr_v110) { goto __twr_l4; } else { goto __twr_l5; }
    __twr_l5:;
    __twr_v111 = (uint64_t)(&TlCopyIntoDynamicBuffer);
    __twr_v112 = 1ULL;
    __twr_v113 = _mng_srcpath102 + _mng_lastoff106;
    __twr_v114 = _mng_i105 - _mng_lastoff106;
    __twr_v115 = __twr_v114 + __twr_v112;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v111)(_mng_destpath103, __twr_v113, __twr_v115);
    ...
    __twr_l3:;
    __twr_v119 = _mng_srcpath102 + _mng_i105;
    __twr_v120 = *(uint8_t*)(__twr_v119);
    if (__twr_v120) { goto __twr_l1; } else { goto __twr_l2; }
    __twr_l2:;
}
uint64_t TlMatchPath(uint64_t _mng_path121, uint64_t _mng_pathset122, uint64_t _mng_resultingpath123, uint64_t _mng_handle124) {
    uint64_t __twr_v125;
    uint64_t __twr_v126;
    uint64_t _mng_pathlen127;
    uint64_t __twr_v128;
    ...
    uint64_t __twr_v180;
    uint64_t __twr_v181;
    __twr_v125 = (uint64_t)(&TlMeasureString);
    __twr_v126 = ((uint64_t (*)(uint64_t))__twr_v125)(_mng_path121);
    _mng_pathlen127 = __twr_v126;
    __twr_v128 = 0ULL;
    _mng_initialized129 = __twr_v128;
    _mng_i130 = __twr_v128;
    _mng_lastoff131 = __twr_v128;
    _mng_length132 = __twr_v128;
    __twr_l6:;
    __twr_v133 = _mng_pathset122 + _mng_i130;
    __twr_v134 = *(uint8_t*)(__twr_v133);
    __twr_v135 = 58ULL;
    if (__twr_v134 == __twr_v135) { goto __twr_l11; } else { goto __twr_l12; }
    __twr_l12:;
    __twr_v136 = _mng_pathset122 + _mng_i130;
    __twr_v137 = *(uint8_t*)(__twr_v136);
    __twr_v138 = 0ULL;
    if (__twr_v137 != __twr_v138) { goto __twr_l10; } else { goto __twr_l11; }
    __twr_l11:;
    if (_mng_length132) { goto __twr_l9; } else { goto __twr_l10; }
    __twr_l9:;
    if (_mng_initialized129) { goto __twr_l14; } else { goto __twr_l13; }
    __twr_l14:;
    __twr_v139 = (uint64_t)(&TlUninitializeDynamicBuffer);
    ((void (*)(uint64_t))__twr_v139)(_mng_resultingpath123);
    __twr_l13:;
    __twr_v140 = (uint64_t)(&TlInitializeDynamicBuffer);
    ((void (*)(uint64_t))__twr_v140)(_mng_resultingpath123);
    __twr_v141 = 1ULL;
    _mng_initialized129 = __twr_v141;
    __twr_v142 = (uint64_t)(&TlCopyIntoDynamicBuffer);
    __twr_v143 = _mng_pathset122 + _mng_lastoff131;
    __twr_v144 = _mng_i130 - _mng_lastoff131;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v142)(_mng_resultingpath123, __twr_v143, __twr_v144);
    __twr_v145 = 16ULL;
    __twr_v146 = _mng_resultingpath123 + __twr_v145;
    __twr_v147 = *(uint64_t*)(__twr_v146);
    __twr_v148 = *(uint64_t*)(_mng_resultingpath123);
    __twr_v149 = __twr_v148 - __twr_v141;
    __twr_v150 = __twr_v147 + __twr_v149;
    __twr_v151 = *(uint8_t*)(__twr_v150);
    __twr_v152 = 47ULL;
    if (__twr_v151 == __twr_v152) { goto __twr_l15; } else { goto __twr_l16; }
    __twr_l16:;
    __twr_v153 = (uint64_t)(&TlInsertDynamicBuffer);
    __twr_v154 = 47ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v153)(_mng_resultingpath123, __twr_v154);
    __twr_l15:;
    __twr_v155 = (uint64_t)(&TlCopyIntoDynamicBuffer);
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v155)(_mng_resultingpath123, _mng_path121, _mng_pathlen127);
    __twr_v156 = (uint64_t)(&TlInsertDynamicBuffer);
    __twr_v157 = 0ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v156)(_mng_resultingpath123, __twr_v157);
    __twr_v158 = (uint64_t)(&TlOpenSource);
    __twr_v159 = 16ULL;
    __twr_v160 = _mng_resultingpath123 + __twr_v159;
    __twr_v161 = *(uint64_t*)(__twr_v160);
    __twr_v162 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v158)(__twr_v161, _mng_handle124);
    if (__twr_v162) { goto __twr_l17; } else { goto __twr_l18; }
    __twr_l18:;
    __twr_v163 = 1ULL;
    return __twr_v163;
    __twr_l17:;
    __twr_v164 = 1ULL;
    __twr_v165 = _mng_i130 + __twr_v164;
    _mng_lastoff131 = __twr_v165;
    __twr_v166 = 0ULL;
    _mng_length132 = __twr_v166;
    goto __twr_l8;
    __twr_l10:;
    __twr_v167 = _mng_pathset122 + _mng_i130;
    __twr_v168 = *(uint8_t*)(__twr_v167);
    __twr_v169 = 58ULL;
    if (__twr_v168 != __twr_v169) { goto __twr_l20; } else { goto __twr_l19; }
    __twr_l19:;
    __twr_v170 = 1ULL;
    __twr_v171 = _mng_i130 + __twr_v170;
    _mng_lastoff131 = __twr_v171;
    __twr_v172 = 0ULL;
    _mng_length132 = __twr_v172;
    goto __twr_l8;
    __twr_l20:;
    __twr_v173 = _mng_pathset122 + _mng_i130;
    __twr_v174 = *(uint8_t*)(__twr_v173);
    __twr_v175 = 0ULL;
    if (__twr_v174 != __twr_v175) { goto __twr_l22; } else { goto __twr_l21; }
    __twr_l21:;
    goto __twr_l7;
    goto __twr_l8;
    __twr_l22:;
    __twr_v176 = 1ULL;
    __twr_v177 = _mng_length132 + __twr_v176;
    _mng_length132 = __twr_v177;
    __twr_l8:;
    __twr_v178 = 1ULL;
    __twr_v179 = _mng_i130 + __twr_v178;
    _mng_i130 = __twr_v179;
    goto __twr_l6;
    __twr_l7:;
    if (_mng_initialized129) { goto __twr_l24; } else { goto __twr_l23; }
    __twr_l24:;
    __twr_v180 = (uint64_t)(&TlUninitializeDynamicBuffer);
    ((void (*)(uint64_t))__twr_v180)(_mng_resultingpath123);
    __twr_l23:;
    __twr_v181 = 0ULL;
    return __twr_v181;
}
