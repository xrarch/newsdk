...
uint64_t LirCreateRegister() {
    ...
    if (!(__twr_v187)) { goto __twr_l3; } else { goto __twr_l4; }
    __twr_l4:;
...
void LirRemoveInstruction(uint64_t _mng_lirinst222) {
    ...
    *(uint64_t*)(__twr_v234) = __twr_v232;
    ...
    if (!(__twr_v235)) { goto __twr_l13; } else { goto __twr_l12; }
    __twr_l12:;
    __twr_v236 = 8ULL;
...
uint64_t LirGetLabel(uint64_t _mng_oldlabel245) {
    ...
    if (!(__twr_v248)) { goto __twr_l14; } else { goto __twr_l15; }
    __twr_l15:;
    __twr_v250 = 1ULL;
    __twr_v251 = 48ULL;
...
uint64_t LirGetRegister(uint64_t _mng_oldvariable263) {
    ...
    if (!(__twr_v266)) { goto __twr_l16; } else { goto __twr_l17; }
    __twr_l17:;
...
uint64_t LirSelect(uint64_t _mng_inst272) {
    ...
    if (!(__twr_v275)) { goto __twr_l18; } else { goto __twr_l19; }
    __twr_l19:;
    return _mng_reg276;
    __twr_l18:;
    ...
    if (__twr_v293 != __twr_v282) { goto __twr_l20; } else { goto __twr_l21; }
    __twr_l21:;
...
uint64_t LirSelectOrGetRegister(uint64_t _mng_var299) {
    ...
    if (!(__twr_v302)) { goto __twr_l22; } else { goto __twr_l23; }
    __twr_l23:;
...
void LirSelectForFunction(uint64_t _mng_funcsym310) {
    ...
    *(uint64_t*)(__twr_v321) = __twr_v313;
    if (!(__twr_v319)) { goto __twr_l25; } else { goto __twr_l24; }
    __twr_l24:;
    __twr_v322 = 88ULL;
    ...
    *(uint32_t*)(__twr_v337) = __twr_v332;
    ...
    __twr_v350 = 6ULL;
    if (__twr_v349 != __twr_v350) { goto __twr_l33; } else { goto __twr_l36; }
    __twr_l36:;
    __twr_v351 = 48ULL;
