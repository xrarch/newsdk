...
void LirInsertInstructionTail(uint64_t _mng_lirinst185) {
    ...
    *(uint64_t*)(__twr_v208) = _mng_lirinst185;
    __twr_l5:;
    __twr_v209 = (uint64_t)(&LirCurrentFunction);
    __twr_v210 = *(uint64_t*)(__twr_v209);
    __twr_v211 = 24ULL;
    __twr_v212 = __twr_v210 + __twr_v211;
    *(uint64_t*)(__twr_v212) = _mng_lirinst185;
    _jkl_epilogue:;
}
void LirRemoveInstruction(uint64_t _mng_lirinst213) {
    uint64_t __twr_v214;
    uint64_t __twr_v215;
    uint64_t __twr_v216;
    uint64_t _mng_block217;
    uint64_t __twr_v218;
    uint64_t __twr_v219;
    uint64_t __twr_v220;
    uint64_t _mng_p221;
    ...
    uint64_t __twr_v235;
    __twr_v214 = 16ULL;
    __twr_v215 = _mng_lirinst213 + __twr_v214;
    __twr_v216 = *(uint64_t*)(__twr_v215);
    _mng_block217 = __twr_v216;
    __twr_v218 = 8ULL;
    __twr_v219 = _mng_lirinst213 + __twr_v218;
    __twr_v220 = *(uint64_t*)(__twr_v219);
    _mng_p221 = __twr_v220;
    if (!(__twr_v220)) { goto __twr_l10; } else { goto __twr_l9; }
    __twr_l9:;
    __twr_v222 = *(uint64_t*)(_mng_lirinst213);
    *(uint64_t*)(_mng_p221) = __twr_v222;
    goto __twr_l8;
    __twr_l10:;
    __twr_v223 = *(uint64_t*)(_mng_lirinst213);
    __twr_v224 = 16ULL;
    __twr_v225 = _mng_block217 + __twr_v224;
    *(uint64_t*)(__twr_v225) = __twr_v223;
    __twr_l8:;
    __twr_v226 = *(uint64_t*)(_mng_lirinst213);
    _mng_p221 = __twr_v226;
    if (!(__twr_v226)) { goto __twr_l13; } else { goto __twr_l12; }
    __twr_l12:;
    __twr_v227 = 8ULL;
    __twr_v228 = _mng_lirinst213 + __twr_v227;
    __twr_v229 = *(uint64_t*)(__twr_v228);
    __twr_v230 = _mng_p221 + __twr_v227;
    *(uint64_t*)(__twr_v230) = __twr_v229;
    goto __twr_l11;
    __twr_l13:;
    __twr_v231 = 8ULL;
    __twr_v232 = _mng_lirinst213 + __twr_v231;
    __twr_v233 = *(uint64_t*)(__twr_v232);
    __twr_v234 = 24ULL;
    __twr_v235 = _mng_block217 + __twr_v234;
    *(uint64_t*)(__twr_v235) = __twr_v233;
    __twr_l11:;
    _jkl_epilogue:;
}
uint64_t LirGetLabel(uint64_t _mng_oldlabel236) {
    uint64_t _jkl_retv;
    uint64_t __twr_v237;
    uint64_t __twr_v238;
    uint64_t __twr_v239;
    uint64_t _mng_lirinst240;
    uint64_t __twr_v241;
    uint64_t __twr_v242;
    uint64_t __twr_v243;
    uint64_t __twr_v244;
    ...
    uint64_t __twr_v253;
    __twr_v237 = 8ULL;
    __twr_v238 = _mng_oldlabel236 + __twr_v237;
    __twr_v239 = *(uint64_t*)(__twr_v238);
    _mng_lirinst240 = __twr_v239;
    if (!(__twr_v239)) { goto __twr_l14; } else { goto __twr_l15; }
    __twr_l15:;
    __twr_v241 = 1ULL;
    __twr_v242 = 48ULL;
    __twr_v243 = _mng_lirinst240 + __twr_v242;
    __twr_v244 = *(uint32_t*)(__twr_v243);
    __twr_v245 = __twr_v244 + __twr_v241;
    *(uint32_t*)(__twr_v243) = __twr_v245;
    _jkl_retv = _mng_lirinst240;
    goto _jkl_epilogue;
    __twr_l14:;
    __twr_v246 = (uint64_t)(&LirCreateInstruction);
    __twr_v247 = 1ULL;
    __twr_v248 = 0ULL;
    __twr_v249 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v246)(__twr_v247, __twr_v248);
    _mng_lirinst240 = __twr_v249;
    __twr_v250 = 8ULL;
    __twr_v251 = _mng_oldlabel236 + __twr_v250;
    *(uint64_t*)(__twr_v251) = __twr_v249;
    __twr_v252 = 48ULL;
    __twr_v253 = __twr_v249 + __twr_v252;
    *(uint32_t*)(__twr_v253) = __twr_v247;
    _jkl_retv = __twr_v249;
    goto _jkl_epilogue;
    _jkl_epilogue:;
    return _jkl_retv;
}
uint64_t LirGetRegister(uint64_t _mng_oldvariable254) {
    uint64_t _jkl_retv;
    uint64_t __twr_v255;
    uint64_t __twr_v256;
    uint64_t __twr_v257;
    uint64_t _mng_lirreg258;
    uint64_t __twr_v259;
    uint64_t __twr_v260;
    uint64_t __twr_v261;
    uint64_t __twr_v262;
    __twr_v255 = 16ULL;
    __twr_v256 = _mng_oldvariable254 + __twr_v255;
    __twr_v257 = *(uint64_t*)(__twr_v256);
    _mng_lirreg258 = __twr_v257;
    if (!(__twr_v257)) { goto __twr_l16; } else { goto __twr_l17; }
    __twr_l17:;
    _jkl_retv = _mng_lirreg258;
    goto _jkl_epilogue;
    __twr_l16:;
    __twr_v259 = (uint64_t)(&LirCreateRegister);
    __twr_v260 = ((uint64_t (*)())__twr_v259)();
    _mng_lirreg258 = __twr_v260;
    __twr_v261 = 16ULL;
    __twr_v262 = _mng_oldvariable254 + __twr_v261;
...
uint64_t LirSelect(uint64_t _mng_inst263) {
    uint64_t _jkl_retv;
    uint64_t __twr_v264;
    uint64_t __twr_v265;
    uint64_t __twr_v266;
    uint64_t _mng_reg267;
    uint64_t __twr_v268;
    uint64_t __twr_v269;
    uint64_t __twr_v270;
    uint64_t __twr_v271;
    ...
    uint64_t __twr_v289;
    __twr_v264 = 80ULL;
    __twr_v265 = _mng_inst263 + __twr_v264;
    __twr_v266 = *(uint64_t*)(__twr_v265);
    _mng_reg267 = __twr_v266;
    if (!(__twr_v266)) { goto __twr_l18; } else { goto __twr_l19; }
    __twr_l19:;
    _jkl_retv = _mng_reg267;
    goto _jkl_epilogue;
    __twr_l18:;
    __twr_v268 = (uint64_t)(&JklTargetInfo);
    __twr_v269 = *(uint64_t*)(__twr_v268);
    __twr_v270 = 24ULL;
    __twr_v271 = __twr_v269 + __twr_v270;
    __twr_v272 = *(uint64_t*)(__twr_v271);
    __twr_v273 = 88ULL;
    __twr_v274 = _mng_inst263 + __twr_v273;
    __twr_v275 = *(uint8_t*)(__twr_v274);
    __twr_v276 = 3ULL;
    __twr_v277 = __twr_v275 << __twr_v276;
    __twr_v278 = __twr_v272 + __twr_v277;
    __twr_v279 = *(uint64_t*)(__twr_v278);
    __twr_v280 = ((uint64_t (*)(uint64_t))__twr_v279)(_mng_inst263);
    _mng_reg267 = __twr_v280;
    if (!(__twr_v280)) { goto __twr_l20; } else { goto __twr_l22; }
    __twr_l22:;
    __twr_v281 = 2ULL;
    __twr_v282 = _mng_reg267 + __twr_v281;
    __twr_v283 = *(uint8_t*)(__twr_v282);
    __twr_v284 = 0ULL;
    if (__twr_v283 != __twr_v284) { goto __twr_l20; } else { goto __twr_l21; }
    __twr_l21:;
    __twr_v285 = (uint64_t)(&TlInternalError);
    __twr_v286 = (uint64_t)(&"Machine -> Virt TODO");
    __twr_v287 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v285)(__twr_v286, __twr_v287, __twr_v287, __twr_v287);
    __twr_l20:;
    __twr_v288 = 80ULL;
    __twr_v289 = _mng_inst263 + __twr_v288;
    *(uint64_t*)(__twr_v289) = _mng_reg267;
    _jkl_retv = _mng_reg267;
    goto _jkl_epilogue;
    _jkl_epilogue:;
    return _jkl_retv;
}
uint64_t LirSelectOrGetRegister(uint64_t _mng_var290) {
    uint64_t _jkl_retv;
    uint64_t __twr_v291;
    uint64_t __twr_v292;
    uint64_t __twr_v293;
    ...
    uint64_t __twr_v300;
    __twr_v291 = 8ULL;
    __twr_v292 = _mng_var290 + __twr_v291;
    __twr_v293 = *(uint64_t*)(__twr_v292);
    if (!(__twr_v293)) { goto __twr_l23; } else { goto __twr_l24; }
    __twr_l24:;
...
void LirSelectForFunction(uint64_t _mng_funcsym301) {
    uint64_t __twr_v302;
    uint64_t __twr_v303;
    uint64_t __twr_v304;
    uint64_t __twr_v305;
    ...
    uint64_t __twr_v358;
    __twr_v302 = 96ULL;
    __twr_v303 = _mng_funcsym301 + __twr_v302;
    ...
    *(uint64_t*)(__twr_v307) = __twr_v305;
    __twr_v308 = 24ULL;
    __twr_v309 = __twr_v304 + __twr_v308;
    *(uint64_t*)(__twr_v309) = __twr_v305;
    __twr_v310 = *(uint64_t*)(__twr_v304);
    _mng_inst311 = __twr_v310;
    __twr_v312 = (uint64_t)(&LirCurrentFunction);
    *(uint64_t*)(__twr_v312) = __twr_v304;
    if (!(__twr_v310)) { goto __twr_l26; } else { goto __twr_l25; }
    __twr_l25:;
    __twr_v313 = 88ULL;
    __twr_v314 = _mng_inst311 + __twr_v313;
    __twr_v315 = *(uint8_t*)(__twr_v314);
    __twr_v316 = 21ULL;
    if (__twr_v315 != __twr_v316) { goto __twr_l30; } else { goto __twr_l29; }
    __twr_l29:;
    __twr_v317 = 8ULL;
    __twr_v318 = _mng_inst311 + __twr_v317;
    __twr_v319 = *(uint64_t*)(__twr_v318);
    _mng_lirinst320 = __twr_v319;
    if (__twr_v319) { goto __twr_l31; } else { goto __twr_l32; }
    __twr_l32:;
    __twr_v321 = (uint64_t)(&LirCreateInstruction);
    __twr_v322 = 1ULL;
    __twr_v323 = 0ULL;
    __twr_v324 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v321)(__twr_v322, __twr_v323);
    _mng_lirinst320 = __twr_v324;
    __twr_v325 = 8ULL;
    __twr_v326 = _mng_inst311 + __twr_v325;
    *(uint64_t*)(__twr_v326) = __twr_v324;
    __twr_v327 = 48ULL;
    __twr_v328 = __twr_v324 + __twr_v327;
    *(uint32_t*)(__twr_v328) = __twr_v323;
    __twr_l31:;
    __twr_v329 = (uint64_t)(&LirInsertInstructionTail);
    ((void (*)(uint64_t))__twr_v329)(_mng_lirinst320);
    goto __twr_l28;
    __twr_l30:;
    __twr_v330 = 88ULL;
    __twr_v331 = _mng_inst311 + __twr_v330;
    __twr_v332 = *(uint8_t*)(__twr_v331);
    __twr_v333 = 25ULL;
    if (__twr_v332 == __twr_v333) { goto __twr_l33; } else { goto __twr_l36; }
    __twr_l36:;
    __twr_v334 = 88ULL;
    __twr_v335 = _mng_inst311 + __twr_v334;
    __twr_v336 = *(uint8_t*)(__twr_v335);
    __twr_v337 = 28ULL;
    if (__twr_v336 == __twr_v337) { goto __twr_l33; } else { goto __twr_l35; }
    __twr_l35:;
    __twr_v338 = 88ULL;
    __twr_v339 = _mng_inst311 + __twr_v338;
    __twr_v340 = *(uint8_t*)(__twr_v339);
    __twr_v341 = 6ULL;
    if (__twr_v340 != __twr_v341) { goto __twr_l34; } else { goto __twr_l37; }
    __twr_l37:;
    __twr_v342 = 48ULL;
    __twr_v343 = _mng_inst311 + __twr_v342;
    __twr_v344 = *(uint64_t*)(__twr_v343);
    __twr_v345 = *(uint64_t*)(__twr_v344);
    if (__twr_v345) { goto __twr_l33; } else { goto __twr_l34; }
    __twr_l34:;
    __twr_v346 = 88ULL;
    __twr_v347 = _mng_inst311 + __twr_v346;
    __twr_v348 = *(uint8_t*)(__twr_v347);
    __twr_v349 = 7ULL;
    if (__twr_v348 <= __twr_v349) { goto __twr_l28; } else { goto __twr_l38; }
    __twr_l38:;
    __twr_v350 = 88ULL;
    __twr_v351 = _mng_inst311 + __twr_v350;
    __twr_v352 = *(uint8_t*)(__twr_v351);
    __twr_v353 = 23ULL;
    if (__twr_v352 >= __twr_v353) { goto __twr_l28; } else { goto __twr_l33; }
    __twr_l33:;
    __twr_v354 = (uint64_t)(&LirSelect);
    __twr_v355 = ((uint64_t (*)(uint64_t))__twr_v354)(_mng_inst311);
    __twr_l28:;
    __twr_v356 = 32ULL;
    __twr_v357 = _mng_inst311 + __twr_v356;
    __twr_v358 = *(uint64_t*)(__twr_v357);
    _mng_inst311 = __twr_v358;
    __twr_l27:;
    if (_mng_inst311) { goto __twr_l25; } else { goto __twr_l26; }
    __twr_l26:;
    _jkl_epilogue:;
}
