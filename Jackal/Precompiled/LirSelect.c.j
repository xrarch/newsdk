...
void LirInsertInstructionTail(uint64_t _mng_lirinst194) {
    ...
    __twr_v204 = (uint64_t)(&"\n");
    ((void (*)(uint64_t))__twr_v199)(__twr_v204);
    __twr_v205 = (uint64_t)(&LirCurrentFunction);
    __twr_v206 = *(uint64_t*)(__twr_v205);
    __twr_v207 = 16ULL;
    __twr_v208 = _mng_lirinst194 + __twr_v207;
    *(uint64_t*)(__twr_v208) = __twr_v206;
    __twr_v209 = 0ULL;
    *(uint64_t*)(_mng_lirinst194) = __twr_v209;
    __twr_v210 = *(uint64_t*)(__twr_v205);
    __twr_v211 = 24ULL;
    __twr_v212 = __twr_v210 + __twr_v211;
    __twr_v213 = *(uint64_t*)(__twr_v212);
    __twr_v214 = 8ULL;
    __twr_v215 = _mng_lirinst194 + __twr_v214;
    *(uint64_t*)(__twr_v215) = __twr_v213;
    __twr_v216 = *(uint64_t*)(__twr_v205);
    __twr_v217 = __twr_v216 + __twr_v211;
    __twr_v218 = *(uint64_t*)(__twr_v217);
    if (__twr_v218) { goto __twr_l7; } else { goto __twr_l6; }
    __twr_l6:;
    __twr_v219 = (uint64_t)(&LirCurrentFunction);
    __twr_v220 = *(uint64_t*)(__twr_v219);
    __twr_v221 = 16ULL;
    __twr_v222 = __twr_v220 + __twr_v221;
    *(uint64_t*)(__twr_v222) = _mng_lirinst194;
    goto __twr_l5;
    __twr_l7:;
    __twr_v223 = (uint64_t)(&LirCurrentFunction);
    __twr_v224 = *(uint64_t*)(__twr_v223);
    __twr_v225 = 24ULL;
    __twr_v226 = __twr_v224 + __twr_v225;
    __twr_v227 = *(uint64_t*)(__twr_v226);
    *(uint64_t*)(__twr_v227) = _mng_lirinst194;
    __twr_l5:;
    __twr_v228 = (uint64_t)(&LirCurrentFunction);
    __twr_v229 = *(uint64_t*)(__twr_v228);
    __twr_v230 = 24ULL;
    __twr_v231 = __twr_v229 + __twr_v230;
    *(uint64_t*)(__twr_v231) = _mng_lirinst194;
}
void LirRemoveInstruction(uint64_t _mng_lirinst232) {
    uint64_t __twr_v233;
    uint64_t __twr_v234;
    uint64_t __twr_v235;
    uint64_t _mng_block236;
    uint64_t __twr_v237;
    uint64_t __twr_v238;
    uint64_t __twr_v239;
    uint64_t _mng_p240;
    ...
    uint64_t __twr_v254;
    __twr_v233 = 16ULL;
    __twr_v234 = _mng_lirinst232 + __twr_v233;
    __twr_v235 = *(uint64_t*)(__twr_v234);
    _mng_block236 = __twr_v235;
    __twr_v237 = 8ULL;
    __twr_v238 = _mng_lirinst232 + __twr_v237;
    __twr_v239 = *(uint64_t*)(__twr_v238);
    _mng_p240 = __twr_v239;
    if (!(__twr_v239)) { goto __twr_l10; } else { goto __twr_l9; }
    __twr_l9:;
    __twr_v241 = *(uint64_t*)(_mng_lirinst232);
    *(uint64_t*)(_mng_p240) = __twr_v241;
    goto __twr_l8;
    __twr_l10:;
    __twr_v242 = *(uint64_t*)(_mng_lirinst232);
    __twr_v243 = 16ULL;
    __twr_v244 = _mng_block236 + __twr_v243;
    *(uint64_t*)(__twr_v244) = __twr_v242;
    __twr_l8:;
    __twr_v245 = *(uint64_t*)(_mng_lirinst232);
    _mng_p240 = __twr_v245;
    if (!(__twr_v245)) { goto __twr_l13; } else { goto __twr_l12; }
    __twr_l12:;
    __twr_v246 = 8ULL;
    __twr_v247 = _mng_lirinst232 + __twr_v246;
    __twr_v248 = *(uint64_t*)(__twr_v247);
    __twr_v249 = _mng_p240 + __twr_v246;
    *(uint64_t*)(__twr_v249) = __twr_v248;
    goto __twr_l11;
    __twr_l13:;
    __twr_v250 = 8ULL;
    __twr_v251 = _mng_lirinst232 + __twr_v250;
    __twr_v252 = *(uint64_t*)(__twr_v251);
    __twr_v253 = 24ULL;
    __twr_v254 = _mng_block236 + __twr_v253;
    *(uint64_t*)(__twr_v254) = __twr_v252;
    __twr_l11:;
}
uint64_t LirGetLabel(uint64_t _mng_oldlabel255) {
    uint64_t __twr_v256;
    uint64_t __twr_v257;
    uint64_t __twr_v258;
    uint64_t _mng_lirinst259;
    uint64_t __twr_v260;
    uint64_t __twr_v261;
    uint64_t __twr_v262;
    uint64_t __twr_v263;
    ...
    uint64_t __twr_v272;
    __twr_v256 = 8ULL;
    __twr_v257 = _mng_oldlabel255 + __twr_v256;
    __twr_v258 = *(uint64_t*)(__twr_v257);
    _mng_lirinst259 = __twr_v258;
    if (!(__twr_v258)) { goto __twr_l14; } else { goto __twr_l15; }
    __twr_l15:;
    __twr_v260 = 1ULL;
    __twr_v261 = 48ULL;
    __twr_v262 = _mng_lirinst259 + __twr_v261;
    __twr_v263 = *(uint32_t*)(__twr_v262);
    __twr_v264 = __twr_v263 + __twr_v260;
    *(uint32_t*)(__twr_v262) = __twr_v264;
    return _mng_lirinst259;
    __twr_l14:;
    __twr_v265 = (uint64_t)(&LirCreateInstruction);
    __twr_v266 = 1ULL;
    __twr_v267 = 0ULL;
    __twr_v268 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v265)(__twr_v266, __twr_v267);
    _mng_lirinst259 = __twr_v268;
    __twr_v269 = 8ULL;
    __twr_v270 = _mng_oldlabel255 + __twr_v269;
    *(uint64_t*)(__twr_v270) = __twr_v268;
    __twr_v271 = 48ULL;
    __twr_v272 = __twr_v268 + __twr_v271;
    *(uint32_t*)(__twr_v272) = __twr_v266;
    return __twr_v268;
}
uint64_t LirGetRegister(uint64_t _mng_oldvariable273) {
    uint64_t __twr_v274;
    uint64_t __twr_v275;
    uint64_t __twr_v276;
    uint64_t _mng_lirreg277;
    uint64_t __twr_v278;
    uint64_t __twr_v279;
    uint64_t __twr_v280;
    uint64_t __twr_v281;
    __twr_v274 = 16ULL;
    __twr_v275 = _mng_oldvariable273 + __twr_v274;
    __twr_v276 = *(uint64_t*)(__twr_v275);
    _mng_lirreg277 = __twr_v276;
    if (!(__twr_v276)) { goto __twr_l16; } else { goto __twr_l17; }
    __twr_l17:;
    return _mng_lirreg277;
    __twr_l16:;
    __twr_v278 = (uint64_t)(&LirCreateRegister);
    __twr_v279 = ((uint64_t (*)())__twr_v278)();
    _mng_lirreg277 = __twr_v279;
    __twr_v280 = 16ULL;
    __twr_v281 = _mng_oldvariable273 + __twr_v280;
...
uint64_t LirSelect(uint64_t _mng_inst282) {
    ...
    if (!(__twr_v285)) { goto __twr_l18; } else { goto __twr_l19; }
    __twr_l19:;
    return _mng_reg286;
    __twr_l18:;
    ...
    if (!(__twr_v299)) { goto __twr_l20; } else { goto __twr_l22; }
    __twr_l22:;
    __twr_v300 = 2ULL;
    __twr_v301 = _mng_reg286 + __twr_v300;
    __twr_v302 = *(uint8_t*)(__twr_v301);
    __twr_v303 = 0ULL;
    if (__twr_v302 != __twr_v303) { goto __twr_l20; } else { goto __twr_l21; }
    __twr_l21:;
    __twr_v304 = (uint64_t)(&TlInternalError);
    __twr_v305 = (uint64_t)(&"Machine -> Virt TODO");
    __twr_v306 = 0ULL;
...
uint64_t LirSelectOrGetRegister(uint64_t _mng_var309) {
    ...
    if (!(__twr_v312)) { goto __twr_l23; } else { goto __twr_l24; }
    __twr_l24:;
...
void LirSelectForFunction(uint64_t _mng_funcsym320) {
    ...
    *(uint64_t*)(__twr_v331) = __twr_v323;
    if (!(__twr_v329)) { goto __twr_l26; } else { goto __twr_l25; }
    __twr_l25:;
    __twr_v332 = 88ULL;
    ...
    if (__twr_v338) { goto __twr_l31; } else { goto __twr_l32; }
    __twr_l32:;
    ...
    *(uint32_t*)(__twr_v347) = __twr_v342;
    ...
    __twr_l27:;
    if (_mng_inst330) { goto __twr_l25; } else { goto __twr_l26; }
    __twr_l26:;
}
