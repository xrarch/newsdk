...
void TlInitializeZone(uint64_t _mng_zone102, uint64_t _mng_blocksize103) {
    ...
    *(uint64_t*)(_mng_zone102) = __twr_v109;
    __twr_v111 = 8ULL;
    __twr_v112 = _mng_zone102 + __twr_v111;
...
uint64_t TlAllocateFromZone(uint64_t _mng_zone113) {
    ...
    *(uint64_t*)(__twr_v120) = __twr_v118;
    ...
    __twr_v123 = 5ULL;
    __twr_v124 = __twr_v121 << __twr_v123;
    ...
    __twr_v131 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v129)(__twr_v130, __twr_v131, __twr_v131, __twr_v131);
    __twr_l5:;
    _mng_block117 = _mng_chunk127;
    __twr_v132 = _mng_chunk127 + _mng_blocksize122;
