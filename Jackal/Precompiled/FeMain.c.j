...
extern void LexStreamError_C(uint64_t _mng_filename148, uint64_t _mng_linenumber149, uint64_t _mng_linepos150, uint64_t _mng_str151, uint64_t _mng_err1152, uint64_t _mng_err2153, uint64_t _mng_err3154);
void LexStreamError(uint64_t _mng_str155, uint64_t _mng_err1156, uint64_t _mng_err2157, uint64_t _mng_err3158) {
    uint64_t __twr_v159;
    uint64_t __twr_v160;
    uint64_t _mng_stream161;
    uint64_t __twr_v162;
    uint64_t __twr_v163;
    uint64_t __twr_v164;
    uint64_t __twr_v165;
    ...
    _mng_stream161 = __twr_v160;
    __twr_v162 = (uint64_t)(&LexStreamError_C);
    __twr_v163 = 8ULL;
    __twr_v164 = _mng_stream161 + __twr_v163;
    ...
    __twr_v171 = 48ULL;
    __twr_v172 = _mng_stream161 + __twr_v171;
    __twr_v173 = *(uint32_t*)(__twr_v172);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v162)(__twr_v167, __twr_v170, __twr_v173, _mng_str155, _mng_err1156, _mng_err2157, _mng_err3158);
    __twr_v174 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v174)();
    __twr_l1:;
    _jkl_epilogue:;
}
void LexTokenError(uint64_t _mng_token175, uint64_t _mng_str176, uint64_t _mng_err1177, uint64_t _mng_err2178, uint64_t _mng_err3179) {
    uint64_t __twr_v180;
    uint64_t __twr_v181;
    uint64_t __twr_v182;
    uint64_t __twr_v183;
    ...
    uint64_t __twr_v191;
    uint64_t __twr_v192;
    __twr_v180 = (uint64_t)(&LexStreamError_C);
    __twr_v181 = 8ULL;
    __twr_v182 = _mng_token175 + __twr_v181;
    __twr_v183 = *(uint64_t*)(__twr_v182);
    __twr_v184 = 304ULL;
    __twr_v185 = __twr_v183 + __twr_v184;
    __twr_v186 = 16ULL;
    __twr_v187 = _mng_token175 + __twr_v186;
    __twr_v188 = *(uint32_t*)(__twr_v187);
    __twr_v189 = 20ULL;
    __twr_v190 = _mng_token175 + __twr_v189;
    __twr_v191 = *(uint32_t*)(__twr_v190);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v180)(__twr_v185, __twr_v188, __twr_v191, _mng_str176, _mng_err1177, _mng_err2178, _mng_err3179);
    __twr_v192 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v192)();
    __twr_l2:;
    _jkl_epilogue:;
}
