...
extern void LexStreamError_C(uint64_t _mng_filename145, uint64_t _mng_linenumber146, uint64_t _mng_linepos147, uint64_t _mng_str148, uint64_t _mng_err1149, uint64_t _mng_err2150, uint64_t _mng_err3151);
void LexStreamError(uint64_t _mng_str152, uint64_t _mng_err1153, uint64_t _mng_err2154, uint64_t _mng_err3155) {
    uint64_t __twr_v156;
    uint64_t __twr_v157;
    uint64_t _mng_stream158;
    uint64_t __twr_v159;
    uint64_t __twr_v160;
    uint64_t __twr_v161;
    uint64_t __twr_v162;
    ...
    uint64_t __twr_v174;
    uint64_t __twr_v175;
    __twr_v156 = (uint64_t)(&LexCurrentStream);
    __twr_v157 = *(uint64_t*)(__twr_v156);
    _mng_stream158 = __twr_v157;
    __twr_v159 = (uint64_t)(&LexStreamError_C);
    __twr_v160 = 8ULL;
    __twr_v161 = _mng_stream158 + __twr_v160;
    ...
    __twr_v168 = __twr_v164 + __twr_v167;
    __twr_v169 = 44ULL;
    __twr_v170 = _mng_stream158 + __twr_v169;
    __twr_v171 = *(uint32_t*)(__twr_v170);
    __twr_v172 = 48ULL;
    __twr_v173 = _mng_stream158 + __twr_v172;
    __twr_v174 = *(uint32_t*)(__twr_v173);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v159)(__twr_v168, __twr_v171, __twr_v174, _mng_str152, _mng_err1153, _mng_err2154, _mng_err3155);
    __twr_v175 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v175)();
}
void LexTokenError(uint64_t _mng_token176, uint64_t _mng_str177, uint64_t _mng_err1178, uint64_t _mng_err2179, uint64_t _mng_err3180) {
    uint64_t __twr_v181;
    uint64_t __twr_v182;
    uint64_t __twr_v183;
    uint64_t __twr_v184;
    ...
    uint64_t __twr_v196;
    uint64_t __twr_v197;
    __twr_v181 = (uint64_t)(&LexStreamError_C);
    __twr_v182 = 8ULL;
    __twr_v183 = _mng_token176 + __twr_v182;
    ...
    __twr_v190 = __twr_v186 + __twr_v189;
    __twr_v191 = 16ULL;
    __twr_v192 = _mng_token176 + __twr_v191;
    __twr_v193 = *(uint32_t*)(__twr_v192);
    __twr_v194 = 20ULL;
    __twr_v195 = _mng_token176 + __twr_v194;
    __twr_v196 = *(uint32_t*)(__twr_v195);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v181)(__twr_v190, __twr_v193, __twr_v196, _mng_str177, _mng_err1178, _mng_err2179, _mng_err3180);
