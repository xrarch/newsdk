...
extern void LexStreamError_C(uint64_t _mng_filename161, uint64_t _mng_linenumber162, uint64_t _mng_linepos163, uint64_t _mng_str164, uint64_t _mng_err1165, uint64_t _mng_err2166, uint64_t _mng_err3167);
void LexStreamError(uint64_t _mng_str168, uint64_t _mng_err1169, uint64_t _mng_err2170, uint64_t _mng_err3171) {
    uint64_t __twr_v172;
    uint64_t __twr_v173;
    uint64_t _mng_stream174;
    uint64_t __twr_v175;
    uint64_t __twr_v176;
    uint64_t __twr_v177;
    uint64_t __twr_v178;
    ...
    uint64_t __twr_v186;
    uint64_t __twr_v187;
    __twr_v172 = (uint64_t)(&LexCurrentStream);
    __twr_v173 = *(uint64_t*)(__twr_v172);
    _mng_stream174 = __twr_v173;
    __twr_v175 = (uint64_t)(&LexStreamError_C);
    __twr_v176 = 8ULL;
    __twr_v177 = _mng_stream174 + __twr_v176;
    __twr_v178 = *(uint64_t*)(__twr_v177);
    __twr_v179 = 304ULL;
    __twr_v180 = __twr_v178 + __twr_v179;
    __twr_v181 = 44ULL;
    __twr_v182 = _mng_stream174 + __twr_v181;
    __twr_v183 = *(uint32_t*)(__twr_v182);
    __twr_v184 = 48ULL;
    __twr_v185 = _mng_stream174 + __twr_v184;
    __twr_v186 = *(uint32_t*)(__twr_v185);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v175)(__twr_v180, __twr_v183, __twr_v186, _mng_str168, _mng_err1169, _mng_err2170, _mng_err3171);
    __twr_v187 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v187)();
    __twr_l1:;
    _jkl_epilogue:;
}
void LexTokenError(uint64_t _mng_token188, uint64_t _mng_str189, uint64_t _mng_err1190, uint64_t _mng_err2191, uint64_t _mng_err3192) {
    uint64_t __twr_v193;
    uint64_t __twr_v194;
    uint64_t __twr_v195;
    uint64_t __twr_v196;
    ...
    uint64_t __twr_v204;
    uint64_t __twr_v205;
    __twr_v193 = (uint64_t)(&LexStreamError_C);
    __twr_v194 = 8ULL;
    __twr_v195 = _mng_token188 + __twr_v194;
    ...
    __twr_v202 = 20ULL;
    __twr_v203 = _mng_token188 + __twr_v202;
    __twr_v204 = *(uint32_t*)(__twr_v203);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v193)(__twr_v198, __twr_v201, __twr_v204, _mng_str189, _mng_err1190, _mng_err2191, _mng_err3192);
    __twr_v205 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v205)();
    __twr_l2:;
    _jkl_epilogue:;
}
