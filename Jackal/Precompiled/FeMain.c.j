...
extern void LexStreamError_C(uint64_t _mng_filename164, uint64_t _mng_linenumber165, uint64_t _mng_linepos166, uint64_t _mng_str167, uint64_t _mng_err1168, uint64_t _mng_err2169, uint64_t _mng_err3170);
void LexStreamError(uint64_t _mng_str171, uint64_t _mng_err1172, uint64_t _mng_err2173, uint64_t _mng_err3174) {
    uint64_t __twr_v175;
    uint64_t __twr_v176;
    ...
    __twr_v179 = 8ULL;
    __twr_v180 = _mng_stream177 + __twr_v179;
    __twr_v181 = *(uint64_t*)(__twr_v180);
    __twr_v182 = 304ULL;
    __twr_v183 = __twr_v181 + __twr_v182;
    __twr_v184 = 44ULL;
    __twr_v185 = _mng_stream177 + __twr_v184;
    __twr_v186 = *(uint32_t*)(__twr_v185);
    __twr_v187 = 48ULL;
    __twr_v188 = _mng_stream177 + __twr_v187;
    __twr_v189 = *(uint32_t*)(__twr_v188);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v178)(__twr_v183, __twr_v186, __twr_v189, _mng_str171, _mng_err1172, _mng_err2173, _mng_err3174);
    __twr_v190 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v190)();
    __twr_l1:;
    _jkl_epilogue:;
}
void LexTokenError(uint64_t _mng_token191, uint64_t _mng_str192, uint64_t _mng_err1193, uint64_t _mng_err2194, uint64_t _mng_err3195) {
    uint64_t __twr_v196;
    uint64_t __twr_v197;
    uint64_t __twr_v198;
    uint64_t __twr_v199;
    ...
    uint64_t __twr_v207;
    uint64_t __twr_v208;
    __twr_v196 = (uint64_t)(&LexStreamError_C);
    __twr_v197 = 8ULL;
    __twr_v198 = _mng_token191 + __twr_v197;
    __twr_v199 = *(uint64_t*)(__twr_v198);
    __twr_v200 = 304ULL;
    __twr_v201 = __twr_v199 + __twr_v200;
    __twr_v202 = 16ULL;
    __twr_v203 = _mng_token191 + __twr_v202;
    __twr_v204 = *(uint32_t*)(__twr_v203);
    __twr_v205 = 20ULL;
    __twr_v206 = _mng_token191 + __twr_v205;
    __twr_v207 = *(uint32_t*)(__twr_v206);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v196)(__twr_v201, __twr_v204, __twr_v207, _mng_str192, _mng_err1193, _mng_err2194, _mng_err3195);
    __twr_v208 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v208)();
    __twr_l2:;
    _jkl_epilogue:;
}
