...
extern void LexStreamError_C(uint64_t _mng_filename143, uint64_t _mng_linenumber144, uint64_t _mng_linepos145, uint64_t _mng_str146, uint64_t _mng_err1147, uint64_t _mng_err2148, uint64_t _mng_err3149);
void LexStreamError(uint64_t _mng_str150, uint64_t _mng_err1151, uint64_t _mng_err2152, uint64_t _mng_err3153) {
    uint64_t __twr_v154;
    uint64_t __twr_v155;
    uint64_t _mng_stream156;
    uint64_t __twr_v157;
    uint64_t __twr_v158;
    uint64_t __twr_v159;
    uint64_t __twr_v160;
    ...
    uint64_t __twr_v168;
    uint64_t __twr_v169;
    __twr_v154 = (uint64_t)(&LexCurrentStream);
    __twr_v155 = *(uint64_t*)(__twr_v154);
    _mng_stream156 = __twr_v155;
    __twr_v157 = (uint64_t)(&LexStreamError_C);
    __twr_v158 = 8ULL;
    __twr_v159 = _mng_stream156 + __twr_v158;
    __twr_v160 = *(uint64_t*)(__twr_v159);
    __twr_v161 = 304ULL;
    __twr_v162 = __twr_v160 + __twr_v161;
    __twr_v163 = 44ULL;
    __twr_v164 = _mng_stream156 + __twr_v163;
    __twr_v165 = *(uint32_t*)(__twr_v164);
    __twr_v166 = 48ULL;
    __twr_v167 = _mng_stream156 + __twr_v166;
    __twr_v168 = *(uint32_t*)(__twr_v167);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v157)(__twr_v162, __twr_v165, __twr_v168, _mng_str150, _mng_err1151, _mng_err2152, _mng_err3153);
    __twr_v169 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v169)();
    __twr_l1:;
    _jkl_epilogue:;
}
void LexTokenError(uint64_t _mng_token170, uint64_t _mng_str171, uint64_t _mng_err1172, uint64_t _mng_err2173, uint64_t _mng_err3174) {
    uint64_t __twr_v175;
    uint64_t __twr_v176;
    uint64_t __twr_v177;
    uint64_t __twr_v178;
    ...
    uint64_t __twr_v186;
    uint64_t __twr_v187;
    __twr_v175 = (uint64_t)(&LexStreamError_C);
    __twr_v176 = 8ULL;
    __twr_v177 = _mng_token170 + __twr_v176;
    __twr_v178 = *(uint64_t*)(__twr_v177);
    __twr_v179 = 304ULL;
    __twr_v180 = __twr_v178 + __twr_v179;
    __twr_v181 = 16ULL;
    __twr_v182 = _mng_token170 + __twr_v181;
    __twr_v183 = *(uint32_t*)(__twr_v182);
    __twr_v184 = 20ULL;
    __twr_v185 = _mng_token170 + __twr_v184;
    __twr_v186 = *(uint32_t*)(__twr_v185);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v175)(__twr_v180, __twr_v183, __twr_v186, _mng_str171, _mng_err1172, _mng_err2173, _mng_err3174);
    __twr_v187 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v187)();
    __twr_l2:;
    _jkl_epilogue:;
}
