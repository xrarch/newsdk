...
extern void LexStreamError_C(uint64_t _mng_filename165, uint64_t _mng_linenumber166, uint64_t _mng_linepos167, uint64_t _mng_str168, uint64_t _mng_err1169, uint64_t _mng_err2170, uint64_t _mng_err3171);
void LexStreamError(uint64_t _mng_str172, uint64_t _mng_err1173, uint64_t _mng_err2174, uint64_t _mng_err3175) {
    uint64_t __twr_v176;
    uint64_t __twr_v177;
    uint64_t _mng_stream178;
    uint64_t __twr_v179;
    uint64_t __twr_v180;
    uint64_t __twr_v181;
    uint64_t __twr_v182;
    ...
    _mng_stream178 = __twr_v177;
    __twr_v179 = (uint64_t)(&LexStreamError_C);
    __twr_v180 = 8ULL;
    __twr_v181 = _mng_stream178 + __twr_v180;
    __twr_v182 = *(uint64_t*)(__twr_v181);
    __twr_v183 = 304ULL;
    __twr_v184 = __twr_v182 + __twr_v183;
    __twr_v185 = 44ULL;
    __twr_v186 = _mng_stream178 + __twr_v185;
    __twr_v187 = *(uint32_t*)(__twr_v186);
    __twr_v188 = 48ULL;
    __twr_v189 = _mng_stream178 + __twr_v188;
    __twr_v190 = *(uint32_t*)(__twr_v189);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v179)(__twr_v184, __twr_v187, __twr_v190, _mng_str172, _mng_err1173, _mng_err2174, _mng_err3175);
    __twr_v191 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v191)();
    __twr_l1:;
    _jkl_epilogue:;
}
void LexTokenError(uint64_t _mng_token192, uint64_t _mng_str193, uint64_t _mng_err1194, uint64_t _mng_err2195, uint64_t _mng_err3196) {
    uint64_t __twr_v197;
    uint64_t __twr_v198;
    uint64_t __twr_v199;
    uint64_t __twr_v200;
    ...
    uint64_t __twr_v208;
    uint64_t __twr_v209;
    __twr_v197 = (uint64_t)(&LexStreamError_C);
    __twr_v198 = 8ULL;
    __twr_v199 = _mng_token192 + __twr_v198;
    __twr_v200 = *(uint64_t*)(__twr_v199);
    __twr_v201 = 304ULL;
    __twr_v202 = __twr_v200 + __twr_v201;
    __twr_v203 = 16ULL;
    __twr_v204 = _mng_token192 + __twr_v203;
    __twr_v205 = *(uint32_t*)(__twr_v204);
    __twr_v206 = 20ULL;
    __twr_v207 = _mng_token192 + __twr_v206;
    __twr_v208 = *(uint32_t*)(__twr_v207);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v197)(__twr_v202, __twr_v205, __twr_v208, _mng_str193, _mng_err1194, _mng_err2195, _mng_err3196);
    __twr_v209 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v209)();
    __twr_l2:;
    _jkl_epilogue:;
}
