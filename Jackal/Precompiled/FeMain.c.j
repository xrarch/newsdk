...
void LexStreamError(uint64_t _mng_str146, uint64_t _mng_err1147, uint64_t _mng_err2148, uint64_t _mng_err3149) {
    ...
    _mng_stream152 = __twr_v151;
    __twr_v153 = (uint64_t)(&LexStreamError_C);
    __twr_v154 = 8ULL;
    ...
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v153)(__twr_v158, __twr_v161, __twr_v164, _mng_str146, _mng_err1147, _mng_err2148, _mng_err3149);
    __twr_v165 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v165)();
    __twr_l1:;
    _jkl_epilogue:;
}
void LexTokenError(uint64_t _mng_token166, uint64_t _mng_str167, uint64_t _mng_err1168, uint64_t _mng_err2169, uint64_t _mng_err3170) {
    uint64_t __twr_v171;
    uint64_t __twr_v172;
    uint64_t __twr_v173;
    uint64_t __twr_v174;
    ...
    uint64_t __twr_v182;
    uint64_t __twr_v183;
    __twr_v171 = (uint64_t)(&LexStreamError_C);
    __twr_v172 = 8ULL;
    __twr_v173 = _mng_token166 + __twr_v172;
    __twr_v174 = *(uint64_t*)(__twr_v173);
    __twr_v175 = 304ULL;
    __twr_v176 = __twr_v174 + __twr_v175;
    __twr_v177 = 16ULL;
    __twr_v178 = _mng_token166 + __twr_v177;
    __twr_v179 = *(uint32_t*)(__twr_v178);
    __twr_v180 = 20ULL;
    __twr_v181 = _mng_token166 + __twr_v180;
    __twr_v182 = *(uint32_t*)(__twr_v181);
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t))__twr_v171)(__twr_v176, __twr_v179, __twr_v182, _mng_str167, _mng_err1168, _mng_err2169, _mng_err3170);
    __twr_v183 = (uint64_t)(&TlErrorExit);
    ((void (*)())__twr_v183)();
    __twr_l2:;
    _jkl_epilogue:;
}
