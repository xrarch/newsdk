...
void LexTokenError(uint64_t _mng_token177, uint64_t _mng_str178, uint64_t _mng_err1179, uint64_t _mng_err2180, uint64_t _mng_err3181) {
    uint64_t __twr_v182;
    uint64_t __twr_v183;
    uint64_t __twr_v184;
    uint64_t __twr_v185;
    ...
    uint64_t __twr_v197;
    uint64_t __twr_v198;
    __twr_v182 = (uint64_t)(&LexStreamError_C);
    __twr_v183 = 8ULL;
