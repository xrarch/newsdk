...
void LexInitializeSection(uint64_t _mng_section165, uint64_t _mng_name166) {
    uint64_t __twr_v167;
    uint64_t __twr_v168;
    uint64_t __twr_v169;
    uint64_t __twr_v170;
    ...
    uint64_t __twr_v191;
    uint64_t __twr_v192;
    __twr_v167 = (uint64_t)(&TlCopyString);
    __twr_v168 = 48ULL;
    __twr_v169 = _mng_section165 + __twr_v168;
    __twr_v170 = 64ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v167)(__twr_v169, _mng_name166, __twr_v170);
    __twr_v171 = 40ULL;
    __twr_v172 = _mng_section165 + __twr_v171;
    *(uint64_t*)(__twr_v172) = __twr_v169;
    __twr_v173 = (uint64_t)(&TlInitializeHashTable);
    __twr_v174 = 120ULL;
    __twr_v175 = _mng_section165 + __twr_v174;
    ((void (*)(uint64_t))__twr_v173)(__twr_v175);
    __twr_v176 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v177 = 1776ULL;
    __twr_v178 = _mng_section165 + __twr_v177;
    ((void (*)(uint64_t))__twr_v176)(__twr_v178);
    __twr_v179 = 1688ULL;
    __twr_v180 = _mng_section165 + __twr_v179;
    ((void (*)(uint64_t))__twr_v176)(__twr_v180);
    __twr_v181 = (uint64_t)(&LexDefaultSection);
    if (_mng_section165 == __twr_v181) { goto __twr_l2; } else { goto __twr_l3; }
    __twr_l3:;
    __twr_v182 = 0ULL;
    __twr_v183 = 112ULL;
    __twr_v184 = _mng_section165 + __twr_v183;
    *(uint64_t*)(__twr_v184) = __twr_v182;
    __twr_v185 = (uint64_t)(&LexSectionListTail);
    __twr_v186 = *(uint64_t*)(__twr_v185);
    if (!(__twr_v186)) { goto __twr_l6; } else { goto __twr_l5; }
    __twr_l5:;
    __twr_v187 = (uint64_t)(&LexSectionListTail);
    __twr_v188 = *(uint64_t*)(__twr_v187);
    __twr_v189 = 112ULL;
    __twr_v190 = __twr_v188 + __twr_v189;
    *(uint64_t*)(__twr_v190) = _mng_section165;
    goto __twr_l4;
    __twr_l6:;
    __twr_v191 = (uint64_t)(&LexSectionListHead);
    *(uint64_t*)(__twr_v191) = _mng_section165;
    __twr_l4:;
    __twr_v192 = (uint64_t)(&LexSectionListTail);
    *(uint64_t*)(__twr_v192) = _mng_section165;
    __twr_l2:;
    __twr_l1:;
    _jkl_epilogue:;
}
void LexInitializeSectionStuff() {
    ...
    __twr_v197 = (uint64_t)(&LexSectionHashTable);
    ((void (*)(uint64_t))__twr_v196)(__twr_v197);
    __twr_v198 = (uint64_t)(&LexInitializeSection);
    __twr_v199 = (uint64_t)(&LexDefaultSection);
    __twr_v200 = (uint64_t)(&"DEFAULT_SECTION");
    ((void (*)(uint64_t, uint64_t))__twr_v198)(__twr_v199, __twr_v200);
    __twr_v201 = (uint64_t)(&LexTextSection);
    __twr_v202 = (uint64_t)(&"text");
    ((void (*)(uint64_t, uint64_t))__twr_v198)(__twr_v201, __twr_v202);
    __twr_v203 = (uint64_t)(&LexDataSection);
    __twr_v204 = (uint64_t)(&"data");
    ((void (*)(uint64_t, uint64_t))__twr_v198)(__twr_v203, __twr_v204);
    __twr_v205 = (uint64_t)(&LexBssSection);
    __twr_v206 = (uint64_t)(&"bss");
    ((void (*)(uint64_t, uint64_t))__twr_v198)(__twr_v205, __twr_v206);
    __twr_v207 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v207) = __twr_v199;
    __twr_l7:;
    _jkl_epilogue:;
}
uint64_t LexLookupSection(uint64_t _mng_name208) {
    uint64_t _jkl_retv;
    uint64_t __twr_v209;
    uint64_t __twr_v210;
    uint64_t __twr_v211;
    ...
    uint64_t _mng_section216;
    uint64_t __twr_v217;
    __twr_v209 = *(uint8_t*)(_mng_name208);
    if (__twr_v209) { goto __twr_l9; } else { goto __twr_l10; }
    __twr_l10:;
    __twr_v210 = (uint64_t)(&LexDefaultSection);
    _jkl_retv = __twr_v210;
    goto _jkl_epilogue;
    __twr_l9:;
    __twr_v211 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v212 = (uint64_t)(&LexSectionHashTable);
    __twr_v213 = 1872ULL;
    __twr_v214 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v211)(__twr_v212, __twr_v213, _mng_name208, (uint64_t)(&_mng_created215));
    _mng_section216 = __twr_v214;
    if (_mng_created215) { goto __twr_l11; } else { goto __twr_l12; }
    __twr_l12:;
    _jkl_retv = _mng_section216;
    goto _jkl_epilogue;
    __twr_l11:;
    __twr_v217 = (uint64_t)(&LexInitializeSection);
    ((void (*)(uint64_t, uint64_t))__twr_v217)(_mng_section216, _mng_name208);
    _jkl_retv = _mng_section216;
    goto _jkl_epilogue;
    __twr_l8:;
    _jkl_epilogue:;
...
void LexPushSection(uint64_t _mng_section218) {
    uint64_t __twr_v219;
    uint64_t __twr_v220;
    uint64_t __twr_v221;
    ...
    uint64_t __twr_v227;
    uint64_t __twr_v228;
    __twr_v219 = (uint64_t)(&TlAllocateFromZone);
    __twr_v220 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v221 = ((uint64_t (*)(uint64_t))__twr_v219)(__twr_v220);
    _mng_elem222 = __twr_v221;
    __twr_v223 = (uint64_t)(&LexSectionStackTop);
    __twr_v224 = *(uint64_t*)(__twr_v223);
    *(uint64_t*)(_mng_elem222) = __twr_v224;
    __twr_v225 = (uint64_t)(&LexCurrentSection);
    __twr_v226 = *(uint64_t*)(__twr_v225);
    __twr_v227 = 8ULL;
    __twr_v228 = _mng_elem222 + __twr_v227;
    *(uint64_t*)(__twr_v228) = __twr_v226;
    *(uint64_t*)(__twr_v223) = _mng_elem222;
    *(uint64_t*)(__twr_v225) = _mng_section218;
    __twr_l13:;
    _jkl_epilogue:;
}
uint64_t LexPopSection() {
    ...
    uint64_t __twr_v240;
    uint64_t __twr_v241;
    __twr_v229 = (uint64_t)(&LexSectionStackTop);
    __twr_v230 = *(uint64_t*)(__twr_v229);
    _mng_elem231 = __twr_v230;
    if (_mng_elem231) { goto __twr_l15; } else { goto __twr_l16; }
    __twr_l16:;
    __twr_v232 = 0ULL;
    _jkl_retv = __twr_v232;
    goto _jkl_epilogue;
    __twr_l15:;
    __twr_v233 = *(uint64_t*)(_mng_elem231);
    __twr_v234 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v234) = __twr_v233;
    __twr_v235 = 8ULL;
    __twr_v236 = _mng_elem231 + __twr_v235;
    __twr_v237 = *(uint64_t*)(__twr_v236);
    __twr_v238 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v238) = __twr_v237;
    __twr_v239 = (uint64_t)(&TlFreeToZone);
    __twr_v240 = (uint64_t)(&LexSectionStackElementZone);
    ((void (*)(uint64_t, uint64_t))__twr_v239)(__twr_v240, _mng_elem231);
    __twr_v241 = 1ULL;
