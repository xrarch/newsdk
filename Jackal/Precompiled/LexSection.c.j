...
void LexInitializeSection(uint64_t _mng_section164, uint64_t _mng_name165) {
    uint64_t __twr_v166;
    uint64_t __twr_v167;
    uint64_t __twr_v168;
    uint64_t __twr_v169;
    ...
    uint64_t __twr_v190;
    uint64_t __twr_v191;
    __twr_v166 = (uint64_t)(&TlCopyString);
    __twr_v167 = 48ULL;
    __twr_v168 = _mng_section164 + __twr_v167;
    __twr_v169 = 64ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v166)(__twr_v168, _mng_name165, __twr_v169);
    __twr_v170 = 40ULL;
    __twr_v171 = _mng_section164 + __twr_v170;
    *(uint64_t*)(__twr_v171) = __twr_v168;
    __twr_v172 = (uint64_t)(&TlInitializeHashTable);
    __twr_v173 = 120ULL;
    __twr_v174 = _mng_section164 + __twr_v173;
    ((void (*)(uint64_t))__twr_v172)(__twr_v174);
    __twr_v175 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v176 = 1776ULL;
    __twr_v177 = _mng_section164 + __twr_v176;
    ((void (*)(uint64_t))__twr_v175)(__twr_v177);
    __twr_v178 = 1688ULL;
    __twr_v179 = _mng_section164 + __twr_v178;
    ((void (*)(uint64_t))__twr_v175)(__twr_v179);
    __twr_v180 = (uint64_t)(&LexDefaultSection);
    if (_mng_section164 == __twr_v180) { goto __twr_l2; } else { goto __twr_l3; }
    __twr_l3:;
    __twr_v181 = 0ULL;
    __twr_v182 = 112ULL;
    __twr_v183 = _mng_section164 + __twr_v182;
    *(uint64_t*)(__twr_v183) = __twr_v181;
    __twr_v184 = (uint64_t)(&LexSectionListTail);
    __twr_v185 = *(uint64_t*)(__twr_v184);
    if (!(__twr_v185)) { goto __twr_l6; } else { goto __twr_l5; }
    __twr_l5:;
    __twr_v186 = (uint64_t)(&LexSectionListTail);
    __twr_v187 = *(uint64_t*)(__twr_v186);
    __twr_v188 = 112ULL;
    __twr_v189 = __twr_v187 + __twr_v188;
    *(uint64_t*)(__twr_v189) = _mng_section164;
    goto __twr_l4;
    __twr_l6:;
    __twr_v190 = (uint64_t)(&LexSectionListHead);
    *(uint64_t*)(__twr_v190) = _mng_section164;
    __twr_l4:;
    __twr_v191 = (uint64_t)(&LexSectionListTail);
    *(uint64_t*)(__twr_v191) = _mng_section164;
    __twr_l2:;
    __twr_l1:;
    _jkl_epilogue:;
}
void LexInitializeSectionStuff() {
    ...
    uint64_t __twr_v205;
    uint64_t __twr_v206;
    __twr_v192 = (uint64_t)(&TlInitializeZone);
    __twr_v193 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v194 = 16ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v192)(__twr_v193, __twr_v194);
    __twr_v195 = (uint64_t)(&TlInitializeHashTable);
    __twr_v196 = (uint64_t)(&LexSectionHashTable);
    ((void (*)(uint64_t))__twr_v195)(__twr_v196);
    __twr_v197 = (uint64_t)(&LexInitializeSection);
    __twr_v198 = (uint64_t)(&LexDefaultSection);
    __twr_v199 = (uint64_t)(&"DEFAULT_SECTION");
    ((void (*)(uint64_t, uint64_t))__twr_v197)(__twr_v198, __twr_v199);
    __twr_v200 = (uint64_t)(&LexTextSection);
    __twr_v201 = (uint64_t)(&"text");
    ((void (*)(uint64_t, uint64_t))__twr_v197)(__twr_v200, __twr_v201);
    __twr_v202 = (uint64_t)(&LexDataSection);
    __twr_v203 = (uint64_t)(&"data");
    ((void (*)(uint64_t, uint64_t))__twr_v197)(__twr_v202, __twr_v203);
    __twr_v204 = (uint64_t)(&LexBssSection);
    __twr_v205 = (uint64_t)(&"bss");
    ((void (*)(uint64_t, uint64_t))__twr_v197)(__twr_v204, __twr_v205);
    __twr_v206 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v206) = __twr_v198;
    __twr_l7:;
    _jkl_epilogue:;
}
uint64_t LexLookupSection(uint64_t _mng_name207) {
    uint64_t _jkl_retv;
    uint64_t __twr_v208;
    uint64_t __twr_v209;
    uint64_t __twr_v210;
    ...
    uint64_t _mng_section215;
    uint64_t __twr_v216;
    __twr_v208 = *(uint8_t*)(_mng_name207);
    if (__twr_v208) { goto __twr_l9; } else { goto __twr_l10; }
    __twr_l10:;
    __twr_v209 = (uint64_t)(&LexDefaultSection);
    _jkl_retv = __twr_v209;
    goto _jkl_epilogue;
    __twr_l9:;
    __twr_v210 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v211 = (uint64_t)(&LexSectionHashTable);
    __twr_v212 = 1872ULL;
    __twr_v213 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v210)(__twr_v211, __twr_v212, _mng_name207, (uint64_t)(&_mng_created214));
    _mng_section215 = __twr_v213;
    if (_mng_created214) { goto __twr_l11; } else { goto __twr_l12; }
    __twr_l12:;
    _jkl_retv = _mng_section215;
    goto _jkl_epilogue;
    __twr_l11:;
    __twr_v216 = (uint64_t)(&LexInitializeSection);
    ((void (*)(uint64_t, uint64_t))__twr_v216)(_mng_section215, _mng_name207);
    _jkl_retv = _mng_section215;
    goto _jkl_epilogue;
    __twr_l8:;
    _jkl_epilogue:;
...
void LexPushSection(uint64_t _mng_section217) {
    uint64_t __twr_v218;
    uint64_t __twr_v219;
    uint64_t __twr_v220;
    uint64_t _mng_elem221;
    uint64_t __twr_v222;
    uint64_t __twr_v223;
    uint64_t __twr_v224;
    uint64_t __twr_v225;
    uint64_t __twr_v226;
    uint64_t __twr_v227;
    __twr_v218 = (uint64_t)(&TlAllocateFromZone);
    __twr_v219 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v220 = ((uint64_t (*)(uint64_t))__twr_v218)(__twr_v219);
    _mng_elem221 = __twr_v220;
    __twr_v222 = (uint64_t)(&LexSectionStackTop);
    __twr_v223 = *(uint64_t*)(__twr_v222);
    *(uint64_t*)(_mng_elem221) = __twr_v223;
    __twr_v224 = (uint64_t)(&LexCurrentSection);
    __twr_v225 = *(uint64_t*)(__twr_v224);
    __twr_v226 = 8ULL;
    __twr_v227 = _mng_elem221 + __twr_v226;
    *(uint64_t*)(__twr_v227) = __twr_v225;
    *(uint64_t*)(__twr_v222) = _mng_elem221;
    *(uint64_t*)(__twr_v224) = _mng_section217;
    __twr_l13:;
    _jkl_epilogue:;
}
uint64_t LexPopSection() {
    ...
    uint64_t __twr_v239;
    uint64_t __twr_v240;
    __twr_v228 = (uint64_t)(&LexSectionStackTop);
    __twr_v229 = *(uint64_t*)(__twr_v228);
    _mng_elem230 = __twr_v229;
    if (_mng_elem230) { goto __twr_l15; } else { goto __twr_l16; }
    __twr_l16:;
    __twr_v231 = 0ULL;
    _jkl_retv = __twr_v231;
    goto _jkl_epilogue;
    __twr_l15:;
    __twr_v232 = *(uint64_t*)(_mng_elem230);
    __twr_v233 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v233) = __twr_v232;
    __twr_v234 = 8ULL;
    __twr_v235 = _mng_elem230 + __twr_v234;
    __twr_v236 = *(uint64_t*)(__twr_v235);
    __twr_v237 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v237) = __twr_v236;
    __twr_v238 = (uint64_t)(&TlFreeToZone);
    __twr_v239 = (uint64_t)(&LexSectionStackElementZone);
    ((void (*)(uint64_t, uint64_t))__twr_v238)(__twr_v239, _mng_elem230);
    __twr_v240 = 1ULL;
