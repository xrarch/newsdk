...
void LexInitializeSection(uint64_t _mng_section146, uint64_t _mng_name147) {
    ...
    __twr_v161 = __twr_v157 + __twr_v160;
    __twr_v162 = 0ULL;
    ...
    *(uint64_t*)(__twr_v177) = _mng_section146;
    goto __twr_l1;
    __twr_l3:;
    __twr_v178 = (uint64_t)(&LexSectionListHead);
    *(uint64_t*)(__twr_v178) = _mng_section146;
    __twr_l1:;
    __twr_v179 = (uint64_t)(&LexSectionListTail);
    *(uint64_t*)(__twr_v179) = _mng_section146;
}
void LexInitializeSectionStuff() {
    ...
    uint64_t __twr_v188;
    uint64_t __twr_v189;
    __twr_v180 = (uint64_t)(&TlInitializeZone);
    __twr_v181 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v182 = 16ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v180)(__twr_v181, __twr_v182);
    __twr_v183 = (uint64_t)(&TlInitializeHashTable);
    __twr_v184 = (uint64_t)(&LexSectionHashTable);
    ((void (*)(uint64_t))__twr_v183)(__twr_v184);
    __twr_v185 = (uint64_t)(&LexInitializeSection);
    __twr_v186 = (uint64_t)(&LexDefaultSection);
    __twr_v187 = (uint64_t)(&"DEFAULT_SECTION");
    ((void (*)(uint64_t, uint64_t))__twr_v185)(__twr_v186, __twr_v187);
    __twr_v188 = (uint64_t)(&LexDefaultSection);
    __twr_v189 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v189) = __twr_v188;
}
uint64_t LexLookupSection(uint64_t _mng_name190) {
    uint64_t __twr_v191;
    uint64_t __twr_v192;
    uint64_t __twr_v193;
    uint64_t __twr_v194;
    ...
    __twr_v194 = _mng_name190 + __twr_v193;
    __twr_v195 = *(uint8_t*)(__twr_v194);
    __twr_v196 = 0ULL;
    if (__twr_v195 == __twr_v196) { goto __twr_l5; } else { goto __twr_l4; }
    __twr_l5:;
    __twr_v197 = (uint64_t)(&LexDefaultSection);
    return __twr_v197;
    __twr_l4:;
    ...
    if (_mng_created202) { goto __twr_l6; } else { goto __twr_l7; }
    __twr_l7:;
    return _mng_section204;
    __twr_l6:;
    __twr_v205 = (uint64_t)(&LexInitializeSection);
    ((void (*)(uint64_t, uint64_t))__twr_v205)(_mng_section204, _mng_name190);
    return _mng_section204;
}
void LexPushSection(uint64_t _mng_section206) {
    ...
    __twr_v213 = 0ULL;
    __twr_v214 = _mng_elem210 + __twr_v213;
    *(uint64_t*)(__twr_v214) = __twr_v212;
    __twr_v215 = (uint64_t)(&LexCurrentSection);
    __twr_v216 = *(uint64_t*)(__twr_v215);
    __twr_v217 = 8ULL;
    __twr_v218 = _mng_elem210 + __twr_v217;
    *(uint64_t*)(__twr_v218) = __twr_v216;
    __twr_v219 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v219) = _mng_elem210;
    __twr_v220 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v220) = _mng_section206;
}
uint64_t LexPopSection() {
    uint64_t __twr_v221;
    uint64_t __twr_v222;
    uint64_t _mng_elem223;
    uint64_t __twr_v224;
    uint64_t __twr_v225;
    uint64_t __twr_v226;
    uint64_t __twr_v227;
    ...
    uint64_t __twr_v234;
    uint64_t __twr_v235;
    __twr_v221 = (uint64_t)(&LexSectionStackTop);
    __twr_v222 = *(uint64_t*)(__twr_v221);
    _mng_elem223 = __twr_v222;
    if (_mng_elem223) { goto __twr_l8; } else { goto __twr_l9; }
    __twr_l9:;
    __twr_v224 = 0ULL;
    return __twr_v224;
    __twr_l8:;
    __twr_v225 = 0ULL;
    __twr_v226 = _mng_elem223 + __twr_v225;
    __twr_v227 = *(uint64_t*)(__twr_v226);
    __twr_v228 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v228) = __twr_v227;
    __twr_v229 = 8ULL;
    __twr_v230 = _mng_elem223 + __twr_v229;
    __twr_v231 = *(uint64_t*)(__twr_v230);
    __twr_v232 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v232) = __twr_v231;
    __twr_v233 = (uint64_t)(&TlFreeToZone);
    __twr_v234 = (uint64_t)(&LexSectionStackElementZone);
    ((void (*)(uint64_t, uint64_t))__twr_v233)(__twr_v234, _mng_elem223);
    __twr_v235 = 1ULL;
    return __twr_v235;
}
