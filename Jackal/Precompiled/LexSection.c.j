...
void LexInitializeSection(uint64_t _mng_section146, uint64_t _mng_name147) {
    ...
    __twr_v151 = 64ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v148)(__twr_v150, _mng_name147, __twr_v151);
    __twr_v152 = 40ULL;
    __twr_v153 = _mng_section146 + __twr_v152;
    *(uint64_t*)(__twr_v153) = __twr_v150;
    __twr_v154 = (uint64_t)(&TlInitializeHashTable);
    __twr_v155 = 120ULL;
    __twr_v156 = _mng_section146 + __twr_v155;
    ((void (*)(uint64_t))__twr_v154)(__twr_v156);
    __twr_v157 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v158 = 1776ULL;
    __twr_v159 = _mng_section146 + __twr_v158;
    ((void (*)(uint64_t))__twr_v157)(__twr_v159);
    __twr_v160 = 1688ULL;
    __twr_v161 = _mng_section146 + __twr_v160;
    ((void (*)(uint64_t))__twr_v157)(__twr_v161);
    __twr_v162 = (uint64_t)(&LexDefaultSection);
    if (_mng_section146 == __twr_v162) { goto __twr_l2; } else { goto __twr_l3; }
    __twr_l3:;
    __twr_v163 = 0ULL;
    __twr_v164 = 112ULL;
    ...
    *(uint64_t*)(__twr_v165) = __twr_v163;
    ...
    if (!(__twr_v167)) { goto __twr_l6; } else { goto __twr_l5; }
    __twr_l5:;
...
void LexInitializeSectionStuff() {
    ...
    __twr_v182 = (uint64_t)(&LexTextSection);
    __twr_v183 = (uint64_t)(&"text");
    ((void (*)(uint64_t, uint64_t))__twr_v179)(__twr_v182, __twr_v183);
    __twr_v184 = (uint64_t)(&LexDataSection);
    __twr_v185 = (uint64_t)(&"data");
    ((void (*)(uint64_t, uint64_t))__twr_v179)(__twr_v184, __twr_v185);
    __twr_v186 = (uint64_t)(&LexBssSection);
    __twr_v187 = (uint64_t)(&"bss");
    ((void (*)(uint64_t, uint64_t))__twr_v179)(__twr_v186, __twr_v187);
    __twr_v188 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v188) = __twr_v180;
    __twr_l7:;
    _jkl_epilogue:;
}
uint64_t LexLookupSection(uint64_t _mng_name189) {
    ...
    uint64_t _mng_section197;
    uint64_t __twr_v198;
    __twr_v190 = *(uint8_t*)(_mng_name189);
    if (__twr_v190) { goto __twr_l9; } else { goto __twr_l10; }
    __twr_l10:;
    __twr_v191 = (uint64_t)(&LexDefaultSection);
    _jkl_retv = __twr_v191;
    goto _jkl_epilogue;
    __twr_l9:;
    __twr_v192 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v193 = (uint64_t)(&LexSectionHashTable);
    __twr_v194 = 1872ULL;
    __twr_v195 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v192)(__twr_v193, __twr_v194, _mng_name189, (uint64_t)(&_mng_created196));
    _mng_section197 = __twr_v195;
    if (_mng_created196) { goto __twr_l11; } else { goto __twr_l12; }
    __twr_l12:;
    _jkl_retv = _mng_section197;
    goto _jkl_epilogue;
    __twr_l11:;
    __twr_v198 = (uint64_t)(&LexInitializeSection);
    ((void (*)(uint64_t, uint64_t))__twr_v198)(_mng_section197, _mng_name189);
    _jkl_retv = _mng_section197;
    goto _jkl_epilogue;
    __twr_l8:;
    _jkl_epilogue:;
...
void LexPushSection(uint64_t _mng_section199) {
    uint64_t __twr_v200;
    uint64_t __twr_v201;
    uint64_t __twr_v202;
    uint64_t _mng_elem203;
    uint64_t __twr_v204;
    uint64_t __twr_v205;
    uint64_t __twr_v206;
    uint64_t __twr_v207;
    uint64_t __twr_v208;
    uint64_t __twr_v209;
    __twr_v200 = (uint64_t)(&TlAllocateFromZone);
    __twr_v201 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v202 = ((uint64_t (*)(uint64_t))__twr_v200)(__twr_v201);
    _mng_elem203 = __twr_v202;
    __twr_v204 = (uint64_t)(&LexSectionStackTop);
    __twr_v205 = *(uint64_t*)(__twr_v204);
    *(uint64_t*)(_mng_elem203) = __twr_v205;
    __twr_v206 = (uint64_t)(&LexCurrentSection);
    __twr_v207 = *(uint64_t*)(__twr_v206);
    __twr_v208 = 8ULL;
    __twr_v209 = _mng_elem203 + __twr_v208;
    *(uint64_t*)(__twr_v209) = __twr_v207;
    *(uint64_t*)(__twr_v204) = _mng_elem203;
    *(uint64_t*)(__twr_v206) = _mng_section199;
    __twr_l13:;
    _jkl_epilogue:;
}
uint64_t LexPopSection() {
    ...
    _mng_elem212 = __twr_v211;
    if (_mng_elem212) { goto __twr_l15; } else { goto __twr_l16; }
    __twr_l16:;
    __twr_v213 = 0ULL;
    _jkl_retv = __twr_v213;
    goto _jkl_epilogue;
    __twr_l15:;
    __twr_v214 = *(uint64_t*)(_mng_elem212);
    __twr_v215 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v215) = __twr_v214;
    __twr_v216 = 8ULL;
    __twr_v217 = _mng_elem212 + __twr_v216;
    ...
    *(uint64_t*)(__twr_v219) = __twr_v218;
    ...
    __twr_v221 = (uint64_t)(&LexSectionStackElementZone);
    ((void (*)(uint64_t, uint64_t))__twr_v220)(__twr_v221, _mng_elem212);
    __twr_v222 = 1ULL;
