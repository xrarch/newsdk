...
void LexInitializeSection(uint64_t _mng_section153, uint64_t _mng_name154) {
    uint64_t __twr_v155;
    uint64_t __twr_v156;
    uint64_t __twr_v157;
    uint64_t __twr_v158;
    ...
    uint64_t __twr_v179;
    uint64_t __twr_v180;
    __twr_v155 = (uint64_t)(&TlCopyString);
    __twr_v156 = 48ULL;
    __twr_v157 = _mng_section153 + __twr_v156;
    __twr_v158 = 64ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v155)(__twr_v157, _mng_name154, __twr_v158);
    __twr_v159 = 40ULL;
    __twr_v160 = _mng_section153 + __twr_v159;
    *(uint64_t*)(__twr_v160) = __twr_v157;
    __twr_v161 = (uint64_t)(&TlInitializeHashTable);
    __twr_v162 = 120ULL;
    __twr_v163 = _mng_section153 + __twr_v162;
    ((void (*)(uint64_t))__twr_v161)(__twr_v163);
    __twr_v164 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v165 = 1776ULL;
    __twr_v166 = _mng_section153 + __twr_v165;
    ((void (*)(uint64_t))__twr_v164)(__twr_v166);
    __twr_v167 = 1688ULL;
    __twr_v168 = _mng_section153 + __twr_v167;
    ((void (*)(uint64_t))__twr_v164)(__twr_v168);
    __twr_v169 = (uint64_t)(&LexDefaultSection);
    if (_mng_section153 == __twr_v169) { goto __twr_l2; } else { goto __twr_l3; }
    __twr_l3:;
    __twr_v170 = 0ULL;
    __twr_v171 = 112ULL;
    __twr_v172 = _mng_section153 + __twr_v171;
    *(uint64_t*)(__twr_v172) = __twr_v170;
    __twr_v173 = (uint64_t)(&LexSectionListTail);
    __twr_v174 = *(uint64_t*)(__twr_v173);
    if (!(__twr_v174)) { goto __twr_l6; } else { goto __twr_l5; }
    __twr_l5:;
    __twr_v175 = (uint64_t)(&LexSectionListTail);
    __twr_v176 = *(uint64_t*)(__twr_v175);
    __twr_v177 = 112ULL;
    __twr_v178 = __twr_v176 + __twr_v177;
    *(uint64_t*)(__twr_v178) = _mng_section153;
    goto __twr_l4;
    __twr_l6:;
    __twr_v179 = (uint64_t)(&LexSectionListHead);
    *(uint64_t*)(__twr_v179) = _mng_section153;
    __twr_l4:;
    __twr_v180 = (uint64_t)(&LexSectionListTail);
    *(uint64_t*)(__twr_v180) = _mng_section153;
    __twr_l2:;
    __twr_l1:;
    _jkl_epilogue:;
}
void LexInitializeSectionStuff() {
    ...
    uint64_t __twr_v194;
    uint64_t __twr_v195;
    __twr_v181 = (uint64_t)(&TlInitializeZone);
    __twr_v182 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v183 = 16ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v181)(__twr_v182, __twr_v183);
    __twr_v184 = (uint64_t)(&TlInitializeHashTable);
    __twr_v185 = (uint64_t)(&LexSectionHashTable);
    ((void (*)(uint64_t))__twr_v184)(__twr_v185);
    __twr_v186 = (uint64_t)(&LexInitializeSection);
    __twr_v187 = (uint64_t)(&LexDefaultSection);
    __twr_v188 = (uint64_t)(&"DEFAULT_SECTION");
    ((void (*)(uint64_t, uint64_t))__twr_v186)(__twr_v187, __twr_v188);
    __twr_v189 = (uint64_t)(&LexTextSection);
    __twr_v190 = (uint64_t)(&"text");
    ((void (*)(uint64_t, uint64_t))__twr_v186)(__twr_v189, __twr_v190);
    __twr_v191 = (uint64_t)(&LexDataSection);
    __twr_v192 = (uint64_t)(&"data");
    ((void (*)(uint64_t, uint64_t))__twr_v186)(__twr_v191, __twr_v192);
    __twr_v193 = (uint64_t)(&LexBssSection);
    __twr_v194 = (uint64_t)(&"bss");
    ((void (*)(uint64_t, uint64_t))__twr_v186)(__twr_v193, __twr_v194);
    __twr_v195 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v195) = __twr_v187;
    __twr_l7:;
    _jkl_epilogue:;
}
uint64_t LexLookupSection(uint64_t _mng_name196) {
    uint64_t _jkl_retv;
    uint64_t __twr_v197;
    uint64_t __twr_v198;
    uint64_t __twr_v199;
    ...
    uint64_t __twr_v201;
    uint64_t __twr_v202;
    uint64_t _mng_created203;
    uint64_t _mng_section204;
    uint64_t __twr_v205;
    __twr_v197 = *(uint8_t*)(_mng_name196);
    if (__twr_v197) { goto __twr_l9; } else { goto __twr_l10; }
    __twr_l10:;
    __twr_v198 = (uint64_t)(&LexDefaultSection);
    _jkl_retv = __twr_v198;
    goto _jkl_epilogue;
    __twr_l9:;
    __twr_v199 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v200 = (uint64_t)(&LexSectionHashTable);
    __twr_v201 = 1872ULL;
    __twr_v202 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v199)(__twr_v200, __twr_v201, _mng_name196, (uint64_t)(&_mng_created203));
    _mng_section204 = __twr_v202;
    if (_mng_created203) { goto __twr_l11; } else { goto __twr_l12; }
    __twr_l12:;
    _jkl_retv = _mng_section204;
    goto _jkl_epilogue;
    __twr_l11:;
    __twr_v205 = (uint64_t)(&LexInitializeSection);
    ((void (*)(uint64_t, uint64_t))__twr_v205)(_mng_section204, _mng_name196);
    _jkl_retv = _mng_section204;
    goto _jkl_epilogue;
    __twr_l8:;
    _jkl_epilogue:;
...
void LexPushSection(uint64_t _mng_section206) {
    uint64_t __twr_v207;
    uint64_t __twr_v208;
    uint64_t __twr_v209;
    uint64_t _mng_elem210;
    uint64_t __twr_v211;
    uint64_t __twr_v212;
    uint64_t __twr_v213;
    uint64_t __twr_v214;
    uint64_t __twr_v215;
    uint64_t __twr_v216;
    __twr_v207 = (uint64_t)(&TlAllocateFromZone);
    __twr_v208 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v209 = ((uint64_t (*)(uint64_t))__twr_v207)(__twr_v208);
    _mng_elem210 = __twr_v209;
    __twr_v211 = (uint64_t)(&LexSectionStackTop);
    __twr_v212 = *(uint64_t*)(__twr_v211);
    *(uint64_t*)(_mng_elem210) = __twr_v212;
    __twr_v213 = (uint64_t)(&LexCurrentSection);
    __twr_v214 = *(uint64_t*)(__twr_v213);
    __twr_v215 = 8ULL;
    __twr_v216 = _mng_elem210 + __twr_v215;
    *(uint64_t*)(__twr_v216) = __twr_v214;
    *(uint64_t*)(__twr_v211) = _mng_elem210;
    *(uint64_t*)(__twr_v213) = _mng_section206;
    __twr_l13:;
    _jkl_epilogue:;
}
uint64_t LexPopSection() {
    ...
    uint64_t __twr_v228;
    uint64_t __twr_v229;
    __twr_v217 = (uint64_t)(&LexSectionStackTop);
    __twr_v218 = *(uint64_t*)(__twr_v217);
    _mng_elem219 = __twr_v218;
    if (_mng_elem219) { goto __twr_l15; } else { goto __twr_l16; }
    __twr_l16:;
    __twr_v220 = 0ULL;
    _jkl_retv = __twr_v220;
    goto _jkl_epilogue;
    __twr_l15:;
    __twr_v221 = *(uint64_t*)(_mng_elem219);
    __twr_v222 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v222) = __twr_v221;
    __twr_v223 = 8ULL;
    __twr_v224 = _mng_elem219 + __twr_v223;
    __twr_v225 = *(uint64_t*)(__twr_v224);
    __twr_v226 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v226) = __twr_v225;
    __twr_v227 = (uint64_t)(&TlFreeToZone);
    __twr_v228 = (uint64_t)(&LexSectionStackElementZone);
    ((void (*)(uint64_t, uint64_t))__twr_v227)(__twr_v228, _mng_elem219);
    __twr_v229 = 1ULL;
