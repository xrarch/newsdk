...
void LexInitializeSection(uint64_t _mng_section146, uint64_t _mng_name147) {
    ...
    __twr_v151 = 0ULL;
    __twr_v152 = 64ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v148)(__twr_v150, _mng_name147, __twr_v152);
    __twr_v153 = _mng_section146 + __twr_v149;
    __twr_v154 = 40ULL;
    __twr_v155 = _mng_section146 + __twr_v154;
    ...
    *(uint64_t*)(__twr_v166) = _mng_section146;
    goto __twr_l1;
    __twr_l3:;
    __twr_v167 = (uint64_t)(&LexSectionListHead);
    *(uint64_t*)(__twr_v167) = _mng_section146;
    __twr_l1:;
    __twr_v168 = (uint64_t)(&LexSectionListTail);
    *(uint64_t*)(__twr_v168) = _mng_section146;
}
void LexInitializeSectionStuff() {
    ...
    __twr_v170 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v171 = 16ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v169)(__twr_v170, __twr_v171);
    __twr_v172 = (uint64_t)(&TlInitializeHashTable);
    __twr_v173 = (uint64_t)(&LexSectionHashTable);
    ((void (*)(uint64_t))__twr_v172)(__twr_v173);
    __twr_v174 = (uint64_t)(&LexInitializeSection);
    __twr_v175 = (uint64_t)(&LexDefaultSection);
    __twr_v176 = (uint64_t)(&"DEFAULT_SECTION");
    ((void (*)(uint64_t, uint64_t))__twr_v174)(__twr_v175, __twr_v176);
    __twr_v177 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v177) = __twr_v175;
}
uint64_t LexLookupSection(uint64_t _mng_name178) {
    uint64_t __twr_v179;
    uint64_t __twr_v180;
    uint64_t __twr_v181;
    uint64_t __twr_v182;
    ...
    uint64_t __twr_v184;
    uint64_t __twr_v185;
    uint8_t _mng_created186;
    uint64_t __twr_v187;
    uint64_t _mng_section188;
    uint64_t __twr_v189;
    __twr_v179 = 0ULL;
    ...
    return __twr_v181;
    __twr_l4:;
    __twr_v182 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v183 = (uint64_t)(&LexSectionHashTable);
    __twr_v184 = 1696ULL;
    __twr_v185 = (uint64_t)(&_mng_created186);
    __twr_v187 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v182)(__twr_v183, __twr_v184, _mng_name178, __twr_v185);
    _mng_section188 = __twr_v187;
    if (_mng_created186) { goto __twr_l6; } else { goto __twr_l7; }
    __twr_l7:;
    return _mng_section188;
    __twr_l6:;
    __twr_v189 = (uint64_t)(&LexInitializeSection);
    ((void (*)(uint64_t, uint64_t))__twr_v189)(_mng_section188, _mng_name178);
    return _mng_section188;
}
void LexPushSection(uint64_t _mng_section190) {
    uint64_t __twr_v191;
    uint64_t __twr_v192;
    uint64_t __twr_v193;
    uint64_t __twr_v194;
    ...
    uint64_t __twr_v198;
    uint64_t __twr_v199;
    __twr_v191 = (uint64_t)(&TlAllocateFromZone);
    __twr_v192 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v193 = ((uint64_t (*)(uint64_t))__twr_v191)(__twr_v192);
    __twr_v194 = (uint64_t)(&LexSectionStackTop);
    __twr_v195 = *(uint64_t*)(__twr_v194);
    *(uint64_t*)(__twr_v193) = __twr_v195;
    __twr_v196 = (uint64_t)(&LexCurrentSection);
    __twr_v197 = *(uint64_t*)(__twr_v196);
    __twr_v198 = 8ULL;
    __twr_v199 = __twr_v193 + __twr_v198;
    *(uint64_t*)(__twr_v199) = __twr_v197;
    *(uint64_t*)(__twr_v194) = __twr_v193;
    *(uint64_t*)(__twr_v196) = _mng_section190;
}
uint64_t LexPopSection() {
    ...
    uint64_t __twr_v211;
    uint64_t __twr_v212;
    __twr_v200 = (uint64_t)(&LexSectionStackTop);
    ...
    return __twr_v203;
    __twr_l8:;
    __twr_v204 = *(uint64_t*)(_mng_elem202);
    __twr_v205 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v205) = __twr_v204;
    __twr_v206 = 8ULL;
    __twr_v207 = _mng_elem202 + __twr_v206;
    __twr_v208 = *(uint64_t*)(__twr_v207);
    __twr_v209 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v209) = __twr_v208;
    __twr_v210 = (uint64_t)(&TlFreeToZone);
    __twr_v211 = (uint64_t)(&LexSectionStackElementZone);
    ((void (*)(uint64_t, uint64_t))__twr_v210)(__twr_v211, _mng_elem202);
    __twr_v212 = 1ULL;
    return __twr_v212;
}
