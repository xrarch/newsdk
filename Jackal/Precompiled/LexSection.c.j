...
void LexInitializeSection(uint64_t _mng_section148, uint64_t _mng_name149) {
    uint64_t __twr_v150;
    uint64_t __twr_v151;
    uint64_t __twr_v152;
    uint64_t __twr_v153;
    ...
    uint64_t __twr_v174;
    uint64_t __twr_v175;
    __twr_v150 = (uint64_t)(&TlCopyString);
    __twr_v151 = 48ULL;
    __twr_v152 = _mng_section148 + __twr_v151;
    __twr_v153 = 64ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v150)(__twr_v152, _mng_name149, __twr_v153);
    __twr_v154 = 40ULL;
    __twr_v155 = _mng_section148 + __twr_v154;
    *(uint64_t*)(__twr_v155) = __twr_v152;
    __twr_v156 = (uint64_t)(&TlInitializeHashTable);
    __twr_v157 = 120ULL;
    __twr_v158 = _mng_section148 + __twr_v157;
    ((void (*)(uint64_t))__twr_v156)(__twr_v158);
    __twr_v159 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v160 = 1776ULL;
    __twr_v161 = _mng_section148 + __twr_v160;
    ((void (*)(uint64_t))__twr_v159)(__twr_v161);
    __twr_v162 = 1688ULL;
    __twr_v163 = _mng_section148 + __twr_v162;
    ((void (*)(uint64_t))__twr_v159)(__twr_v163);
    __twr_v164 = (uint64_t)(&LexDefaultSection);
    if (_mng_section148 == __twr_v164) { goto __twr_l2; } else { goto __twr_l3; }
    __twr_l3:;
    __twr_v165 = 0ULL;
    __twr_v166 = 112ULL;
    __twr_v167 = _mng_section148 + __twr_v166;
    *(uint64_t*)(__twr_v167) = __twr_v165;
    __twr_v168 = (uint64_t)(&LexSectionListTail);
    __twr_v169 = *(uint64_t*)(__twr_v168);
    if (!(__twr_v169)) { goto __twr_l6; } else { goto __twr_l5; }
    __twr_l5:;
    __twr_v170 = (uint64_t)(&LexSectionListTail);
    __twr_v171 = *(uint64_t*)(__twr_v170);
    __twr_v172 = 112ULL;
    __twr_v173 = __twr_v171 + __twr_v172;
    *(uint64_t*)(__twr_v173) = _mng_section148;
    goto __twr_l4;
    __twr_l6:;
    __twr_v174 = (uint64_t)(&LexSectionListHead);
    *(uint64_t*)(__twr_v174) = _mng_section148;
    __twr_l4:;
    __twr_v175 = (uint64_t)(&LexSectionListTail);
    *(uint64_t*)(__twr_v175) = _mng_section148;
    __twr_l2:;
    __twr_l1:;
    _jkl_epilogue:;
}
void LexInitializeSectionStuff() {
    ...
    __twr_v177 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v178 = 16ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v176)(__twr_v177, __twr_v178);
    __twr_v179 = (uint64_t)(&TlInitializeHashTable);
    __twr_v180 = (uint64_t)(&LexSectionHashTable);
    ((void (*)(uint64_t))__twr_v179)(__twr_v180);
    __twr_v181 = (uint64_t)(&LexInitializeSection);
    __twr_v182 = (uint64_t)(&LexDefaultSection);
    __twr_v183 = (uint64_t)(&"DEFAULT_SECTION");
    ((void (*)(uint64_t, uint64_t))__twr_v181)(__twr_v182, __twr_v183);
    __twr_v184 = (uint64_t)(&LexTextSection);
    __twr_v185 = (uint64_t)(&"text");
    ((void (*)(uint64_t, uint64_t))__twr_v181)(__twr_v184, __twr_v185);
    __twr_v186 = (uint64_t)(&LexDataSection);
    __twr_v187 = (uint64_t)(&"data");
    ((void (*)(uint64_t, uint64_t))__twr_v181)(__twr_v186, __twr_v187);
    __twr_v188 = (uint64_t)(&LexBssSection);
    __twr_v189 = (uint64_t)(&"bss");
    ((void (*)(uint64_t, uint64_t))__twr_v181)(__twr_v188, __twr_v189);
    __twr_v190 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v190) = __twr_v182;
    __twr_l7:;
    _jkl_epilogue:;
}
uint64_t LexLookupSection(uint64_t _mng_name191) {
    uint64_t _jkl_retv;
    uint64_t __twr_v192;
    uint64_t __twr_v193;
    uint64_t __twr_v194;
    ...
    uint64_t __twr_v196;
    uint64_t __twr_v197;
    uint64_t _mng_created198;
    uint64_t _mng_section199;
    uint64_t __twr_v200;
    __twr_v192 = *(uint8_t*)(_mng_name191);
    if (__twr_v192) { goto __twr_l9; } else { goto __twr_l10; }
    __twr_l10:;
    __twr_v193 = (uint64_t)(&LexDefaultSection);
    _jkl_retv = __twr_v193;
    goto _jkl_epilogue;
    __twr_l9:;
    __twr_v194 = (uint64_t)(&TlLookupOrAllocateEntryHashTable);
    __twr_v195 = (uint64_t)(&LexSectionHashTable);
    __twr_v196 = 1872ULL;
    __twr_v197 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v194)(__twr_v195, __twr_v196, _mng_name191, (uint64_t)(&_mng_created198));
    _mng_section199 = __twr_v197;
    if (_mng_created198) { goto __twr_l11; } else { goto __twr_l12; }
    __twr_l12:;
    _jkl_retv = _mng_section199;
    goto _jkl_epilogue;
    __twr_l11:;
    __twr_v200 = (uint64_t)(&LexInitializeSection);
    ((void (*)(uint64_t, uint64_t))__twr_v200)(_mng_section199, _mng_name191);
    _jkl_retv = _mng_section199;
    goto _jkl_epilogue;
    __twr_l8:;
    _jkl_epilogue:;
...
void LexPushSection(uint64_t _mng_section201) {
    uint64_t __twr_v202;
    uint64_t __twr_v203;
    uint64_t __twr_v204;
    ...
    uint64_t __twr_v210;
    uint64_t __twr_v211;
    __twr_v202 = (uint64_t)(&TlAllocateFromZone);
    __twr_v203 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v204 = ((uint64_t (*)(uint64_t))__twr_v202)(__twr_v203);
    _mng_elem205 = __twr_v204;
    __twr_v206 = (uint64_t)(&LexSectionStackTop);
    __twr_v207 = *(uint64_t*)(__twr_v206);
    *(uint64_t*)(_mng_elem205) = __twr_v207;
    __twr_v208 = (uint64_t)(&LexCurrentSection);
    __twr_v209 = *(uint64_t*)(__twr_v208);
    __twr_v210 = 8ULL;
    __twr_v211 = _mng_elem205 + __twr_v210;
    *(uint64_t*)(__twr_v211) = __twr_v209;
    *(uint64_t*)(__twr_v206) = _mng_elem205;
    *(uint64_t*)(__twr_v208) = _mng_section201;
    __twr_l13:;
    _jkl_epilogue:;
}
uint64_t LexPopSection() {
    ...
    if (_mng_elem214) { goto __twr_l15; } else { goto __twr_l16; }
    __twr_l16:;
    __twr_v215 = 0ULL;
    _jkl_retv = __twr_v215;
    goto _jkl_epilogue;
    __twr_l15:;
    __twr_v216 = *(uint64_t*)(_mng_elem214);
    __twr_v217 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v217) = __twr_v216;
    __twr_v218 = 8ULL;
    __twr_v219 = _mng_elem214 + __twr_v218;
    ...
    *(uint64_t*)(__twr_v221) = __twr_v220;
    ...
    __twr_v223 = (uint64_t)(&LexSectionStackElementZone);
    ((void (*)(uint64_t, uint64_t))__twr_v222)(__twr_v223, _mng_elem214);
    __twr_v224 = 1ULL;
