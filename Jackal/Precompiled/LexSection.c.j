...
void LexInitializeSection(uint64_t _mng_section140, uint64_t _mng_name141) {
    uint64_t __twr_v142;
    uint64_t __twr_v143;
    uint64_t __twr_v144;
    uint64_t __twr_v145;
    ...
    uint64_t __twr_v166;
    uint64_t __twr_v167;
    __twr_v142 = (uint64_t)(&TlCopyString);
    __twr_v143 = 48ULL;
    __twr_v144 = _mng_section140 + __twr_v143;
    __twr_v145 = 64ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v142)(__twr_v144, _mng_name141, __twr_v145);
    __twr_v146 = 40ULL;
    __twr_v147 = _mng_section140 + __twr_v146;
    *(uint64_t*)(__twr_v147) = __twr_v144;
    __twr_v148 = (uint64_t)(&TlInitializeHashTable);
    __twr_v149 = 120ULL;
    __twr_v150 = _mng_section140 + __twr_v149;
    ((void (*)(uint64_t))__twr_v148)(__twr_v150);
    __twr_v151 = (uint64_t)(&TlInitializeDynamicBuffer);
    __twr_v152 = 1776ULL;
    __twr_v153 = _mng_section140 + __twr_v152;
    ((void (*)(uint64_t))__twr_v151)(__twr_v153);
    __twr_v154 = 1688ULL;
    __twr_v155 = _mng_section140 + __twr_v154;
    ((void (*)(uint64_t))__twr_v151)(__twr_v155);
    __twr_v156 = (uint64_t)(&LexDefaultSection);
    if (_mng_section140 == __twr_v156) { goto __twr_l2; } else { goto __twr_l3; }
    __twr_l3:;
    __twr_v157 = 0ULL;
    __twr_v158 = 112ULL;
    __twr_v159 = _mng_section140 + __twr_v158;
    *(uint64_t*)(__twr_v159) = __twr_v157;
    __twr_v160 = (uint64_t)(&LexSectionListTail);
    __twr_v161 = *(uint64_t*)(__twr_v160);
    if (!(__twr_v161)) { goto __twr_l6; } else { goto __twr_l5; }
    __twr_l5:;
    __twr_v162 = (uint64_t)(&LexSectionListTail);
    __twr_v163 = *(uint64_t*)(__twr_v162);
    __twr_v164 = 112ULL;
    __twr_v165 = __twr_v163 + __twr_v164;
    *(uint64_t*)(__twr_v165) = _mng_section140;
    goto __twr_l4;
    __twr_l6:;
    __twr_v166 = (uint64_t)(&LexSectionListHead);
    *(uint64_t*)(__twr_v166) = _mng_section140;
    __twr_l4:;
    __twr_v167 = (uint64_t)(&LexSectionListTail);
    *(uint64_t*)(__twr_v167) = _mng_section140;
    __twr_l2:;
    __twr_l1:;
    _jkl_epilogue:;
}
void LexInitializeSectionStuff() {
    ...
    __twr_v169 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v170 = 16ULL;
    ((void (*)(uint64_t, uint64_t))__twr_v168)(__twr_v169, __twr_v170);
    __twr_v171 = (uint64_t)(&TlInitializeHashTable);
    __twr_v172 = (uint64_t)(&LexSectionHashTable);
    ((void (*)(uint64_t))__twr_v171)(__twr_v172);
    __twr_v173 = (uint64_t)(&LexInitializeSection);
    __twr_v174 = (uint64_t)(&LexDefaultSection);
    __twr_v175 = (uint64_t)(&"DEFAULT_SECTION");
    ((void (*)(uint64_t, uint64_t))__twr_v173)(__twr_v174, __twr_v175);
    __twr_v176 = (uint64_t)(&LexTextSection);
    __twr_v177 = (uint64_t)(&"text");
    ((void (*)(uint64_t, uint64_t))__twr_v173)(__twr_v176, __twr_v177);
    __twr_v178 = (uint64_t)(&LexDataSection);
    __twr_v179 = (uint64_t)(&"data");
    ((void (*)(uint64_t, uint64_t))__twr_v173)(__twr_v178, __twr_v179);
    __twr_v180 = (uint64_t)(&LexBssSection);
    __twr_v181 = (uint64_t)(&"bss");
    ((void (*)(uint64_t, uint64_t))__twr_v173)(__twr_v180, __twr_v181);
    __twr_v182 = (uint64_t)(&LexCurrentSection);
    *(uint64_t*)(__twr_v182) = __twr_v174;
    __twr_l7:;
    _jkl_epilogue:;
}
uint64_t LexLookupSection(uint64_t _mng_name183) {
    ...
    uint64_t __twr_v188;
    uint64_t __twr_v189;
    uint64_t _mng_created190;
    uint64_t _mng_section191;
    uint64_t __twr_v192;
    __twr_v184 = *(uint8_t*)(_mng_name183);
    ...
    __twr_v188 = 1872ULL;
    __twr_v189 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v186)(__twr_v187, __twr_v188, _mng_name183, (uint64_t)(&_mng_created190));
    ...
    ((void (*)(uint64_t, uint64_t))__twr_v192)(_mng_section191, _mng_name183);
    _jkl_retv = _mng_section191;
    goto _jkl_epilogue;
    __twr_l8:;
    _jkl_epilogue:;
...
void LexPushSection(uint64_t _mng_section193) {
    uint64_t __twr_v194;
    uint64_t __twr_v195;
    uint64_t __twr_v196;
    uint64_t _mng_elem197;
    uint64_t __twr_v198;
    uint64_t __twr_v199;
    uint64_t __twr_v200;
    uint64_t __twr_v201;
    uint64_t __twr_v202;
    uint64_t __twr_v203;
    __twr_v194 = (uint64_t)(&TlAllocateFromZone);
    __twr_v195 = (uint64_t)(&LexSectionStackElementZone);
    __twr_v196 = ((uint64_t (*)(uint64_t))__twr_v194)(__twr_v195);
    _mng_elem197 = __twr_v196;
    __twr_v198 = (uint64_t)(&LexSectionStackTop);
    __twr_v199 = *(uint64_t*)(__twr_v198);
    *(uint64_t*)(_mng_elem197) = __twr_v199;
    __twr_v200 = (uint64_t)(&LexCurrentSection);
    __twr_v201 = *(uint64_t*)(__twr_v200);
    __twr_v202 = 8ULL;
    __twr_v203 = _mng_elem197 + __twr_v202;
    *(uint64_t*)(__twr_v203) = __twr_v201;
    *(uint64_t*)(__twr_v198) = _mng_elem197;
    *(uint64_t*)(__twr_v200) = _mng_section193;
    __twr_l13:;
    _jkl_epilogue:;
}
uint64_t LexPopSection() {
    ...
    uint64_t __twr_v215;
    uint64_t __twr_v216;
    __twr_v204 = (uint64_t)(&LexSectionStackTop);
    __twr_v205 = *(uint64_t*)(__twr_v204);
    _mng_elem206 = __twr_v205;
    if (_mng_elem206) { goto __twr_l15; } else { goto __twr_l16; }
    __twr_l16:;
    __twr_v207 = 0ULL;
    _jkl_retv = __twr_v207;
    goto _jkl_epilogue;
    __twr_l15:;
    __twr_v208 = *(uint64_t*)(_mng_elem206);
    __twr_v209 = (uint64_t)(&LexSectionStackTop);
    *(uint64_t*)(__twr_v209) = __twr_v208;
    __twr_v210 = 8ULL;
    __twr_v211 = _mng_elem206 + __twr_v210;
    ...
    *(uint64_t*)(__twr_v213) = __twr_v212;
    ...
    __twr_v215 = (uint64_t)(&LexSectionStackElementZone);
    ((void (*)(uint64_t, uint64_t))__twr_v214)(__twr_v215, _mng_elem206);
    __twr_v216 = 1ULL;
