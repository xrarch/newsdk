...
void LexPushStream(uint64_t _mng_stream207) {
    ...
    *(uint64_t*)(__twr_v212) = _mng_stream207;
}
uint64_t LexPopStream() {
    uint64_t __twr_v213;
    uint64_t __twr_v214;
    uint64_t _mng_oldstream215;
    uint64_t __twr_v216;
    uint64_t __twr_v217;
    uint64_t __twr_v218;
    uint64_t __twr_v219;
...
void LexInitializeFileStream(uint64_t _mng_stream220, uint64_t _mng_fileblock221, uint64_t _mng_handle222) {
    ...
    __twr_v226 = 16384ULL;
    __twr_v227 = (uint64_t)(&_mng_buffer228);
    __twr_v229 = ((uint64_t (*)(uint64_t, uint64_t))__twr_v225)(__twr_v226, __twr_v227);
    _mng_status230 = __twr_v229;
    if (_mng_status230) { goto __twr_l4; } else { goto __twr_l3; }
    __twr_l4:;
    __twr_v231 = (uint64_t)(&TlInternalError);
    __twr_v232 = (uint64_t)(&"Failed to allocate lex buffer");
    __twr_v233 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v231)(__twr_v232, __twr_v233, __twr_v233, __twr_v233);
    __twr_l3:;
    __twr_v234 = 8ULL;
    __twr_v235 = _mng_stream220 + __twr_v234;
    *(uint64_t*)(__twr_v235) = _mng_fileblock221;
    __twr_v236 = 16ULL;
    __twr_v237 = _mng_stream220 + __twr_v236;
    *(uint64_t*)(__twr_v237) = _mng_handle222;
    __twr_v238 = 16384ULL;
    __twr_v239 = 32ULL;
    __twr_v240 = _mng_stream220 + __twr_v239;
    *(uint32_t*)(__twr_v240) = __twr_v238;
    __twr_v241 = 24ULL;
    __twr_v242 = _mng_stream220 + __twr_v241;
    *(uint64_t*)(__twr_v242) = _mng_buffer228;
}
uint64_t LexCreateFileStream(uint64_t _mng_fileblock243, uint64_t _mng_handle244) {
    uint64_t __twr_v245;
    uint64_t __twr_v246;
    uint64_t _mng_stream247;
    uint64_t __twr_v248;
    __twr_v245 = (uint64_t)(&LexAllocateStream);
    __twr_v246 = ((uint64_t (*)())__twr_v245)();
    _mng_stream247 = __twr_v246;
    __twr_v248 = (uint64_t)(&LexInitializeFileStream);
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v248)(_mng_stream247, _mng_fileblock243, _mng_handle244);
    return _mng_stream247;
}
...
uint64_t LexStreamNextCharacter() {
    ...
    if (__twr_v250) { goto __twr_l5; } else { goto __twr_l6; }
    __twr_l5:;
    __twr_v251 = (uint64_t)(&LexCurrentStream);
    __twr_v252 = *(uint64_t*)(__twr_v251);
    _mng_stream253 = __twr_v252;
    __twr_v254 = 92ULL;
    __twr_v255 = _mng_stream253 + __twr_v254;
    __twr_v256 = *(uint8_t*)(__twr_v255);
    if (__twr_v256) { goto __twr_l9; } else { goto __twr_l10; }
    __twr_l9:;
    ...
    __twr_v266 = __twr_v265 + __twr_v259;
    *(uint8_t*)(__twr_v266) = __twr_v263;
    goto __twr_l8;
    __twr_l10:;
    __twr_v267 = 91ULL;
    __twr_v268 = _mng_stream253 + __twr_v267;
    __twr_v269 = *(uint8_t*)(__twr_v268);
    if (__twr_v269) { goto __twr_l11; } else { goto __twr_l12; }
    __twr_l11:;
    ...
    _mng_byte262 = __twr_v274;
    __twr_v275 = 0ULL;
    __twr_v276 = (uint64_t)(&LexCurrentStream);
    __twr_v277 = *(uint64_t*)(__twr_v276);
    __twr_v278 = __twr_v277 + __twr_v272;
    *(uint8_t*)(__twr_v278) = __twr_v275;
    goto __twr_l8;
    __twr_l12:;
    __twr_v279 = 40ULL;
    __twr_v280 = _mng_stream253 + __twr_v279;
    __twr_v281 = *(uint32_t*)(__twr_v280);
    __twr_v282 = 36ULL;
    __twr_v283 = _mng_stream253 + __twr_v282;
    __twr_v284 = *(uint32_t*)(__twr_v283);
    if (__twr_v281 < __twr_v284) { goto __twr_l13; } else { goto __twr_l14; }
    __twr_l13:;
    __twr_v285 = 24ULL;
    __twr_v286 = _mng_stream253 + __twr_v285;
    __twr_v287 = *(uint64_t*)(__twr_v286);
    __twr_v288 = 40ULL;
    __twr_v289 = _mng_stream253 + __twr_v288;
    __twr_v290 = *(uint32_t*)(__twr_v289);
    __twr_v291 = 1ULL;
    __twr_v292 = __twr_v290 * __twr_v291;
    __twr_v293 = __twr_v287 + __twr_v292;
    __twr_v294 = *(uint8_t*)(__twr_v293);
    _mng_byte262 = __twr_v294;
    __twr_v295 = __twr_v290 + __twr_v291;
    *(uint32_t*)(__twr_v289) = __twr_v295;
    goto __twr_l8;
    __twr_l14:;
    __twr_v296 = 56ULL;
    __twr_v297 = _mng_stream253 + __twr_v296;
    __twr_v298 = *(uint64_t*)(__twr_v297);
    if (__twr_v298) { goto __twr_l15; } else { goto __twr_l16; }
    __twr_l15:;
    __twr_v299 = 64ULL;
    __twr_v300 = _mng_stream253 + __twr_v299;
    __twr_v301 = *(uint8_t*)(__twr_v300);
    if (__twr_v301) { goto __twr_l17; } else { goto __twr_l18; }
    __twr_l18:;
    __twr_v302 = 1ULL;
    __twr_v303 = 64ULL;
    __twr_v304 = _mng_stream253 + __twr_v303;
    ...
    *(uint32_t*)(__twr_v307) = __twr_v309;
    ...
    __twr_v327 = __twr_v326 + __twr_v324;
    __twr_v328 = *(uint64_t*)(__twr_v327);
    if (__twr_v328) { goto __twr_l25; } else { goto __twr_l24; }
    __twr_l25:;
    ...
    if (__twr_v337 != __twr_v339) { goto __twr_l26; } else { goto __twr_l21; }
    __twr_l26:;
    ...
    if (__twr_v348) { goto __twr_l27; } else { goto __twr_l28; }
    __twr_l28:;
    ...
    *(uint64_t*)(__twr_v359) = __twr_v358;
    ...
    __twr_v364 = 16ULL;
    __twr_v365 = _mng_stream253 + __twr_v364;
    __twr_v366 = *(uint64_t*)(__twr_v365);
    __twr_v367 = 32ULL;
    __twr_v368 = _mng_stream253 + __twr_v367;
    __twr_v369 = *(uint32_t*)(__twr_v368);
    __twr_v370 = 24ULL;
    __twr_v371 = _mng_stream253 + __twr_v370;
    __twr_v372 = *(uint64_t*)(__twr_v371);
    __twr_v373 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v363)(__twr_v366, __twr_v369, __twr_v372);
    __twr_v374 = 36ULL;
    __twr_v375 = _mng_stream253 + __twr_v374;
    *(uint32_t*)(__twr_v375) = __twr_v373;
    __twr_v376 = *(uint32_t*)(__twr_v375);
    if (__twr_v376) { goto __twr_l29; } else { goto __twr_l30; }
    __twr_l30:;
    __twr_v377 = 64ULL;
    __twr_v378 = _mng_stream253 + __twr_v377;
    __twr_v379 = *(uint8_t*)(__twr_v378);
    if (__twr_v379) { goto __twr_l31; } else { goto __twr_l32; }
    __twr_l32:;
    __twr_v380 = 1ULL;
    __twr_v381 = 64ULL;
    __twr_v382 = _mng_stream253 + __twr_v381;
    *(uint8_t*)(__twr_v382) = __twr_v380;
    ...
    __twr_v387 = 1ULL;
    __twr_v388 = 40ULL;
    __twr_v389 = _mng_stream253 + __twr_v388;
    *(uint32_t*)(__twr_v389) = __twr_v387;
    __twr_v390 = 24ULL;
    __twr_v391 = _mng_stream253 + __twr_v390;
    __twr_v392 = *(uint64_t*)(__twr_v391);
    __twr_v393 = 0ULL;
    __twr_v394 = __twr_v393 * __twr_v387;
    __twr_v395 = __twr_v392 + __twr_v394;
    __twr_v396 = *(uint8_t*)(__twr_v395);
    _mng_byte262 = __twr_v396;
    __twr_l8:;
    __twr_v397 = 0ULL;
    if (_mng_byte262 == __twr_v397) { goto __twr_l34; } else { goto __twr_l35; }
    __twr_l34:;
    __twr_v398 = (uint64_t)(&LexStreamError);
    __twr_v399 = (uint64_t)(&"An invalid byte was found in the source file.");
    __twr_v400 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v398)(__twr_v399, _mng_byte262, __twr_v400, __twr_v400);
    goto __twr_l33;
    __twr_l35:;
    __twr_v401 = 13ULL;
    if (_mng_byte262 == __twr_v401) { goto __twr_l36; } else { goto __twr_l37; }
    __twr_l36:;
    __twr_v402 = (uint64_t)(&LexStreamError);
    __twr_v403 = (uint64_t)(&"DOS line endings were detected in the source file.");
    __twr_v404 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v402)(__twr_v403, __twr_v404, __twr_v404, __twr_v404);
    goto __twr_l33;
    __twr_l37:;
    __twr_v405 = 10ULL;
    if (_mng_byte262 == __twr_v405) { goto __twr_l38; } else { goto __twr_l39; }
    __twr_l38:;
    __twr_v406 = 1ULL;
    __twr_v407 = 44ULL;
    __twr_v408 = _mng_stream253 + __twr_v407;
    __twr_v409 = *(uint32_t*)(__twr_v408);
    __twr_v410 = __twr_v409 + __twr_v406;
    *(uint32_t*)(__twr_v408) = __twr_v410;
    __twr_v411 = 48ULL;
    __twr_v412 = _mng_stream253 + __twr_v411;
    *(uint32_t*)(__twr_v412) = __twr_v406;
    __twr_v413 = 64ULL;
    __twr_v414 = _mng_stream253 + __twr_v413;
    *(uint8_t*)(__twr_v414) = __twr_v406;
    goto __twr_l33;
    __twr_l39:;
    __twr_v415 = 1ULL;
    __twr_v416 = 48ULL;
    __twr_v417 = _mng_stream253 + __twr_v416;
    __twr_v418 = *(uint32_t*)(__twr_v417);
    __twr_v419 = __twr_v418 + __twr_v415;
    *(uint32_t*)(__twr_v417) = __twr_v419;
    __twr_v420 = 0ULL;
    __twr_v421 = 64ULL;
    __twr_v422 = _mng_stream253 + __twr_v421;
    *(uint8_t*)(__twr_v422) = __twr_v420;
    ...
    if (__twr_v424) { goto __twr_l5; } else { goto __twr_l6; }
    __twr_l6:;
    __twr_v425 = 0ULL;
    return __twr_v425;
}
