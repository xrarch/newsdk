...
void LexUninitializeStream(uint64_t _mng_stream190) {
    ...
    if (__twr_v193) { goto __twr_l1; } else { goto __twr_l2; }
    __twr_l2:;
...
uint64_t LexCreateFileStream(uint64_t _mng_fileblock234, uint64_t _mng_handle235) {
    ...
    __twr_v238 = (uint64_t)(&LexInitializeFileStream);
    ((void (*)(uint64_t, uint64_t, uint64_t))__twr_v238)(__twr_v237, _mng_fileblock234, _mng_handle235);
    return __twr_v237;
}
...
uint64_t LexStreamNextCharacter() {
    ...
    _mng_byte252 = __twr_v251;
    __twr_v253 = 0ULL;
    *(uint8_t*)(__twr_v250) = __twr_v253;
    return __twr_v251;
    goto __twr_l8;
    __twr_l10:;
    __twr_v254 = 91ULL;
    ...
    _mng_byte252 = __twr_v261;
    __twr_v262 = 0ULL;
    *(uint8_t*)(__twr_v260) = __twr_v262;
    return __twr_v261;
    goto __twr_l8;
    __twr_l12:;
    __twr_v263 = 40ULL;
    __twr_v264 = _mng_stream243 + __twr_v263;
    ...
    __twr_v272 = 40ULL;
    __twr_v273 = _mng_stream243 + __twr_v272;
    __twr_v274 = *(uint32_t*)(__twr_v273);
    __twr_v275 = 1ULL;
    __twr_v276 = __twr_v271 + __twr_v274;
    __twr_v277 = *(uint8_t*)(__twr_v276);
    _mng_byte252 = __twr_v277;
    __twr_v278 = __twr_v274 + __twr_v275;
    *(uint32_t*)(__twr_v273) = __twr_v278;
    goto __twr_l8;
    __twr_l14:;
    __twr_v279 = 56ULL;
    ...
    if (__twr_v284) { goto __twr_l17; } else { goto __twr_l18; }
    __twr_l18:;
    __twr_v285 = 1ULL;
    __twr_v286 = 64ULL;
    __twr_v287 = _mng_stream243 + __twr_v286;
    *(uint8_t*)(__twr_v287) = __twr_v285;
    __twr_v288 = 10ULL;
    return __twr_v288;
    __twr_l17:;
    __twr_v289 = 1ULL;
    __twr_v290 = (uint64_t)(&LexMacroDepth);
    __twr_v291 = *(uint32_t*)(__twr_v290);
    __twr_v292 = __twr_v291 - __twr_v289;
    *(uint32_t*)(__twr_v290) = __twr_v292;
    __twr_v293 = 56ULL;
    __twr_v294 = _mng_stream243 + __twr_v293;
    __twr_v295 = *(uint64_t*)(__twr_v294);
    __twr_v296 = 257ULL;
    __twr_v297 = __twr_v295 + __twr_v296;
    __twr_v298 = *(uint8_t*)(__twr_v297);
    if (__twr_v298) { goto __twr_l19; } else { goto __twr_l20; }
    __twr_l20:;
    __twr_v299 = 72ULL;
    __twr_v300 = _mng_stream243 + __twr_v299;
    ...
    if (__twr_v327) { goto __twr_l27; } else { goto __twr_l28; }
    __twr_l28:;
    ...
    *(uint64_t*)(__twr_v338) = __twr_v337;
    ...
    __twr_v343 = 16ULL;
    __twr_v344 = _mng_stream243 + __twr_v343;
    __twr_v345 = *(uint64_t*)(__twr_v344);
    __twr_v346 = 32ULL;
    __twr_v347 = _mng_stream243 + __twr_v346;
    __twr_v348 = *(uint32_t*)(__twr_v347);
    __twr_v349 = 24ULL;
    __twr_v350 = _mng_stream243 + __twr_v349;
    __twr_v351 = *(uint64_t*)(__twr_v350);
    __twr_v352 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v342)(__twr_v345, __twr_v348, __twr_v351);
    __twr_v353 = 36ULL;
    __twr_v354 = _mng_stream243 + __twr_v353;
    *(uint32_t*)(__twr_v354) = __twr_v352;
    __twr_v355 = *(uint32_t*)(__twr_v354);
    if (__twr_v355) { goto __twr_l29; } else { goto __twr_l30; }
    __twr_l30:;
    __twr_v356 = 64ULL;
    __twr_v357 = _mng_stream243 + __twr_v356;
    __twr_v358 = *(uint8_t*)(__twr_v357);
    if (__twr_v358) { goto __twr_l31; } else { goto __twr_l32; }
    __twr_l32:;
    __twr_v359 = 1ULL;
    __twr_v360 = 64ULL;
    __twr_v361 = _mng_stream243 + __twr_v360;
    *(uint8_t*)(__twr_v361) = __twr_v359;
    ...
    __twr_v366 = 1ULL;
    __twr_v367 = 40ULL;
    __twr_v368 = _mng_stream243 + __twr_v367;
    *(uint32_t*)(__twr_v368) = __twr_v366;
    __twr_v369 = 24ULL;
    __twr_v370 = _mng_stream243 + __twr_v369;
    ...
    __twr_v376 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v374)(__twr_v375, _mng_byte252, __twr_v376, __twr_v376);
    goto __twr_l33;
    __twr_l35:;
    __twr_v377 = 13ULL;
    ...
    __twr_v382 = 1ULL;
    __twr_v383 = 44ULL;
    __twr_v384 = _mng_stream243 + __twr_v383;
    __twr_v385 = *(uint32_t*)(__twr_v384);
    __twr_v386 = __twr_v385 + __twr_v382;
    *(uint32_t*)(__twr_v384) = __twr_v386;
    __twr_v387 = 48ULL;
    __twr_v388 = _mng_stream243 + __twr_v387;
    *(uint32_t*)(__twr_v388) = __twr_v382;
    __twr_v389 = 64ULL;
    __twr_v390 = _mng_stream243 + __twr_v389;
    *(uint8_t*)(__twr_v390) = __twr_v382;
    goto __twr_l33;
    __twr_l39:;
    __twr_v391 = 1ULL;
    __twr_v392 = 48ULL;
    __twr_v393 = _mng_stream243 + __twr_v392;
    __twr_v394 = *(uint32_t*)(__twr_v393);
    __twr_v395 = __twr_v394 + __twr_v391;
    *(uint32_t*)(__twr_v393) = __twr_v395;
    __twr_v396 = 0ULL;
    __twr_v397 = 64ULL;
    __twr_v398 = _mng_stream243 + __twr_v397;
    *(uint8_t*)(__twr_v398) = __twr_v396;
    ...
    if (__twr_v400) { goto __twr_l5; } else { goto __twr_l6; }
    __twr_l6:;
    __twr_v401 = 0ULL;
    return __twr_v401;
}
