...
void LexInitializeStream(uint64_t _mng_stream146, uint64_t _mng_macro147) {
    ...
    *(uint64_t*)(__twr_v173) = __twr_v148;
    __twr_v174 = 88ULL;
    ...
    *(uint8_t*)(__twr_v181) = __twr_v148;
    __twr_v182 = 92ULL;
    __twr_v183 = _mng_stream146 + __twr_v182;
    *(uint8_t*)(__twr_v183) = __twr_v148;
    __twr_l3:;
    _jkl_epilogue:;
}
...
uint64_t LexStreamNextCharacter() {
    ...
    *(uint32_t*)(__twr_v286) = __twr_v288;
    ...
    __twr_l30:;
    __twr_v296 = 72ULL;
    __twr_v297 = _mng_stream239 + __twr_v296;
    __twr_v298 = *(uint64_t*)(__twr_v297);
    __twr_v299 = (uint64_t)(&LexRootScope);
    __twr_v300 = *(uint64_t*)(__twr_v299);
    if (__twr_v298 == __twr_v300) { goto __twr_l33; } else { goto __twr_l32; }
    __twr_l32:;
    __twr_v301 = (uint64_t)(&LexCurrentScope);
    __twr_v302 = *(uint64_t*)(__twr_v301);
    __twr_v303 = *(uint64_t*)(__twr_v302);
    __twr_v304 = *(uint64_t*)(__twr_v303);
    if (!(__twr_v304)) { goto __twr_l34; } else { goto __twr_l35; }
    __twr_l35:;
    __twr_v305 = (uint64_t)(&LexStreamError);
    __twr_v306 = (uint64_t)(&"Macro terminated during nested scope");
    __twr_v307 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v305)(__twr_v306, __twr_v307, __twr_v307, __twr_v307);
    __twr_l34:;
    __twr_v308 = (uint64_t)(&TlDeleteSymbolTable);
    __twr_v309 = (uint64_t)(&LexCurrentScope);
    __twr_v310 = *(uint64_t*)(__twr_v309);
    __twr_v311 = ((uint64_t (*)(uint64_t))__twr_v308)(__twr_v310);
    goto __twr_l31;
    __twr_l33:;
    __twr_v312 = (uint64_t)(&LexCurrentScope);
    __twr_v313 = *(uint64_t*)(__twr_v312);
    __twr_v314 = (uint64_t)(&LexRootScope);
    __twr_v315 = *(uint64_t*)(__twr_v314);
    if (__twr_v313 == __twr_v315) { goto __twr_l31; } else { goto __twr_l36; }
    __twr_l36:;
    __twr_v316 = (uint64_t)(&LexStreamError);
    __twr_v317 = (uint64_t)(&"Macro terminated during nested scope");
    __twr_v318 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v316)(__twr_v317, __twr_v318, __twr_v318, __twr_v318);
    __twr_l31:;
    __twr_v319 = (uint64_t)(&TlDeleteSymbolTable);
    __twr_v320 = (uint64_t)(&LexCurrentMacroScope);
    __twr_v321 = *(uint64_t*)(__twr_v320);
    __twr_v322 = ((uint64_t (*)(uint64_t))__twr_v319)(__twr_v321);
    __twr_l29:;
    __twr_v323 = (uint64_t)(&PrsLeaveMacro);
    __twr_v324 = ((uint64_t (*)())__twr_v323)();
    if (__twr_v324) { goto __twr_l37; } else { goto __twr_l38; }
    __twr_l38:;
    __twr_v325 = (uint64_t)(&LexStreamError);
    __twr_v326 = (uint64_t)(&"Macro terminated during nested block");
    __twr_v327 = 0ULL;
    ...
    __twr_v331 = (uint64_t)(&LexCurrentScope);
    *(uint64_t*)(__twr_v331) = __twr_v330;
    __twr_v332 = 80ULL;
    __twr_v333 = _mng_stream239 + __twr_v332;
    __twr_v334 = *(uint64_t*)(__twr_v333);
    __twr_v335 = (uint64_t)(&LexCurrentMacroScope);
    *(uint64_t*)(__twr_v335) = __twr_v334;
    ...
    goto __twr_l18;
    __twr_l26:;
    __twr_v339 = (uint64_t)(&TlReadFile);
    __twr_v340 = 16ULL;
    __twr_v341 = _mng_stream239 + __twr_v340;
    __twr_v342 = *(uint64_t*)(__twr_v341);
    __twr_v343 = 32ULL;
    __twr_v344 = _mng_stream239 + __twr_v343;
    __twr_v345 = *(uint32_t*)(__twr_v344);
    __twr_v346 = 24ULL;
    __twr_v347 = _mng_stream239 + __twr_v346;
    __twr_v348 = *(uint64_t*)(__twr_v347);
    __twr_v349 = ((uint64_t (*)(uint64_t, uint64_t, uint64_t))__twr_v339)(__twr_v342, __twr_v345, __twr_v348);
    __twr_v350 = 36ULL;
    __twr_v351 = _mng_stream239 + __twr_v350;
    *(uint32_t*)(__twr_v351) = __twr_v349;
    __twr_v352 = *(uint32_t*)(__twr_v351);
    if (__twr_v352) { goto __twr_l39; } else { goto __twr_l40; }
    __twr_l40:;
    __twr_v353 = 64ULL;
    __twr_v354 = _mng_stream239 + __twr_v353;
    ...
    *(uint8_t*)(__twr_v358) = __twr_v356;
    ...
    __twr_v363 = 1ULL;
    __twr_v364 = 40ULL;
    __twr_v365 = _mng_stream239 + __twr_v364;
    *(uint32_t*)(__twr_v365) = __twr_v363;
    __twr_v366 = 24ULL;
    __twr_v367 = _mng_stream239 + __twr_v366;
    __twr_v368 = *(uint64_t*)(__twr_v367);
    __twr_v369 = *(uint8_t*)(__twr_v368);
    _mng_byte248 = __twr_v369;
    __twr_l18:;
    if (_mng_byte248) { goto __twr_l45; } else { goto __twr_l44; }
    __twr_l44:;
    __twr_v370 = (uint64_t)(&LexStreamError);
    __twr_v371 = (uint64_t)(&"An invalid byte was found in the source file.");
    __twr_v372 = 0ULL;
    ((void (*)(uint64_t, uint64_t, uint64_t, uint64_t))__twr_v370)(__twr_v371, _mng_byte248, __twr_v372, __twr_v372);
    goto __twr_l43;
    __twr_l45:;
    __twr_v373 = 13ULL;
    if (_mng_byte248 != __twr_v373) { goto __twr_l47; } else { goto __twr_l46; }
    __twr_l46:;
