...
uint64_t IrGetStackOffset(uint64_t _mng_func186, uint64_t _mng_symbol187) {
    ...
    if (__twr_v190) { goto __twr_l2; } else { goto __twr_l1; }
    __twr_l2:;
    __twr_v191 = 120ULL;
...
uint64_t IrCreateInstruction(uint64_t _mng_type221) {
    ...
    if (__twr_v226) { goto __twr_l7; } else { goto __twr_l6; }
    __twr_l7:;
...
uint64_t IrCreateVariable(uint64_t _mng_definedby254) {
    ...
    if (__twr_v259) { goto __twr_l9; } else { goto __twr_l8; }
    __twr_l9:;
...
void IrInsertInstructionTail(uint64_t _mng_inst284) {
    ...
    *(uint64_t*)(__twr_v313) = _mng_inst284;
    ...
    if (__twr_v316 > __twr_v312) { goto __twr_l16; } else { goto __twr_l15; }
    __twr_l16:;
    __twr_v317 = 88ULL;
    __twr_v318 = _mng_inst284 + __twr_v317;
    __twr_v319 = *(uint8_t*)(__twr_v318);
    __twr_v320 = 23ULL;
    if (__twr_v319 < __twr_v320) { goto __twr_l14; } else { goto __twr_l15; }
    __twr_l14:;
    ...
    __twr_v326 = 24ULL;
    if (__twr_v325 > __twr_v326) { goto __twr_l18; } else { goto __twr_l13; }
    __twr_l18:;
    __twr_v327 = 88ULL;
    __twr_v328 = _mng_inst284 + __twr_v327;
    __twr_v329 = *(uint8_t*)(__twr_v328);
    __twr_v330 = 28ULL;
    if (__twr_v329 < __twr_v330) { goto __twr_l17; } else { goto __twr_l13; }
    __twr_l17:;
...
void IrRemoveInstruction(uint64_t _mng_inst334) {
    ...
    if (__twr_v341) { goto __twr_l20; } else { goto __twr_l21; }
    __twr_l20:;
    __twr_v343 = 32ULL;
    ...
    *(uint64_t*)(_mng_block338) = __twr_v349;
    ...
    if (__twr_v352) { goto __twr_l23; } else { goto __twr_l24; }
    __twr_l23:;
    __twr_v353 = 40ULL;
...
uint64_t IrGenerateLoad(uint64_t _mng_var362, uint64_t _mng_type363) {
    ...
    if (__twr_v367) { goto __twr_l26; } else { goto __twr_l25; }
    __twr_l26:;
    ...
    __twr_v390 = 0ULL;
    if (__twr_v389 == __twr_v390) { goto __twr_l31; } else { goto __twr_l32; }
    __twr_l31:;
    ...
    *(uint8_t*)(_mng_inst372) = __twr_v391;
    ...
    __twr_v395 = 2ULL;
    if (__twr_v394 == __twr_v395) { goto __twr_l33; } else { goto __twr_l34; }
    __twr_l33:;
    __twr_v396 = 13ULL;
...
void IrGenerateStore(uint64_t _mng_destvar413, uint64_t _mng_srcvar414, uint64_t _mng_type415) {
    ...
    __twr_v435 = 0ULL;
    if (__twr_v434 == __twr_v435) { goto __twr_l39; } else { goto __twr_l40; }
    __twr_l39:;
    ...
    *(uint8_t*)(_mng_inst419) = __twr_v436;
    ...
    __twr_v440 = 2ULL;
    if (__twr_v439 == __twr_v440) { goto __twr_l41; } else { goto __twr_l42; }
    __twr_l41:;
    __twr_v441 = 13ULL;
...
void IrGenerateBranch(uint64_t _mng_node453, uint64_t _mng_var1454, uint64_t _mng_var2455, uint64_t _mng_truelabel456, uint64_t _mng_falselabel457, uint64_t _mng_type458) {
    ...
    __twr_v462 = 1ULL;
    if (__twr_v461 == __twr_v462) { goto __twr_l44; } else { goto __twr_l43; }
    __twr_l44:;
    ...
    __twr_v470 = 1ULL;
    if (__twr_v469 == __twr_v470) { goto __twr_l46; } else { goto __twr_l45; }
    __twr_l46:;
...
uint64_t IrCreateConstantVariable(uint64_t _mng_value489) {
    ...
    if (__twr_v492) { goto __twr_l49; } else { goto __twr_l48; }
    __twr_l49:;
    return _mng_var493;
    __twr_l48:;
...
uint64_t IrCreateConstantBefore(uint64_t _mng_beforeinst503, uint64_t _mng_value504) {
    ...
    *(uint64_t*)(__twr_v507) = _mng_value504;
    ...
    if (__twr_v517) { goto __twr_l51; } else { goto __twr_l52; }
    __twr_l51:;
    __twr_v519 = 32ULL;
...
uint64_t IrGenerateOperatorInst(uint64_t _mng_type545, uint64_t _mng_src1546, uint64_t _mng_src2547) {
    ...
    if (__twr_v549) { goto __twr_l54; } else { goto __twr_l53; }
    __twr_l54:;
    return _mng_var550;
    __twr_l53:;
...
uint64_t IrGenerateIdentifier(uint64_t _mng_node567, uint64_t _mng_truelabel568, uint64_t _mng_falselabel569) {
    ...
    __twr_v575 = 1ULL;
    if (__twr_v574 != __twr_v575) { goto __twr_l56; } else { goto __twr_l55; }
    __twr_l56:;
    ...
    if (__twr_v600 != __twr_v604) { goto __twr_l61; } else { goto __twr_l62; }
    __twr_l61:;
    __twr_v605 = 112ULL;
    __twr_v606 = _mng_symbol571 + __twr_v605;
    __twr_v607 = *(uint64_t*)(__twr_v606);
    if (__twr_v607) { goto __twr_l64; } else { goto __twr_l65; }
    __twr_l64:;
    __twr_v608 = 112ULL;
    ...
    *(uint8_t*)(__twr_v614) = __twr_v612;
    ...
    __twr_v622 = 2ULL;
    if (__twr_v621 == __twr_v622) { goto __twr_l66; } else { goto __twr_l67; }
    __twr_l66:;
...
uint64_t IrGenerateAnd(uint64_t _mng_node676, uint64_t _mng_truelabel677, uint64_t _mng_falselabel678) {
    ...
    uint64_t __twr_v713;
    __twr_v679 = 0ULL;
    if (_mng_truelabel677 != __twr_v679) { goto __twr_l76; } else { goto __twr_l75; }
    __twr_l76:;
...
uint64_t IrGenerateOr(uint64_t _mng_node714, uint64_t _mng_truelabel715, uint64_t _mng_falselabel716) {
    ...
    uint64_t __twr_v751;
    __twr_v717 = 0ULL;
    if (_mng_truelabel715 != __twr_v717) { goto __twr_l78; } else { goto __twr_l77; }
    __twr_l78:;
...
uint64_t IrIsSignedType(uint64_t _mng_node810) {
    ...
    __twr_v817 = 0ULL;
    if (__twr_v816 != __twr_v817) { goto __twr_l86; } else { goto __twr_l85; }
    __twr_l86:;
    __twr_v818 = 0ULL;
    return __twr_v818;
    __twr_l85:;
    ...
    __twr_v821 = 1ULL;
    if (__twr_v819 > __twr_v821) { goto __twr_l87; } else { goto __twr_l89; }
    __twr_l87:;
    __twr_v822 = 6ULL;
    if (_mng_primtype820 < __twr_v822) { goto __twr_l88; } else { goto __twr_l89; }
    __twr_l88:;
    __twr_v823 = 1ULL;
...
uint64_t IrGenerateDivide(uint64_t _mng_node951, uint64_t _mng_truelabel952, uint64_t _mng_falselabel953) {
    ...
    if (__twr_v958) { goto __twr_l104; } else { goto __twr_l105; }
    __twr_l104:;
...
uint64_t IrGenerateAddrOf(uint64_t _mng_node1007, uint64_t _mng_truelabel1008, uint64_t _mng_falselabel1009) {
    ...
    __twr_v1022 = 1ULL;
    if (__twr_v1021 == __twr_v1022) { goto __twr_l109; } else { goto __twr_l110; }
    __twr_l109:;
    __twr_v1023 = 0ULL;
    __twr_v1024 = 92ULL;
    ...
    *(uint8_t*)(__twr_v1025) = __twr_v1023;
    ...
    __twr_v1029 = 2ULL;
    if (__twr_v1028 != __twr_v1029) { goto __twr_l112; } else { goto __twr_l111; }
    __twr_l112:;
...
uint64_t IrGenerateArrayIndex(uint64_t _mng_node1079, uint64_t _mng_truelabel1080, uint64_t _mng_falselabel1081) {
    ...
    __twr_v1091 = 1ULL;
    if (__twr_v1090 == __twr_v1091) { goto __twr_l118; } else { goto __twr_l119; }
    __twr_l118:;
    __twr_v1092 = 0ULL;
    __twr_v1093 = 16ULL;
    ...
    __twr_v1108 = 3ULL;
    if (__twr_v1107 == __twr_v1108) { goto __twr_l120; } else { goto __twr_l121; }
    __twr_l120:;
...
uint64_t IrGenerateFunctionCall(uint64_t _mng_node1159, uint64_t _mng_truelabel1160, uint64_t _mng_falselabel1161) {
    ...
    *(uint64_t*)(__twr_v1183) = __twr_v1167;
    ...
    if (__twr_v1187) { goto __twr_l127; } else { goto __twr_l128; }
    __twr_l127:;
    ...
    if (__twr_v1193) { goto __twr_l131; } else { goto __twr_l130; }
    __twr_l131:;
...
void IrGenerateAssignment(uint64_t _mng_destvar1212, uint64_t _mng_srcvar1213, uint64_t _mng_type1214) {
    ...
    __twr_v1218 = 1ULL;
    if (__twr_v1217 == __twr_v1218) { goto __twr_l138; } else { goto __twr_l139; }
    __twr_l138:;
    ...
    __twr_v1223 = 2ULL;
    if (__twr_v1222 == __twr_v1223) { goto __twr_l140; } else { goto __twr_l141; }
    __twr_l140:;
...
void IrGenerateModificationAssign(uint64_t _mng_node1250, uint64_t _mng_type1251) {
    ...
    __twr_v1273 = 1ULL;
    if (__twr_v1272 == __twr_v1273) { goto __twr_l143; } else { goto __twr_l144; }
    __twr_l143:;
...
uint64_t IrGenerateConstant(uint64_t _mng_node1357, uint64_t _mng_truelabel1358, uint64_t _mng_falselabel1359) {
    ...
    if (__twr_v1362) { goto __twr_l148; } else { goto __twr_l149; }
    __twr_l148:;
...
uint64_t IrGenerateRvalue(uint64_t _mng_node1401) {
    ...
    __twr_v1409 = 1ULL;
    if (__twr_v1408 == __twr_v1409) { goto __twr_l153; } else { goto __twr_l152; }
    __twr_l153:;
...
void IrGenerateReturn(uint64_t _mng_node1437) {
    ...
    if (__twr_v1441) { goto __twr_l155; } else { goto __twr_l154; }
    __twr_l155:;
...
void IrGenerateWhile(uint64_t _mng_node1453) {
    ...
    *(uint64_t*)(__twr_v1470) = __twr_v1465;
    ...
    __twr_v1480 = 4ULL;
    if (__twr_v1479 == __twr_v1480) { goto __twr_l157; } else { goto __twr_l156; }
    __twr_l157:;
...
void IrGenerateGoTo(uint64_t _mng_node1512) {
    ...
    __twr_v1520 = 5ULL;
    if (__twr_v1519 == __twr_v1520) { goto __twr_l164; } else { goto __twr_l163; }
    __twr_l164:;
...
void IrGenerateIf(uint64_t _mng_node1537) {
    ...
    if (__twr_v1540) { goto __twr_l167; } else { goto __twr_l168; }
    __twr_l167:;
    __twr_v1549 = 16ULL;
    ...
    __twr_v1560 = 3ULL;
    if (__twr_v1559 == __twr_v1560) { goto __twr_l171; } else { goto __twr_l170; }
    __twr_l171:;
...
void IrGenerateBlock(uint64_t _mng_block1579) {
    ...
    if (__twr_v1580) { goto __twr_l181; } else { goto __twr_l182; }
    __twr_l181:;
    ...
    if (__twr_v1589) { goto __twr_l185; } else { goto __twr_l184; }
    __twr_l185:;
...
void IrGenerateForFunction(uint64_t _mng_funcsym1594) {
    ...
    if (__twr_v1598) { goto __twr_l187; } else { goto __twr_l186; }
    __twr_l187:;
...
void IrGenerate() {
    ...
    if (__twr_v1623) { goto __twr_l188; } else { goto __twr_l189; }
    __twr_l188:;
